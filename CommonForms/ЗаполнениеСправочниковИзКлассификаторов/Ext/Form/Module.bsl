...
Процедура Поиск(Команда)
	...
	ЗаполнитьКлассификаторНаКлиенет(ПолныйПутьКМакету, ИмяСправочника, Истина)
...
Процедура ОтменитьПоиск(Команда)
	...
	СтрокаПоискаПоКоду 		   = "";
	ЗаполнитьКлассификаторНаКлиенет(ПолныйПутьКМакету, ИмяСправочника);
...
&НаКлиенте
Процедура ЗаполнитьКлассификаторНаКлиенет(ПолныйПутьКМакету, ИмяСправочника, Отбор = Ложь)
