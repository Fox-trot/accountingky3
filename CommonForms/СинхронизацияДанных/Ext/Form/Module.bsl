...
Процедура ВыполнитьСинхронизацию(Команда)
	...
	ИначеЕсли ТекущиеДанные.ЗапускОбменаИзКорреспондента
		...
		ПоказатьПредупреждение(, СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
			НСтр("ru = 'Запуск синхронизации с ""%1"" из этой программы недоступен.
	...
	Иначе
		...
		ДополнительныеПараметры.Вставить("РежимСопоставления",    ТекущиеДанные.ПолученоСообщениеДляСопоставленияДанных);
...
Процедура СписокПриложенийПриАктивизацииСтроки(Элемент)
	...
	Элементы.СписокПриложенийНачальнаяВыгрузкаДанных.Доступность = Не ТекущиеДанные.ЗапускОбменаИзКорреспондента
		Или ТекущиеДанные.ПолученоСообщениеДляСопоставленияДанных;
