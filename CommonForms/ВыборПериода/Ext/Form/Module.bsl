...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЦветФонаКнопкиВыбранногоПериода = ЦветаСтиля.ЦветАктивности;
	ЦветФонаКнопки = ЦветаСтиля.ЦветНавигации;
...
// Процедура - обработчик события ПриИзменении поля ввода ВыбираемыйПериод.
//
&НаКлиенте
