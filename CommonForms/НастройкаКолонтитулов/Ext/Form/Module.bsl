...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПолеСверху	= Настройки.Отступ.ПолеСверху;
	ПолеСлева   = Настройки.Отступ.ПолеСлева;
	ПолеСнизу   = Настройки.Отступ.ПолеСнизу;
	ПолеСправа  = Настройки.Отступ.ПолеСправа;
...
Процедура СохранитьНастройкиНаСервере()
	...
	Отступ.Вставить("ПолеСверху", ПолеСверху);
	Отступ.Вставить("ПолеСлева", ПолеСлева);
	Отступ.Вставить("ПолеСнизу", ПолеСнизу);
	Отступ.Вставить("ПолеСправа", ПолеСправа);
