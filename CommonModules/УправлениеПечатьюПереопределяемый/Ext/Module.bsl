...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.БланкиСФ);
	СписокОбъектов.Добавить(Документы.ВедомостьЗП);
	СписокОбъектов.Добавить(Документы.ВозвратТоваровОтПокупателя);
	СписокОбъектов.Добавить(Документы.ВозвратТоваровПоставщику);
	//СписокОбъектов.Добавить(Документы.ВыплатаЗП);
	...
	СписокОбъектов.Добавить(Документы.ЗаявлениеОВвозеИВывозе);
	...
	СписокОбъектов.Добавить(Документы.РеестрГТД);
	...
	СписокОбъектов.Добавить(Документы.Шаблон);
