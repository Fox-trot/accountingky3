...
Функция ПолучитьСУчетомКэша(Кэш, Параметр)
	...
	Если Кэш.Свойство("Организация") Тогда 
		Если Параметр = "АдрЮР" ИЛИ Параметр = "АдрФакт"  Тогда
...
// Выборка данных договора в в структуру
Функция ДанныеДоговора(Договор) Экспорт
	...
	|	ДоговорыКонтрагентов.КодПоставкиНДС,
	...
	Если Результат.Следующий() Тогда
		...
		СтруктураДанныеДоговора.Вставить("КодПоставкиНДС", 		Результат.КодПоставкиНДС);
...
Функция ПустаяСтруктураДанныеДоговора()
	...
	СтруктураДанныхДоговора.Вставить("КодПоставкиНДС", 		Справочники.КодыПоставокНДС.ПустаяСсылка());
...
//  * СчетДохода	- ПланСчетовСсылка.Хозрасчетный - Счет отражения доходов от реализации
//  * СчетРасхода	- ПланСчетовСсылка.Хозрасчетный - Счет отражения расходов при списании
//  * СтатьяДохода	- СправочникСсылка.СтатьиЗатрат - Статья дохода
//  * СтатьяРасхода	- СправочникСсылка.СтатьиЗатрат - Статья расхода
//
