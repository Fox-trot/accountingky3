...
Процедура НачатьУстановкуПоставляемогоРасширенияВОбластьДанных(Знач ОписаниеИнсталляции, Знач Ответственный, Знач ПоставляемоеРасширение)
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'Поставляемые расширения.Инициирована установка поставляемого расширения в область данных';
			|en = 'Supplied extensions. Installation of supplied extension in the data area is initiated'", ОбщегоНазначения.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Информация,
		,
	...
	Если НЕ ОбщегоНазначения.СсылкаСуществует(ПоставляемоеРасширение) Тогда	
		...
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Поставляемые расширения.Установка в область данных отложена';
										|en = 'Supplied extensions. Installation in the data area is deferred'", ОбщегоНазначения.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Информация,
			,
			Строка(ОписаниеИнсталляции.Идентификатор),
			Строка(ОписаниеИнсталляции.Инсталляция));
	...
	ЗаписьЖурналаРегистрации(НСтр("ru = 'Поставляемые расширения.Установка в область данных';
									|en = 'Supplied extensions. Installation in the data area '", ОбщегоНазначения.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Информация,
		,
		ПоставляемоеРасширение,
		Строка(ОписаниеИнсталляции.Инсталляция));
