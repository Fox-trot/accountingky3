...
// Если указанный признак установлен у группы проверок, то выполняются все проверки, принадлежащие
// группе. В этом случае наличие / отсутствие указанного признака у самой проверки значения не имеет.
// Проверки с флагом Использование установленным в значение Ложь из рассмотрения исключаются в любом случае.
//
// Параметры:
