...
Функция ВсеСведенияОРеализации(Организация, НачалоМесяца, КонецМесяца, НеУчитыватьЗакупкиБезНДС) Экспорт
	...
	Запрос.Текст = 
		...
		|ГДЕ
		|	СчетаФактурыВыписанные.Дата МЕЖДУ &НачалоМесяца И &КонецМесяца
...
Функция ВсеСведенияОПоступлении(Организация, НачалоМесяца, КонецМесяца, НеУчитыватьЗакупкиБезНДС) Экспорт
	...
	Запрос.Текст =
		...
		|	СведенияОНДСНаИмпорт.ПризнакСтраны,
