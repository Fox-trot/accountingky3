...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыБП.ЗаполнитьСубконтоОС";
	Обработчик.Идентификатор = Новый УникальныйИдентификатор("b0066ed4-c1d2-4de1-a340-cbe11aea2a29");
	Обработчик.Комментарий = НСтр("ru = 'Заполнение субконто для учета ОС.'");
...
Процедура УстановитьДатуТекущейВерсии() Экспорт
	Константы.ДатаТекущейВерсии.Установить(Дата(2018,03,26));
КонецПроцедуры
...
#Область Обновление_3_0_6_50

Процедура ЗаполнитьСубконтоОС(Параметры) Экспорт
