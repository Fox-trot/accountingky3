	...
	Пока ВыборкаПорядок.Следующий() Цикл
		...
		ИначеЕсли Реквизиты.БазаРаспределения = Перечисления.БазыРаспределенияКосвенныхРасходов.МатериальныеЗатраты Тогда 
			...
			Текст = Текст + 
				...
				|	СпецификацииНоменклатурыИсходныеКомплектующие.Количество / СпецификацииНоменклатурыИсходныеКомплектующие.Ссылка.Количество * ВременнаяТаблицаВыпускМассивПродукции.КоличествоОборот КАК НормаРасхода
