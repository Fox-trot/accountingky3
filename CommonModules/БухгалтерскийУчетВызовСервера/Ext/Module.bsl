...
// Сохраняет настройку для использования по умолчанию. 
// 
// Параметры: 
// 	Значение - Произвольный тип - значение параметра.
//	Настройка - Строка - имя настройки.
//
Процедура УстановитьНастройкуПользователя(ЗначениеНастройки, ИмяНастройки) Экспорт
	БухгалтерскийУчетСервер.УстановитьНастройкуПользователя(ЗначениеНастройки, ИмяНастройки);
