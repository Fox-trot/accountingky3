...
Процедура ОбновлениеНастроек(Настройки)
	...
	Попытка
		...
		Для Каждого Настройка Из Настройки.Действия Цикл
			...
			Идентификатор = Настройка.Идентификатор;
			...
			ИначеЕсли Действие = "ОбновитьОбработчик" Тогда
				...
				Обработчик = Справочники.ДополнительныеОбработчикиОчередиЗаданий.ПолучитьСсылку(Идентификатор);
				...
				ОбработчикОбъект.Наименование = Наименование;
