...
//  ИдентификаторРасшифровки - ИдентификаторРасшифровкиКомпоновкиДанных - Указатель на элемент данных расшифровки для
//                                                                        которого строится расшифровка.
...
//   - Структура см. БухгалтерскиеОтчетыКлиентСервер.НовыйУниверсальныеНастройки - настройки расшифровки пригодные для
//   чтения стандартным отчетом.
//
...
// 
// Возвращаемое значение:
//  ТаблицаЗначений см. НовыйПравилаРасшифровки() - Содержит имена отчетов и реквизиты, требуемые для этих отчетов,
//  правилами расшифровки (см. БухгалтерскиеОтчетыРасшифровка.НовыйПравилаРасшифровки()).
//
Функция РасшифровочныеОтчеты(ДанныеРасшифровки, ИдентификаторРасшифровки, ИмяОтчета) Экспорт
	
	ПравилаРасшифровки = НовыйПравилаРасшифровки();
...
// Добавляет реквизит, требующийся для корректного открытия расшифровочного отчета, в коллекцию требуемых реквизитов
// правил расшифровки.
//
// Параметры:
...
Процедура ДобавитьВНастройкиДанныеОтчета(Настройки, Отчет) Экспорт
	...
	ОбщегоНазначенияБПКлиентСервер.СкопироватьЭлементы(Настройки.Отбор,					Отчет.НастройкиКомпоновкиДанных.Отбор);
	ОбщегоНазначенияБПКлиентСервер.СкопироватьЭлементы(Настройки.УсловноеОформление,	Отчет.НастройкиКомпоновкиДанных.УсловноеОформление);
	ОбщегоНазначенияБПКлиентСервер.СкопироватьЭлементы(Настройки.Порядок,				Отчет.НастройкиКомпоновкиДанных.Порядок);
...
// Выполняет замену полей (для субконто) в таблице группировок и дополнительных полей, если при изменении счета
// поменялись номера и порядок субконто.
//
// Параметры:
...
// Устанавливает Количество в значение Ложь, если на счете нет соответствующего учета.
//
// Параметры:
