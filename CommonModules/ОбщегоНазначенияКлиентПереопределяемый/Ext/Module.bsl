...
Процедура ПослеНачалаРаботыСистемы() Экспорт
	...
	Если ПараметрыРаботыКлиента.ПоказатьЗнакомствоСРедакциейВ30 Тогда
	...
	Если ПараметрыРаботыКлиента.ПоказатьУправлениеНастройками Тогда
		ОбщегоНазначенияБПКлиент.ОткрытьУправлениеНастройками(ПараметрыРаботыКлиента.ИмяОбработкиУправлениеНастройками);
	КонецЕсли;	
	// Конец УправлениеНастройками

	Если ПараметрыРаботыКлиента.ПоказатьПредложитьОбновитьВерсиюПрограммы Тогда
