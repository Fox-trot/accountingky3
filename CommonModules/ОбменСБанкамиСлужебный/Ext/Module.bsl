				...
				Пока ВыборкаПоСертификатам.Следующий() Цикл
					...
					Если ПервыйСертификат
						И (ПрограммаБанка = Перечисления.ПрограммыБанка.СбербанкОнлайн
							...
							ИДМассиваСообщений = ИДМассиваСообщений + Строка(ВыборкаПоСертификатам.НастройкаОбмена.УникальныйИдентификатор());
					КонецЕсли;
					...
					ИДМассиваСообщений = ИДМассиваСообщений + Строка(ВыборкаПоСертификатам.СертификатПодписи.УникальныйИдентификатор());
