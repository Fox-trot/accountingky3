...
Процедура ЗаполнитьСписокВыбораВидПериода(Знач МинимальныйПериод, СписокВыбора, ЗначениеПоУмолчанию = Неопределено) Экспорт
	...
	СписокДоступныхПериодов = ДоступныеПериоды();
...
Функция Периоды(Знач НачалоПериода, Знач ВидПериода) Экспорт
...
Функция ПолучитьПредставлениеПериодаОтчета(ВидПериода, Знач НачалоПериода, Знач КонецПериода) Экспорт
	...
	Иначе
		...
		Список = Периоды(НачалоПериода, ВидПериода);
...
Функция СловаПредставляющиеПериодОтчета(Текст) Экспорт
...
//
// Параметры:
//  ВидПериода		 - ПеречислениеСсылка	 - Доступные периоды отчета
//  Текст			 - Строка	 - 
//  ДатаНачала		 - Дата	 - 
//  ДатаОкончания	 - Дата	 - 
// 
// Возвращаемое значение:
//  ДанныеДляВыбора - СписокЗначений
//
Функция ПодобратьПериодОтчета(ВидПериода, Текст, ДатаНачала, ДатаОкончания) Экспорт
	
	ДанныеДляВыбора = Новый СписокЗначений;
	
	МассивСлов = СловаПредставляющиеПериодОтчета(Текст);
...
Функция ДоступныеПериоды() Экспорт 
