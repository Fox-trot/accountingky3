...
Процедура ИзменитьПользовательскуюВидимостьЛентНовостей(ЛентыНовостей, Видимость = Ложь, Пользователь = Неопределено) Экспорт
	...
	Если БылиИзменения = Истина Тогда
		...
		//  пользовательские и т.п.), необходимо очистить кэш, чтобы
		//  ОбработкаНовостейПовтИсп.ПолучитьМассивОтключенныхЛентНовостей выдавала правильный результат.
...
#Область ПроверкаПравильностиВнедрения

// Производит проверку правильности внедрения подсистемы
// "ОблачныйАрхив". При проверке производится сравнение текущих
...
Процедура ПроверитьПравильностьВнедрения(ОписательОшибок, ОбъектыИПП) Экспорт
	...
	Подсистема = Метаданные.Подсистемы.ИнтернетПоддержкаПользователей.Подсистемы.Новости;
...
Функция НовыйОписательЭталонныхНастроек()
	...
	Если ОбщийРеквизитОбластьДанныхОсновныеДанные <> Неопределено Тогда
		...
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.ОтборыПоЛентамНовостейДляОбластиДанных,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.СостоянияНовостей,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.РазрешенныеДляРедактированияЛентыНовостей,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.КатегорииНовостейИнтервалыВерсий,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.НастройкиПользователейБИП,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.Константы.РазрешенаРаботаСНовостями,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.КатегорииНовостейИнтервалыВерсийНеобработанные,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.ОтключенныеЛентыНовостейДляОбластиДанных,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.РассчитанныеОтборыПоНовостям_Общие,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.ОтборыПоЛентамНовостейОбщие,
			НеИспользовать);
		...
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.ПривязкаНовостейКМетаданным,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.ОтборыПоЛентамНовостейПользовательские,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.Константы.НастройкиНовостей,
			НеИспользовать);
		...
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.ДатыЗагрузкиПоследнихНовостей,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.ВсеОбновленияНовостей,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.ДатыОбновленияСтандартныхСписковНовостей,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.ПериодическиеСвойстваНовостей,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.РассчитанныеОтборыПоНовостям_РедкоМеняющиеся,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.ОтключенныеЛентыНовостей,
			НеИспользовать);
		...
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.КатегорииНовостейПростые,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.РассчитанныеОтборыПоНовостям_Пользовательские,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.РассчитанныеОтборыПоНовостям_ДляОбластиДанных,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.РегистрыСведений.КатегорииНовостейПростыеНеобработанные,
			НеИспользовать);
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхОсновныеДанные,
			Метаданные.Константы.РазрешенаРаботаСНовостямиЧерезИнтернет,
			НеИспользовать);
	...
	Если ОбщийРеквизитОбластьДанныхВспомогательныеДанные <> Неопределено Тогда
		...
		СоставОбластьДанныхВспомогательныеДанные = Новый Массив;
		
		ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиОбщегоРеквизита(
			СоставОбластьДанныхВспомогательныеДанные,
			Метаданные.РегистрыСведений.ОтборыПоЛентамНовостейДляОбластиДанных,
			Использовать);
		...
		СвойстваОбластьДанныхВспомогательныеДанные.Вставить("Состав", СоставОбластьДанныхВспомогательныеДанные);
		
		ОписательЭталонныхНастроек.Вставить(ОбщийРеквизитОбластьДанныхВспомогательныеДанные, СвойстваОбластьДанныхВспомогательныеДанные);
		
	КонецЕсли;
	
	// Заполнение эталонных настроек определяемых типов
	// для проверки внедрения БИП.
	МестоХраненияФункциональныхОпций = Метаданные.ОпределяемыеТипы.Найти("МестоХраненияФункциональныхОпций");
	
	Если МестоХраненияФункциональныхОпций <> Неопределено Тогда
		
		ТипыМестоХраненияФункциональныхОпций = Новый Массив;
		ТипыМестоХраненияФункциональныхОпций.Добавить(Тип("КонстантаМенеджерЗначения.РазрешенаРаботаСНовостями"));
		ТипыМестоХраненияФункциональныхОпций.Добавить(Тип("КонстантаМенеджерЗначения.РазрешенаРаботаСНовостямиЧерезИнтернет"));
		
		СвойстваМестоХраненияФункциональныхОпций = Новый Структура;
		СвойстваМестоХраненияФункциональныхОпций.Вставить("Типы", ТипыМестоХраненияФункциональныхОпций);
		
		ОписательЭталонныхНастроек.Вставить(МестоХраненияФункциональныхОпций, СвойстваМестоХраненияФункциональныхОпций);
	...
	ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиРоли(
		НастройкиРоли,
		Метаданные.Константы.НастройкиНовостей,
		"Чт,Изм,Пр,Ред",
		Истина);
	...
	ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиРоли(
		НастройкиРоли,
		Метаданные.Обработки.УправлениеНовостями,
		"Исп,Пр",
		Истина);
	...
	ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиРоли(
		НастройкиРоли,
		Метаданные.ПланыВидовХарактеристик.КатегорииНовостей,
		"Чт,Доб,Изм,Уд,Пр,ИнтДоб,Ред,ИнтПомУд,ИСПУ,ИУП,ВПС",
		Истина);
	...
	ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиРоли(
		НастройкиРоли,
		Метаданные.ПланыВидовХарактеристик.КатегорииНовостей,
		"Доб,Изм,Уд,Пр,ИнтДоб,Ред,ИнтУд,ИнтПомУд,ИСПУ,ИУП,ВПС,ИнтУПД,ИнтПУПД,ИнтСПУПД,ИнтУППД",
		Ложь);
	...
	ИнтернетПоддержкаПользователей.ДобавитьНастройкуПроверкиРоли(
		НастройкиРоли,
		Метаданные.Справочники.Новости,
		"Доб,Изм,Уд,ИнтДоб,Ред,ИнтУд,ИнтПомУд,ИСПУ,ИУП,ИнтУПД,ИнтПУПД,ИнтСПУПД,ИнтУППД",
		Ложь);
