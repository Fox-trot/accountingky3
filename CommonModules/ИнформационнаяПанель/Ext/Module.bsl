...
Функция НастройкаПоУмолчанию() Экспорт
	...
	ВыбранныеБлоки.Добавить(БлокиИнформационнойПанелиКлиентСервер.ИмяБлокаТекущиеДела());
	...
	//ВыбранныеБлоки.Добавить(БлокиИнформационнойПанелиКлиентСервер.ИмяБлокаЗаметки());
...
Процедура ПрименитьНастройки(КоллекцияБлоков) Экспорт
	...
	НастройкаБлоков = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("ИнформационнаяПанель", "НастройкаБлоков");
	...
	Для Каждого Блок Из КоллекцияБлоков Цикл
		...
		Если Блок.Имя = "Покупатели"
			Или Блок.Имя = "Поставщики" Тогда 
			Блок.Пометка = Ложь;
			Продолжить;
		КонецЕсли;		
...
Процедура ЗаменитьУдалитьУстаревшиеБлокиИнформационнойПанелиВНастройкахПользователей() Экспорт
	...
	Для Каждого Пользователь Из ПользователиИнформационнойБазы.ПолучитьПользователей() Цикл
		...
		НастройкаБлоков = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить(
			"ИнформационнаяПанель",
			"НастройкаБлоков",
			,
			Пользователь.Имя);
