...
Процедура ПроверитьВозможностьВызова()
	...
	Если Не ОбщегоНазначения.ПодсистемаСуществует("ТехнологияСервиса.РаботаВМоделиСервиса") Тогда
		Подсистемы.Добавить(НСтр("ru = 'ТехнологияСервиса.РаботаВМоделиСервиса.БазоваяФункциональностьВМоделиСервиса'"));
	КонецЕсли;
	...
	Для Каждого Подсистема Из Подсистемы Цикл
		ТекстИсключения = Символы.ПС + Подсистема;
	КонецЦикла;
