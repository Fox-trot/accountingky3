...
Процедура ПриОпределенииОбщихПараметровБазовойФункциональности(ОбщиеПараметры) Экспорт
	...
	// БПКР
	//ОбщиеПараметры.Вставить("МинимальноНеобходимаяВерсияПлатформы", "8.3.12.1412");
	ОбщиеПараметры.Вставить("МинимальноНеобходимаяВерсияПлатформы", "8.3.11.3133");
	// Конец БПКР
...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	Если НЕ ДатаПервогоВходаВСистемуЗаполнена ИЛИ НЕ ПравоДоступа("Изменение", Метаданные.Справочники.Организации) Тогда  
		ПоказатьУправлениеНастройками = Ложь;
	Иначе
		ПоказатьУправлениеНастройками = ОбщегоНазначенияПовтИсп.ДоступноИспользованиеРазделенныхДанных()
			И ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("УправлениеНастройками", "Показывать", Истина);
	КонецЕсли;
	
	Если ПоказатьУправлениеНастройками Тогда
		ИмяОбработкиУправлениеНастройками = "УправлениеНастройками";
			
		Если Не ПравоДоступа("Использование", Метаданные.Обработки[ИмяОбработкиУправлениеНастройками]) Тогда
			ПоказатьУправлениеНастройками = Ложь;
		КонецЕсли;
	КонецЕсли;
	
	Параметры.Вставить("ПоказатьУправлениеНастройками",     ПоказатьУправлениеНастройками);
	Параметры.Вставить("ИмяОбработкиУправлениеНастройками", ИмяОбработкиУправлениеНастройками);
	// Конец УправлениеНастройками
