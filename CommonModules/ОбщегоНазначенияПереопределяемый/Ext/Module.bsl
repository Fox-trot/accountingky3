...
Процедура ПриОпределенииОбщихПараметровБазовойФункциональности(ОбщиеПараметры) Экспорт
	// БПКР
	ОбщегоНазначенияПереопределяемыйБП.ПриОпределенииОбщихПараметровБазовойФункциональности(ОбщиеПараметры);
	// Конец БПКР	
КонецПроцедуры
...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	// БПКР
	ОбщегоНазначенияПереопределяемыйБП.ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры);
	// Конец БПКР	
КонецПроцедуры
...
Процедура ПриОпределенииПоддерживаемыхВерсийПрограммныхИнтерфейсов(ПоддерживаемыеВерсии) Экспорт
	// БПКР
	ОбщегоНазначенияПереопределяемыйБП.ПриОпределенииПоддерживаемыхВерсийПрограммныхИнтерфейсов(ПоддерживаемыеВерсии);
	// Конец БПКР	
КонецПроцедуры
