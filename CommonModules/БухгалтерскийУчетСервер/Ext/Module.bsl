...
// Выполняет движения по РС "СведенияОПодакционныхТоварах"
//
Процедура ОтразитьСведенияОПодакционныхТоварах(ДополнительныеСвойства, Движения, Отказ) Экспорт
	...
	ДвиженияПоРегистру = Движения.СведенияОПодакционыхТоварах;
	ДвиженияПоРегистру.Записывать = Истина;
	ДвиженияПоРегистру.Загрузить(ТаблицаДляЗагрузки);	
...
// Выполняет движения по регистру накопления "ДанныеДляОтчетаРеестрВвезенных"
//
...
// Выполняет движения регистра сведений "РеестрПриобретенныхМатериальныхРесурсов"
//
Процедура ОтразитьРеестрПриобретенных(ДополнительныеСвойства, Движения, Отказ) Экспорт
	
	ТаблицаДляЗагрузки = ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаРеестрПриобретенных;
...
// Выполняет движения регистра сведений "ОтразитьПлатежиПоНалогуНаПрибль".
//
Процедура ОтразитьПлатежиПоНалогуНаПрибль(ДополнительныеСвойства, Движения, Отказ) Экспорт
	
	ТаблицаДляЗагрузки = ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаПлатежиПоНалогуНаПрибль;
	...
	ДвиженияПоРегистру = Движения.ПлатежиПоНалогуНаПрибль;
	ДвиженияПоРегистру.Записывать = Истина;
	ДвиженияПоРегистру.Загрузить(ТаблицаДляЗагрузки);	
