...
// Выполняет движения регистра накопления "СостояниеЗаказов".
//
...
// Функция возвращает значение константы РасчетыНеВВалютеДоговора.
// 
Функция СчитатьОперационныеКурсовыеРазницы() Экспорт
	
	Возврат Константы.СчитатьОперационныеКурсовыеРазницы.Получить();
	
КонецФункции // СчитатьОперационныеКурсовыеРазницы()
