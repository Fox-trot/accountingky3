...
// Выполняет движения по РС "ЗначенияСтавокНалоговНДСиНСП"
//
Процедура ОтразитьЗначенияСтавокНалоговНДСиНСП(ДополнительныеСвойства, Движения, Отказ) Экспорт
	
	ТаблицаДляЗагрузки = ДополнительныеСвойства.ТаблицыДляДвижений.ТаблицаЗначенияСтавокНалоговНДСиНСП;
	...
	ДвиженияПоРегистру = Движения.ЗначенияСтавокНалоговНДСиНСП;
	ДвиженияПоРегистру.Записывать = Истина;
	ДвиженияПоРегистру.Загрузить(ТаблицаДляЗагрузки);	
...
// Функция возвращает значение константы УчетРасчетовВВалютеДоговора.
// 
Функция УчетРасчетовВВалютеДоговора() Экспорт
	
	Возврат Константы.УчетРасчетовВВалютеДоговора.Получить();
	
КонецФункции // УчетРасчетовНеВВалютеДоговора()
