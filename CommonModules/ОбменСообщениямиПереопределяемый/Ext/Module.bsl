...
Процедура ПолучитьОбработчикиКаналовСообщений(Обработчики) Экспорт
	...
	ОбменСообщениямиПереопределяемыйБП.ПолучитьОбработчикиКаналовСообщений(Обработчики);	
...
Процедура ПолучателиСообщения(Знач КаналСообщений, Получатели) Экспорт
	...
	ОбменСообщениямиПереопределяемыйБП.ПолучателиСообщения(КаналСообщений, Получатели);
