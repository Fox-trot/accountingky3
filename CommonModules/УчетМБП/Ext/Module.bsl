...
Функция ПодготовитьПараметрыПоступлениеМБП(ТаблицаМБП, ТаблицаРеквизиты, ПоступлениеАО)
	...
	Если ПоступлениеАО Тогда
		СписокОбязательныхКолонок = СписокОбязательныхКолонок + ",Местонахождение"; // <СправочникСсылка.Склады> - склад, на который поступает МБП
	КонецЕсли;
	...
	Если НЕ ПоступлениеАО Тогда
		СписокОбязательныхКолонок = СписокОбязательныхКолонок + ",Склад"; // <СправочникСсылка.Склады> - склад, на который поступает МБП
	КонецЕсли;
