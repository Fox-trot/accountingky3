...
//
Функция РасчетАмортизацииОсновногоСредства(ПериодСтоимости, ПериодОстатков, Организация, ОсновноеСредство, НачислениеАмортизацииОСПоМесяцам = Ложь) Экспорт
	Возврат УправлениеВнеоборотнымиАктивами.РасчетАмортизации(ПериодСтоимости, ПериодОстатков, Организация, ОсновноеСредство, НачислениеАмортизацииОСПоМесяцам); 
