...
Функция ДанныеСчетаУчетаЗП(СтруктураОтбора) Экспорт 
	...
	РезультатСчетаУчетаЗП = Новый Структура("СчетУчетаЗатрат, СтатьяЗатрат, СчетУчетаЗатратСоцОтчисления, СтатьяЗатратСоцОтчисления, НоменклатурнаяГруппа", 
	...
	Запрос.Текст = 
		...
		|	СчетаУчетаЗП.НоменклатурнаяГруппа КАК НоменклатурнаяГруппа
		...
		|	ВременнаяТаблицаСчетаУчетаЗПОтбор.НоменклатурнаяГруппа КАК НоменклатурнаяГруппа
		|ИЗ
