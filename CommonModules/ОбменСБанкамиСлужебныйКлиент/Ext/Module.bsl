...
Процедура ВыполнитьДействияПослеОтправки(Параметры)
	...
	ВывестиИнформациюОбОбработанныхЭД(ТекстЗаголовка, Параметры.ИтогКоличествоНовыхЭД, Параметры.КоличествоПодписанных,
		Параметры.КоличествоПодготовленных, Параметры.КоличествоОтправленных, Параметры.ПодтверждениеПлатежейВБанке);
...
Процедура ВывестиИнформациюОбОбработанныхЭД(ТекстЗаголовка, КоличествоСформированных, КоличествоПодписанных, КоличествоПодготовленных, КоличествоОтправленных = 0, ПодтверждениеПлатежейВБанке = Неопределено)
...
Процедура ПослеОбработкиДокументов(РезультатЗадания, Параметры) Экспорт
	...
	Иначе // выполнено
		...
		Если Результат <> Неопределено Тогда
			...
			ИтогКоличествоНовыхЭД = 0; КоличествоПодписанных = 0; КоличествоПодготовленных = 0;
			...
			Если НЕ Результат.Свойство("КоличествоПодписанных", КоличествоПодписанных) Тогда
			...
			Параметры.Вставить("КоличествоПодписанных", КоличествоПодписанных);
