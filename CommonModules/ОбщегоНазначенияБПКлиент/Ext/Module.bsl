...
Процедура ОткрытьФормуПодбораИзКлассификатора(ИмяСправочника, ПолныйПутьКМакету, Заголовок, 
	...
	СтруктураПараметров = Новый Структура("ИмяСправочника,ПолныйПутьКМакету,Заголовок,ИмяЭкспортнойПроцедуры",
		ИмяСправочника,
		ПолныйПутьКМакету,
		Заголовок,
...
Процедура ОткрытьУправлениеНастройками(ИмяОбработки) Экспорт
