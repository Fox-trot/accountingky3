...
Процедура ПриОпределенииПроверок(ГруппыПроверок, Проверки) Экспорт
	...
	Проверка.ОбработчикПроверки           = "КонтрольВеденияУчетаПереопределяемый.ПроверкаСальдоСчетов_1540_1549_3430";
	Проверка.КонтекстПроверокВеденияУчета = "ПланСчетов";
	...
	Проверка.ОбработчикПроверки           = "КонтрольВеденияУчетаПереопределяемый.ПроверкаЗаполненияВалютыИВалютнойСуммыПроводок";
	Проверка.КонтекстПроверокВеденияУчета = "Общее";
	// Конец БПКР
