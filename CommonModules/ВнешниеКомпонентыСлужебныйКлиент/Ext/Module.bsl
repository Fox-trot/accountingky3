	...
	Если Результат.Статус = "Выполнено" Тогда
		...
		Иначе 
			...
			Оповещение = Новый ОписаниеОповещения(
				"ПодключитьКомпонентуПослеЗакрытияФормыНеДоступноВКлиенте", ЭтотОбъект, Контекст);
...
// Передача управления обработке возврата ошибки.
//
Процедура ПодключитьКомпонентуПослеЗакрытияФормыНеДоступноВКлиенте(Результат, Контекст) Экспорт
...
// Передача управления обработке установки компонент.
//
