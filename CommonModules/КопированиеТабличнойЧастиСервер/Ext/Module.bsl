...
Процедура ПриСозданииНаСервере(ЭлементыФормы, ИмяТЧ) Экспорт
	
	ЕстьСкопированныеСтроки = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("БуферОбменаТабличныеЧасти", "Строки") <> Неопределено;
...
Процедура Копировать(ТЧ, ВыделенныеСтроки, КоличествоСкопированных) Экспорт
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("БуферОбменаТабличныеЧасти", "Строки", СкопированныеСтроки);
...
Процедура Вставить(Объект, ИмяТЧ, ЭлементыФормы, КоличествоСкопированных, КоличествоВставленных) Экспорт
	...
	ДобавляемыеСтроки = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("БуферОбменаТабличныеЧасти", "Строки");
