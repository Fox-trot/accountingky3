...
Процедура ОбновитьПользователя(ЗначенияРеквизитов, ПараметрыРаботыКлиента)
	...
	БухгалтерскийУчетСервер.УстановитьНастройкуПользователя(Справочники.Организации.ОсновнаяОрганизация, "ОсновнаяОрганизация", ПользовательСсылка);
	БухгалтерскийУчетСервер.УстановитьНастройкуПользователя(Справочники.Склады.Основной, "ОсновнойСклад", ПользовательСсылка);
