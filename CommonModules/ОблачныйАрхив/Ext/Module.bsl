...
Процедура ПроверитьПравильностьВнедрения(ОписательОшибок, ОбъектыИПП) Экспорт
	...
	Подсистема = Метаданные.Подсистемы.ИнтернетПоддержкаПользователей.Подсистемы.ОблачныйАрхив;
...
Функция НовыйОписательЭталонныхНастроек()
	...
	Если МестоХраненияФункциональныхОпций <> Неопределено Тогда
		...
		ТипыМестоХраненияФункциональныхОпций.Добавить(Тип("КонстантаМенеджерЗначения.РазрешенаРаботаСОблачнымАрхивом"));
