...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ИначеЕсли ИмяФормы = "Документ.ЗакрытиеМесяцаЗП.Форма.ФормаДокумента" 
		...
		ИЛИ ИмяФормы = "Документ.СправкиДляПН.Форма.ФормаДокумента" 
		...
		ИЛИ ИмяФормы = "Документ.УдержаниеПоГрафику.Форма.ФормаДокумента" 
		ИЛИ ИмяФормы = "Документ.ОтчетыПоНалогамЗП.Форма.ФормаДокумента"  
