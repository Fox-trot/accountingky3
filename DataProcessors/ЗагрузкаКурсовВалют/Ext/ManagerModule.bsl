...
Процедура ДополнитьПараметрыПолученияДаннымиСтатистики(ПараметрыПолучения)
	...
	УстановитьПривилегированныйРежим(Ложь);
	ПараметрыПолученияФайла.Заголовки.Вставить("login", ДанныеАутентификации.Логин);
	ПараметрыПолученияФайла.Заголовки.Вставить("password", ДанныеАутентификации.Пароль);
