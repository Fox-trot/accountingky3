...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ЭтоОсновнаяФормаПрайсЛистов.Пометка = (БухгалтерскийУчетВызовСервераПовтИсп.ПолучитьЗначениеНастройки("ОсновнаяФормаПрайсЛиста") = Перечисления.ОсновнаяФормаПрайсЛиста.ФормированиеПрайсЛистов);
	
	Если Параметры.Свойство("ОткрытьОсновнойРабочийПрайсЛист") Тогда
		
		ПрайсЛист = БухгалтерскийУчетВызовСервераПовтИсп.ПолучитьЗначениеНастройки("ОсновнойРабочийПрайсЛист");
	...
	АвтоматическиФормироватьОбновлятьПрайсЛист = (ЗначениеЗаполнено(ПрайсЛист) И БухгалтерскийУчетВызовСервераПовтИсп.ПолучитьЗначениеНастройки("АвтоматическиФормироватьОбновлятьПрайсЛист"));
...
Процедура ИзменитьНастройкуОсновнойФормыПрайсЛистов()
	...
	БухгалтерскийУчетСервер.УстановитьНастройкуПользователя(ЗначениеНастройки, "ОсновнаяФормаПрайсЛиста");
