...
Процедура ОбновитьЗначенияОтборовИПараметров()
	...
	// Список Приказы 
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокСотрудники, "Организация", ОтборОрганизация, ЗначениеЗаполнено(ОтборОрганизация));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокПриказов, "ФизЛицо", ОтборФизЛицо, ЗначениеЗаполнено(ОтборФизЛицо));
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокПриказов, "Подразделение", ОтборПодразделение, ЗначениеЗаполнено(ВыбранноеПодразделение));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокСтатусыСотрудников, "ФизЛицо", ОтборФизЛицо, ЗначениеЗаполнено(ОтборФизЛицо));
	
	// Список начисления и удержания
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокНачисления, "Организация", ОтборОрганизация, ЗначениеЗаполнено(ОтборОрганизация));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокНачисленияУдержания, "ФизЛицо", ОтборФизЛицо, ЗначениеЗаполнено(ОтборФизЛицо));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокНачисленияУдержания, "ПериодРегистрации", ОтборПериодРегистрации, ЗначениеЗаполнено(ОтборПериодРегистрации));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокНачисленияУдержания, "Подразделение", ОтборПодразделение, ЗначениеЗаполнено(ВыбранноеПодразделение));
	
	
	// Список налоги
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокНалоги, "Организация", ОтборОрганизация, ЗначениеЗаполнено(ОтборОрганизация));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокНалоги, "ФизЛицо", ОтборФизЛицо, ЗначениеЗаполнено(ОтборФизЛицо));
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокНалоги, "Подразделение", ОтборПодразделение, ЗначениеЗаполнено(ВыбранноеПодразделение));
	...
	// Список взаиморасчеты
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокВзаиморасчеты, "Организация", ОтборОрганизация, ЗначениеЗаполнено(ОтборОрганизация));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокВзаиморасчеты, "ФизЛицо", ОтборФизЛицо, ЗначениеЗаполнено(ОтборФизЛицо));
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокВзаиморасчеты, "Подразделение", ОтборПодразделение, ЗначениеЗаполнено(ВыбранноеПодразделение));
	
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(СписокВзаиморасчеты, "НачалоПериода", НачалоМесяца(ОтборПериодРегистрации));
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(СписокВзаиморасчеты, "КонецПериода", КонецМесяца(ОтборПериодРегистрации));
	
	// Список выплаты
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокВыплаты, "Организация", ОтборОрганизация, ЗначениеЗаполнено(ОтборОрганизация));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокВыплаты, "ФизЛицо", ОтборФизЛицо, ЗначениеЗаполнено(ОтборФизЛицо));
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокВыплаты, "Подразделение", ОтборПодразделение, ЗначениеЗаполнено(ВыбранноеПодразделение));
	...
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокСоциальныйФонд, "Организация", ОтборОрганизация, ЗначениеЗаполнено(ОтборОрганизация));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокСоциальныйФонд, "ФизЛицо", ОтборФизЛицо, ЗначениеЗаполнено(ОтборФизЛицо));
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокСоциальныйФонд, "Подразделение", ОтборПодразделение, ЗначениеЗаполнено(ВыбранноеПодразделение));
	...
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокПодоходныйНалог, "Организация", ОтборОрганизация, ЗначениеЗаполнено(ОтборОрганизация));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокПодоходныйНалог, "ФизЛицо", ОтборФизЛицо, ЗначениеЗаполнено(ОтборФизЛицо));
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокПодоходныйНалог, "Подразделение", ОтборПодразделение, ЗначениеЗаполнено(ВыбранноеПодразделение));
	...
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокНачисленияСчетаУчетаЗП, "ФизЛицо", ОтборФизЛицо, ЗначениеЗаполнено(ОтборФизЛицо));
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокНачисленияСчетаУчетаЗП, "ПериодРегистрации", ОтборПериодРегистрации, ЗначениеЗаполнено(ОтборПериодРегистрации));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокНачисленияСчетаУчетаЗП, "Подразделение", ОтборПодразделение, ЗначениеЗаполнено(ВыбранноеПодразделение));
...
Процедура РассчитатьИтогиНаСервере()
	...
	//
	//СуммаПриходВзаиморасчетыИтог = ПолучитьТаблицуДинамическогоСписка("СписокВзаиморасчеты").Итог("СуммаПриход");
	//СуммаРасходВзаиморасчетыИтог = ПолучитьТаблицуДинамическогоСписка("СписокВзаиморасчеты").Итог("СуммаРасход");
	//СуммаОборотВзаиморасчетыИтог = ПолучитьТаблицуДинамическогоСписка("СписокВзаиморасчеты").Итог("СуммаОборот");
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОтборПериодРегистрации = НачалоМесяца(ТекущаяДата());
	...
	Если НЕ ЗначениеЗаполнено(ОтборПериодРегистрации) Тогда 
		ОтборПериодРегистрации = ТекущаяДата();
	КонецЕсли;		
	
	УстановитьВидимостьДоступностьЭлементов();
	//БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(СписокФизическиеЛица, "Организация", ОтборОрганизация, ЗначениеЗаполнено(ОтборОрганизация));
...
Процедура ПриЗагрузкеДанныхИзНастроекНаСервере(Настройки)
	...
	//	ОтборОрганизация = БухгалтерскийУчетПовтИсп.ПолучитьЗначениеНастройки("ОсновнаяОрганизация");
	//КонецЕсли;	
...
// Процедура - обработчик команды открытия формы записи РС "УчетнаяПолитикаПоПерсоналу" по дате указанной на форме 
//
&НаКлиенте
Процедура УПП(Команда)
	
	ОрганизацияОтбора = ?(ЗначениеЗаполнено(ОтборПодразделение), ОтборПодразделение, Неопределено);
	
	ПараметрыОткрытия = Новый Структура("Ключ", ПолучитьКлючУПП(ОтборПериодРегистрации));
	
	Попытка 
		ОткрытьФорму("РегистрСведений.УчетнаяПолитикаПоПерсоналу.Форма.ФормаЗаписи", ПараметрыОткрытия);
	Исключение
		// Сформируем сообщение для пользователя
		СообзениеОбОшибке = ОписаниеОшибки();
		ПозицияОтсечения = СтрНайти(СообзениеОбОшибке, ":", НаправлениеПоиска.СКонца);
		ТекстСообщения = Прав(СообзениеОбОшибке, СтрДлина(СообзениеОбОшибке) - ПозицияОтсечения - 1);
