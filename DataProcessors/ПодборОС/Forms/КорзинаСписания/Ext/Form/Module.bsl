...
Процедура ИзменитьВидимостьКорзины(Команда)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "Корзина", "Видимость", Элементы.ФормаИзменитьВидимостьКорзины.Пометка);
...
Процедура УстановитьТекстЗапросаСписокОС(ЭтоДокументПоступления)
	ТекстЗапроса = 
		...
		|	СправочникОсновныеСредства.Ссылка КАК ОсновноеСредство,
