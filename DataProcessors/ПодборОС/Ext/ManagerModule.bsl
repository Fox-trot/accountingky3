...
Функция СтруктураОбязательныхПараметров()
	...
	Возврат Новый Структура("Дата, Организация, ЭтоДокументПоступления, УникальныйИдентификаторФормыВладельца", "Дата", "Организация", "Признак- документ поступления", "Уникальный идентификатор формы владельца");
