...
Функция СтруктураОбязательныхПараметров()
	...
	Возврат Новый Структура("ДокументСсылка, Дата, Организация, ЭтоДокументПоступления, УникальныйИдентификаторФормыВладельца", 
		"Ссылка на регистрирующий документ (может быть пустой)", 
		"Дата", "Организация", 
		"Признак- документ поступления", 
