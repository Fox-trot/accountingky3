...
Процедура ПриОткрытии(Отказ)
	...
	НаименованиеПредыдущейСтраницы = Элементы.ГруппаСтраницы.ТекущаяСтраница.Имя;
...
Процедура РасшифровкаПоДокументам(Команда)
	...
	Иначе	
		...
		Если МассивДокументов.Количество() = 0 Тогда		
			ТекстСообщения = НСтр("ru = 'За выбранный период по контрагенту нет документов с ошибками, проверь предыдушие периоды.'");
			ОбщегоНазначенияКлиент.СообщитьПользователю(ТекстСообщения);
...
Процедура ГруппаСтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	Если ТекущаяСтраница = Элементы.ГруппаОперации Тогда 
		...
		Иначе
			СТЧ = Элементы.ОбороткаСчетаДоговоры.ТекущиеДанные;
		КонецЕсли;	
	...
	Если Элементы.ГруппаСтраницы.ТекущаяСтраница.Имя = "ГруппаДоговоры" 
		ИЛИ Элементы.ГруппаСтраницы.ТекущаяСтраница.Имя = "ГруппаСчетДоговор" Тогда
		НаименованиеПредыдущейСтраницы = Элементы.ГруппаСтраницы.ТекущаяСтраница.Имя;
	КонецЕсли;
КонецПроцедуры
