...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Обработки.ПодборНоменклатуры.ПроверитьЗаполнениеПараметров(Параметры, Отказ, "КорзинаСписанияКонтрагент");
	...
	Заголовок = СтрШаблон(НСтр("ru = 'Подбор товаров на дату %1 от контрагента %2 по складу %3'"), Объект.Дата, Объект.Контрагент, Объект.Склад);
