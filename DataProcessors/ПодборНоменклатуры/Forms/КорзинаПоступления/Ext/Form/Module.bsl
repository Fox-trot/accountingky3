...
Процедура ДобавитьНоменклатуруВКорзину()
	...
	Иначе
		ДанныеСтрокиКорзины.Вставить("Цена", 0);
	КонецЕсли;
	
	Если КешНастройкиПодбора.ЗапрашиватьКоличество ИЛИ КешНастройкиПодбора.ЗапрашиватьЦену Тогда
		...
		ДанныеСтрокиКорзины.Вставить("Корзина", 			"КорзинаПоступления");
