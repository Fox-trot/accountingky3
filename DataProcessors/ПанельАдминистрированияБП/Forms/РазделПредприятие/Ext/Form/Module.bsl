...
Процедура УстановитьДоступность(РеквизитПутьКДанным = "")
	...
	Если РежимРаботы.ЭтоАдминистраторСистемы 
		...
		//Если РеквизитПутьКДанным = "НаборКонстант.ФункциональнаяОпцияУчетПоНесколькимОрганизациям" ИЛИ РеквизитПутьКДанным = "" Тогда
		//	НаборКонстант.ФункциональнаяОпцияУчетПоНесколькимОрганизациям = ПолучитьФункциональнуюОпцию("ФункциональнаяОпцияУчетПоНесколькимОрганизациям");
		//	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СправочникОрганизации", "Доступность", НаборКонстант.ФункциональнаяОпцияУчетПоНесколькимОрганизациям);
		//КонецЕсли;
		//
		//Если РеквизитПутьКДанным = "НаборКонстант.ФункциональнаяОпцияУчетПоНесколькимОрганизациям" ИЛИ РеквизитПутьКДанным = "" Тогда
		//	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "СправочникПодразделения", "Доступность", НаборКонстант.ФункциональнаяОпцияУчетПоНесколькимОрганизациям);
		//КонецЕсли;
	КонецЕсли;
...
Функция ЗаполнитьСправочникГНСНаСервере()
	Количество = 0;
	Справочники.ГНС.ЗаполнитьПоУмолчанию(Количество);
	Возврат Количество; 
КонецФункции
...
Процедура ОтветНаВопросЗаполнитьСправочникГНС(РезультатВопроса, ДополнительныеПараметры) Экспорт
	Если РезультатВопроса = КодВозвратаДиалога.Да Тогда
		...
		ТекстПояснения = СтрЗаменить(ТекстПояснения, "%Количество%", МассивЭлементов);
