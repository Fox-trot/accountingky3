...
Процедура ФункциональнаяОпцияУчетДвиженияОСПоПодразделениямПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
	ФункциональнаяОпцияУчетДвиженияОСПриИзменении();		
КонецПроцедуры
...
// Процедура - обработчик события ПриИзменении флага ФункциональнаяОпцияУчетПроизводстваПоЗаказам.
//
&НаКлиенте
Процедура ФункциональнаяОпцияУчетПроизводстваПоЗаказамПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
	
	//Если ПолучитьФункциональнуюОпцию("УчетПроизводстваПоЗаказам") Тогда 
	//	// По заказам.
	//	
	//Иначе 
	//	// По номенклатурным группам.
	//	Обработки.ПанельАдминистрированияБП.ВключитьУчетПроизводстваПоНоменклатурнымГруппам();		
	//КонецЕсли;	
	
КонецПроцедуры

// Процедура - обработчик события ПриИзменении флага ИспользоватьНесколькоНоменклатурныхГрупп.
//
&НаКлиенте
Процедура ИспользоватьНесколькоНоменклатурныхГруппПриИзменении(Элемент)
	Подключаемый_ПриИзмененииРеквизита(Элемент);
КонецПроцедуры
...
&НаСервере
Процедура ФункциональнаяОпцияУчетДвиженияОСПриИзменении()                     
	Если ПолучитьФункциональнуюОпцию("УчетДвиженияОСПоПодразделениям") Тогда 
		Обработки.ПанельАдминистрированияБП.ВключитьУчетДвиженияОСПоПодразделениям();
	КонецЕсли;
	Если ПолучитьФункциональнуюОпцию("УчетДвиженияОСПоМОЛ") Тогда 
		Обработки.ПанельАдминистрированияБП.ВключитьУчетДвиженияОСПоМОЛ();		
	КонецЕсли;	
	
	// Обновление движений документов ОС.
	Если ПолучитьФункциональнуюОпцию("УчетДвиженияОСПоПодразделениям")
		Или ПолучитьФункциональнуюОпцию("УчетДвиженияОСПоМОЛ") Тогда 
