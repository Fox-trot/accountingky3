...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	...
	КонстантаЗначение = НаборКонстант.ИспользоватьНесколькоОрганизаций;
	Если ЗначениеПриОткрытииИспользоватьНесколькоОрганизаций <> КонстантаЗначение Тогда
		Оповестить("Запись_НаборКонстант", Новый Структура("Значение", КонстантаЗначение), "ИспользоватьНесколькоОрганизаций");
	КонецЕсли;
