...
Функция ПолучитьСводнуюТаблицуПереоценки()
	...
	|	Выбор когда ХозрасчетныйОборотыДтКт.СчетКт = Значение(ПланСчетов.Хозрасчетный.ДоходОтКурсовыхРазницПоОперациямВИностраннойВалюте) Тогда ""Доход"" Иначе ""Убытки"" Конец КАК Результат,
