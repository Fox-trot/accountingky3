...
#Область ОбработчикиСобытийЭлементовТаблицыФормыСписокРКОиППИ

&НаКлиенте
Процедура СписокРКОиППИВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	ДокументМенеджер = ПолучениеТипаДокумента();	
...
Процедура СформироватьРКО(Команда)
	...
	Отказ = Ложь;
	НаименованиеКомандыОбращения = "СформироватьРКО_ППИ";
...
Процедура ПереформироватьРКО(Команда)	
	...
	Отказ = Ложь;	
	НаименованиеКомандыОбращения = "ПереформироватьРКО_ППИ";	
	ПроверкаДанныхПередФормированиемИПереформированием(НаименованиеКомандыОбращения, Отказ);
...
Процедура СозданиеДокументовВыплаты(МассивДокументов, НаименованиеКомандыОбращения)
	...
	Если НаименованиеКомандыОбращения = "ПереформироватьРКО_ППИ" Тогда
	...
	ИначеЕсли НаименованиеКомандыОбращения = "СформироватьРКО_ППИ" Тогда
...
Функция ПолучениеТипаДокумента()

	Если Объект.Ведомость.ВидВыплаты = ПредопределенноеЗначение("Перечисление.ВидыВыплатыЗарплаты.ЧерезБанк") Тогда
		ТипДокумента = "Документ.ПлатежноеПоручениеИсходящее";	
	ИначеЕсли Объект.Ведомость.ВидВыплаты = ПредопределенноеЗначение("Перечисление.ВидыВыплатыЗарплаты.ЧерезКассу") Тогда
		ТипДокумента = "Документ.РасходныйКассовыйОрдер";
	КонецЕсли;
	
	Возврат ТипДокумента;
КонецФункции // ПолучениеТипаДокумента()
