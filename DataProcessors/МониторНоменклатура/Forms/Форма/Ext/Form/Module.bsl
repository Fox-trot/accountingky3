...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОтборПартионныйУчет Тогда
		Элементы.ДекорацияПаритонныйУчет.Заголовок = НСтр("ru = 'Учет по ФИФО'");
	Иначе
		Элементы.ДекорацияПаритонныйУчет.Заголовок = НСтр("ru = 'Учет по СВЦ'");
	КонецЕсли;	
КонецПроцедуры
...
Процедура ОтборОрганизацияПриИзменении(Элемент)
	...
	Если ОтборПартионныйУчет Тогда
		Элементы.ДекорацияПаритонныйУчет.Заголовок = НСтр("ru = 'ФИФО'");
	Иначе
		Элементы.ДекорацияПаритонныйУчет.Заголовок = НСтр("ru = 'СВЦ'");
	КонецЕсли;	
