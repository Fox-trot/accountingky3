...
Процедура СохранитьНастройки()  
	...
	ХранилищеОбщихНастроек.Сохранить("МониторНоменклатуры", , Настройки, , Пользователи.ТекущийПользователь().Наименование);
КонецПроцедуры

&НаСервере
Процедура ВосстановитьНастройки()

	СтруктураНастроек = ХранилищеОбщихНастроек.Загрузить("МониторНоменклатуры", , , Пользователи.ТекущийПользователь().Наименование);
