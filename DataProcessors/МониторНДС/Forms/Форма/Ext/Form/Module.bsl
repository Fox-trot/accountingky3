...
Процедура СформироватьНаСервере()
	...
	Для Каждого СтрокаТаблицы Из СтруктураДанных.ТаблицаДетальныеЗаписи Цикл
		...
		Если МассивСтрок.Количество() = 0 Тогда
			...
			НоваяСтрокаТаблицы.Доход = СтрокаТаблицы.СуммаБезНДС;
			НоваяСтрокаТаблицы.Владелец = "Строка 50";
		...
		Иначе
			Для Каждого Строка Из МассивСтрок Цикл	
				...
				Строка.Доход = СтрокаТаблицы.СуммаБезНДС;
			КонецЦикла;	
		КонецЕсли;
		...
		Если СтрокаТаблицы.ПризнакСтраны = Перечисления.ПризнакиСтраны.КР Тогда
			СуммаДоходаОтПродажКР = СуммаДоходаОтПродажКР + СтрокаТаблицы.СуммаБезНДС;	
		КонецЕсли;	
	КонецЦикла;	
