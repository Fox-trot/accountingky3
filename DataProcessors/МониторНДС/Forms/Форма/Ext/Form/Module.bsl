...
Процедура СформироватьНаСервере()
	...
	ТаблицаВсехПоступлений	= УчетНДСВызовСервера.ВсеСведенияОПоступлении(Организация, ДатаНачала, ДатаОкончания);	
	...
	НоваяСтрокаТаблицы = Расшифровка.Добавить();
	НоваяСтрокаТаблицы.Строка = "053 / 054";
	НоваяСтрокаТаблицы.Сумма = ?(Сумма054 = 0, 0, Окр(Сумма053/Сумма054, 4));
	НоваяСтрокаТаблицы.Владелец = "КфОПР";
