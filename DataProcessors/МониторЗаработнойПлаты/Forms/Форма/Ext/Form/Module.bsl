...
Процедура СформироватьТаблицуСписокСотрудников()
	...
	Запрос.Текст = 
		...
		|						ИЗ
		|							ВременнаяТаблицаРаботающиеНаНачалоПериода КАК ТаблицаСотрудники)
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ВременнаяТаблицаИтоговыеДанные.ТабельныйНомер КАК ТабельныйНомер,
		|	ВременнаяТаблицаИтоговыеДанные.ФизЛицо КАК ФизЛицо,
		|	ВременнаяТаблицаИтоговыеДанные.Должность КАК Должность,
		|	ВременнаяТаблицаИтоговыеДанные.Подразделение КАК Подразделение,
		|	ВременнаяТаблицаИтоговыеДанные.Регистратор КАК Регистратор,
		|	ВременнаяТаблицаИтоговыеДанные.ВидСобытия КАК ВидСобытия,
		|	ВременнаяТаблицаИтоговыеДанные.ГрафикРаботы КАК ГрафикРаботы,
		|	ВременнаяТаблицаИтоговыеДанные.ФизЛицоНаименование КАК ФизЛицоНаименование
		|ИЗ
		|	ВременнаяТаблицаИтоговыеДанные КАК ВременнаяТаблицаИтоговыеДанные
		|ГДЕ
		|	НЕ ВременнаяТаблицаИтоговыеДанные.ФизЛицо В
		|				(ВЫБРАТЬ
		|					ВременнаяТаблицаУволенныеНаНачалоПериода.ФизЛицо
		|				ИЗ
		|					ВременнаяТаблицаУволенныеНаНачалоПериода)
		|
		|УПОРЯДОЧИТЬ ПО
		|	ФизЛицоНаименование";		
