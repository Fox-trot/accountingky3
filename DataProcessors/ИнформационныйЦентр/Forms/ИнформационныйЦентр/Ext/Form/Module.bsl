...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЕстьПравоДоступаКБухфону Тогда
		ИнтеграцияПодсистемБТС.ИнтеграцияВызовОнлайнПоддержкиПриСозданииНаСервере(Элементы.ОбщаяКомандаЗапустить1СБухфон);
	КонецЕсли;
...
Процедура ДомашняяСтраницаНажатие(Элемент)
	...
	ФайловаяСистемаКлиент.ОткрытьНавигационнуюСсылку(ДомашняяСтраница.Адрес);
