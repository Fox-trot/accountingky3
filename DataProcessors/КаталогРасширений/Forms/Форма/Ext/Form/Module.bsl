...
Функция ЗагрузитьДанныеРасширений(Знач МассивРасширений)
	...
	ТекстЕще = НСтр("ru = 'Показать еще';en = 'Show more'");
	...
	Для Каждого ДанныеРасширения Из МассивРасширений Цикл
		...
		НоваяСтрока.НаименованиеВерсии = СтрШаблон(НСтр("ru = 'Версия: %1';en = 'Version: %1'"), 
			НоваяСтрока.НаименованиеВерсии);
			
		НоваяСтрока.Разработчик = СтрШаблон(НСтр("ru = 'Разработчик: %1';en = 'Developer: %1'"), 
			НоваяСтрока.Разработчик);

		НоваяСтрока.Состояние = СостояниеРасширения(НоваяСтрока.Состояние);
		
		ДанныеРасширения.Свойство("МаксимальноеКоличествоЭлементов", МаксимальноеКоличествоЭлементов);
