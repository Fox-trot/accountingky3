		...
		Иначе
			...
			ЗаписьЖурналаРегистрации(
				НСтр("ru = 'ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаПропущена';
					|en = 'DataExportImport.ObjectExportSkipped'", ОбщегоНазначения.КодОсновногоЯзыка()),
				...
				СтрШаблон(НСтр("ru = 'Загрузка данных объекта метаданных %1 пропущена, т.к. он включен в
                          ...
                          | the metadata object list excluded from data export and import.'", ОбщегоНазначения.КодОсновногоЯзыка()),
...
Процедура ЗагрузитьДанныеОбъектаИнформационнойБазы(Знач ОбъектМетаданных)
	...
	ЗаписьЖурналаРегистрации(
		НСтр("ru = 'ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаМетаданных';
			|en = 'ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаМетаданных'", ОбщегоНазначения.КодОсновногоЯзыка()),
		УровеньЖурналаРегистрации.Информация,
		ОбъектМетаданных,
		,
		СтрШаблон(НСтр("ru = 'Начало загрузки данных объекта метаданных: %1';
						|en = 'Starting import of metadata object data: %1'", ОбщегоНазначения.КодОсновногоЯзыка()),
			ОбъектМетаданных.ПолноеИмя()));
		...
		Если ОбщегоНазначенияБТС.ЭтоНезависимыйНаборЗаписей(МетаданныеОбъекта) Тогда
			...
			Исключение
				...
				Комментарий = СтрШаблон(НСтр("ru = 'Объекта метаданных %1 с представлением ""%2"" не загружен по причине: %3';
											|en = 'Metadata object %1 with the ""%2"" presentation is not imported due to: %3'", ОбщегоНазначения.КодОсновногоЯзыка()),
				...
				ЗаписьЖурналаРегистрации(
					НСтр("ru = 'ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаМетаданных.Ошибка';
						|en = 'ВыгрузкаЗагрузкаДанных.ЗагрузкаОбъектаМетаданных.Ошибка'", ОбщегоНазначения.КодОсновногоЯзыка()),
