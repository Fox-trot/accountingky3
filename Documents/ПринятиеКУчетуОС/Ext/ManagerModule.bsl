...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =
		...
		|	ТаблицаДокумента.СпособыОтраженияРасходовПоАмортизации.СчетЗатрат КАК СчетДт,
		|	ТаблицаДокумента.СпособыОтраженияРасходовПоАмортизации.Субконто1 КАК СубконтоДт1,
		|	ТаблицаДокумента.СпособыОтраженияРасходовПоАмортизации.Субконто2 КАК СубконтоДт2,
		|	ТаблицаДокумента.СпособыОтраженияРасходовПоАмортизации.Субконто3 КАК СубконтоДт3,
		...
		|	ВременнаяТаблицаШапка.СтатьяДохода,
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
...
Процедура СформироватьТаблицаЗапасы(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	|	ТаблицаДокумента.ПервоначальнаяСтоимость КАК Цена,
...
Функция ПечатьАктаПриемкиПередачиОС(МассивОбъектов, ОбъектыПечати)
	...
	ТабличныйДокумент.КлючПараметровПечати 	= "ПАРАМЕТРЫ_ПЕЧАТИ_ПринятиеКУчетуОС_АктПриемкиПередачиОС";
	ТабличныйДокумент.ИмяПараметровПечати 	= "ПринятиеКУчетуОС_АктПриемкиПередачиОС";
	...
	Пока Шапка.Следующий()  Цикл
	    ...
	    ОбластьМакета.Параметры.НомерДокумента 	= ПрефиксацияОбъектовКлиентСервер.ПолучитьНомерНаПечать(Шапка.НомерДокумента);
		...
		ОбластьМакета.Параметры.ОснованиеПеремещения = Шапка.ДокументОснованиеВид 
						+ ?(ЗначениеЗаполнено(Шапка.ДокументОснованиеНомер), ", № " + ПрефиксацияОбъектовКлиентСервер.ПолучитьНомерНаПечать(Шапка.ДокументОснованиеНомер), "") 
