...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства, Отказ)	
	...
	Запрос.Текст =
		...
		|	ВременнаяТаблицаТовары.СубконтоОприходования1 КАК КорСубконто1,
		|	ВременнаяТаблицаТовары.СубконтоОприходования2 КАК КорСубконто2,
		|	ВременнаяТаблицаТовары.СубконтоОприходования3 КАК КорСубконто3,
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, СтруктураДополнительныеСвойства, Отказ) Экспорт 
	...
	Запрос.Текст = 
		...
		|	ТаблицаДокумента.СубконтоОприходования1,
		|	ТаблицаДокумента.СубконтоОприходования2,
		|	ТаблицаДокумента.СубконтоОприходования3
