...
Функция ПечатьОтчетаОбИспользованииБланков(МассивОбъектов, ОбъектыПечати)
	...
	Макет = ПолучитьМакет("ПФ_MXL_ОтчетОбИспользованииБланков");
	...
	ТабличныйДокумент = Новый ТабличныйДокумент;
	ТабличныйДокумент.ИмяПараметровПечати = "ПараметрыПечати_ОтчетОбИспользованииБланковСФ";
...
Функция ПечатьОтчетаОбИспользованииБланковЛандшафт(МассивОбъектов, ОбъектыПечати)
	Для каждого ДокументСсылка Из МассивОбъектов Цикл	
		...
		ТабличныйДокумент.АвтоМасштаб = Истина;
		ТабличныйДокумент.ЧерноБелаяПечать = Истина;
		ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ОтчетОбИспользованииБланковЛандшафт";
...
Функция ПечатьРеестраИспорченныхБланковСФ(МассивОбъектов, ОбъектыПечати)
	...
	ТабличныйДокумент = Новый ТабличныйДокумент;
	ТабличныйДокумент.ПолеСлева = 0;	
	ТабличныйДокумент.ИмяПараметровПечати = "ПараметрыПечати_РеестрИспорченныхБланковСФ";
...
Функция ПечатьРеестраБланковСФПроизводственныйБрак(МассивОбъектов, ОбъектыПечати)
	...
	ТабличныйДокумент = Новый ТабличныйДокумент;
	ТабличныйДокумент.ПолеСлева = 0;	
	ТабличныйДокумент.ИмяПараметровПечати = "ПараметрыПечати_РеестрБланковСФПроизводственныйБрак";
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_ОтчетОбИспользованииБланков") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, 
		"ПФ_MXL_ОтчетОбИспользованииБланков", 
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_ОтчетОбИспользованииБланковЛандшафт") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, 
		"ПФ_MXL_ОтчетОбИспользованииБланковЛандшафт", 
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_ОтчетОбИспользованииБланковПодробный") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, 
		"ПФ_MXL_ОтчетОбИспользованииБланковПодробный", 
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_РеестрИспорченныхБланковСФ") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, 
		"ПФ_MXL_РеестрИспорченныхБланковСФ", 
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_РеестрБланковСФПроизводственныйБрак") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, 
		"ПФ_MXL_РеестрБланковСФПроизводственныйБрак", 
...
Процедура ДобавитьКомандыПечати(КомандыПечати) Экспорт
	...
	КомандаПечати.Идентификатор = "ПФ_MXL_ОтчетОбИспользованииБланков";
	...
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Идентификатор = "ПФ_MXL_ОтчетОбИспользованииБланковЛандшафт";
	...
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Идентификатор = "ПФ_MXL_ОтчетОбИспользованииБланковПодробный";
	...
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Идентификатор = "ПФ_MXL_РеестрИспорченныхБланковСФ";
	...
	КомандаПечати = КомандыПечати.Добавить();
	КомандаПечати.Идентификатор = "ПФ_MXL_РеестрБланковСФПроизводственныйБрак";
