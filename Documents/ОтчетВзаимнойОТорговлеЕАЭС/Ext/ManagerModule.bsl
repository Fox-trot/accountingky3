...
Функция ПечатьРазделов(МассивОбъектов, ОбъектыПечати)
	...
	Запрос.Текст = 
		...
		|	ВременнаяТаблицаИнформацияОТорговле.Вес * ВременнаяТаблицаИнформацияОТорговле.Количество КАК ВесНетто,
		|	ВременнаяТаблицаИнформацияОТорговле.Сумма КАК ФактурнаяСтоимость
		|ИЗ
		|	ВременнаяТаблицаИнформацияОТорговле КАК ВременнаяТаблицаИнформацияОТорговле
		|;
		|
		...
		|	ВременнаяТаблицаИнформацияОТорговле.Ссылка КАК Ссылка,
		|	ВременнаяТаблицаИнформацияОТорговле.Поставщик КАК Поставщик,
		|	ВременнаяТаблицаИнформацияОТорговле.Сумма КАК СтатистическаяСтоимостьСомы,
		|	ВременнаяТаблицаИнформацияОТорговле.СуммаВДолларах КАК СтатистическаяСтоимостьСША,
		...
		|	ВременнаяТаблицаИнформацияОТорговле.КодОсобенностьПеремещенияТоваров КАК НаправлениеПеремещения
		|ИЗ
		|	ВременнаяТаблицаИнформацияОТорговле КАК ВременнаяТаблицаИнформацияОТорговле";		
	Запрос.УстановитьПараметр("СписокДокументов", МассивОбъектов);
