...
Процедура ЗаполнитьПоПоступлениюТоваровУслуг(ДанныеЗаполнения) Экспорт
	...
	ПризнакСтраны 		= ДанныеЗаполнения.ПризнакСтраны;
...
Процедура ВыполнитьПредварительныйКонтроль(Отказ)
	...
	Запрос.Текст =
		...
		|	ПоступлениеТоваровУслуг.ЗначениеСтавкиНСП КАК ЗначениеСтавкиНСП,
		|	ПоступлениеТоваровУслуг.БезналичныйРасчет КАК БезналичныйРасчет,
		...
		|				ИЛИ ВременнаяТаблицаДанныеДокументов.ЗначениеСтавкиНДС = &ЗначениеСтавкиНДС
		|				ИЛИ ВременнаяТаблицаДанныеДокументов.ЗначениеСтавкиНСП = &ЗначениеСтавкиНСП
		|				ИЛИ ВременнаяТаблицаДанныеДокументов.БезналичныйРасчет = &БезналичныйРасчет)";		
...
Процедура ЗаполнитьДокументыПоступления()
	...
	Запрос.Текст =
		...
		|				И ЗначениеСтавкиНДС = &ЗначениеСтавкиНДС
		|				И ЗначениеСтавкиНСП = &ЗначениеСтавкиНСП
		|				И БезналичныйРасчет = &БезналичныйРасчет) КАК ПоступлениеТоваровОбороты
		|ГДЕ
