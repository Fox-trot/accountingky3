...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбменСБанками.ПриСозданииНаСервере(ЭтотОбъект, Элементы.КомандыЭДО);
	// Конец ОбменСБанками
	...
	Если Элементы.Найти("ФормаСинхронизироватьСБанком") <> Неопределено И Не Пользователи.ЭтоПолноправныйПользователь()
		И Не РольДоступна("ВыполнениеОбменаЭД") Тогда
