...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор", СтруктураОтбора) И ТипЗнч(СтруктураОтбора) = Тип("Структура") Тогда
		...
		Если ОтборСчетОрганизацииИспользование Тогда
			ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(
				Список, "СчетОрганизации", СтруктураОтбора.СчетОрганизации);
		КонецЕсли;
	...
	ПерепискаСБанками = ОбменСБанкамиКлиентСервер.ТекстСсылкиПерепискаСБанками();
...
&НаКлиенте
Процедура ПерепискаСБанкамиНажатие(Элемент, СтандартнаяОбработка)
