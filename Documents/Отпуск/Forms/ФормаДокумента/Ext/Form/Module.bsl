...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	Если ВидОтпуска = ПредопределенноеЗначение("Перечисление.ВидыОтпусков.БезСодержания") Тогда 
	...
	ИначеЕсли ВидОтпуска = ПредопределенноеЗначение("Перечисление.ВидыОтпусков.Компенсация") Тогда 
