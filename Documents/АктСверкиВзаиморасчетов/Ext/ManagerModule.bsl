...
Функция ПечатьАктаСверки(МассивОбъектов, ОбъектыПечати)
	...
	Пока Шапка.Следующий() Цикл
		...
		СуммаДтКонтр = ?(Шапка.Разногласие = "", Формат(?(СуммаКт = 0, "", СуммаКт), "ЧЦ=15; ЧДЦ=2; ЧН=0,00"), Формат(ТаблицаПоДаннымКонтрагента.Итог("СуммаКтКонтрагент"), "ЧЦ=15; ЧДЦ=2; ЧН=' '"));
		ДанныеПечати.Вставить("СуммаДтКонтр", ?(СуммаДтКонтр = 0, "", СуммаДтКонтр));
		
		СуммаКтКонтр = ?(Шапка.Разногласие = "", Формат(?(СуммаДт = 0, "", СуммаДт), "ЧЦ=15; ЧДЦ=2; ЧН=0,00"), Формат(ТаблицаПоДаннымКонтрагента.Итог("СуммаДтКонтрагент"), "ЧЦ=15; ЧДЦ=2; ЧН=' '"));
