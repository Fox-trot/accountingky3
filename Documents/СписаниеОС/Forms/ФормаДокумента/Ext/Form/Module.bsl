...
Процедура ОСОсновноеСредствоПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(СтрокаТабличнойЧасти.ОсновноеСредство) Тогда
		СтрокаТабличнойЧасти.СчетРасхода = ПредопределенноеЗначение("ПланСчетов.Хозрасчетный.РасходыПоВыбытиюАктивов"); // 9540
...
Процедура Заполнить(Команда)
	...
	ОписаниеОповещения = Новый ОписаниеОповещения("ОтветНаВопросЗаполнитьУчетныеДанные", ЭтотОбъект);
...
&НаКлиенте
Процедура ОтветНаВопросЗаполнитьУчетныеДанные(РезультатВопроса, ДополнительныеПараметры) Экспорт
...
Процедура ПолучитьОСИзХранилища(АдресЗапасовВХранилище, ИмяТабличнойЧасти)
	...
	Для Каждого СтрокаЗагрузки Из ТаблицаДляЗагрузки Цикл
		...
		СтрокаТабличнойЧасти.СчетРасхода = ПланыСчетов.Хозрасчетный.РасходыПоВыбытиюАктивов; // 9540
...
Процедура ДополнитьСтрокиНаСервере(МассивОсновныхСредств = Неопределено)
	...
	// При обращении к УправлениеВнеоборотнымиАктивами.ЗаполнитьДанныеОсновныхСредствВТабличнойЧасти
	// амортизация за месяц добавляется к накопленной амортизации. В данном документе "Списание ОС"
	// накопленная амортизация должна быть без учета амортизации за месяц.
