...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	ИначеЕсли ИмяСобытия = "ПодборНоменклатурыПроизведен" 
		...
		//ЗаполнитьСебестоимость(Неопределено);
	Иначе
...
Процедура ЗаполнитьТабличнуюЧастьПоРеализацииПослеПолученияДокумента(ДокументРеализации, СпособЗаполнения)
	...
	//ЗаполнитьСебестоимость(ДокументРеализации);
...
Процедура ЗаполнитьТоварыПоОснованию(ДокументОснование)
	...
	Запрос.Текст = 
		...
		|	РеализацияТоваровУслугТовары.СуммаДохода,
...
//&НаСервере
//Процедура ЗаполнитьСебестоимость(ДокументРеализации)
//	Документ = РеквизитФормыВЗначение("Объект");
//	Документ.ЗаполнитьСебестоимость(ДокументРеализации, ДатаДокумента);
//	ЗначениеВРеквизитФормы(Документ, "Объект");
//КонецПроцедуры 
