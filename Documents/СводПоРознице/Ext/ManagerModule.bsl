...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства, Отказ)	
	...
	ТекстЗапроса = "ВЫБРАТЬ
		...
		|	ВременнаяТаблицаШапка.СтатьяРасходов КАК СубконтоКт1,
...
Процедура СформироватьТаблицаНДС(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =	
		...
		|	ВременнаяТаблицаРеализация.Всего - ВременнаяТаблицаРеализация.СуммаНДС - ВременнаяТаблицаРеализация.СуммаНСП КАК Сумма
		|ИЗ
		|	ВременнаяТаблицаШапка КАК ВременнаяТаблицаШапка
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВременнаяТаблицаРеализация КАК ВременнаяТаблицаРеализация
		|		ПО (ИСТИНА)
...
Процедура СформироватьТаблицаРеестрПриобретенныхМатериальныхРесурсов(ДокументСсылка, СтруктураДополнительныеСвойства) 
	...
	Запрос.Текст =
		...
		|	ВременнаяТаблицаТовары.ПризнакСтраны
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ВременнаяТаблицаТоварыНеВозврат.ЗачетНДС КАК ЗачетНДС,
		|	ВременнаяТаблицаТоварыНеВозврат.Контрагент КАК Контрагент,
		|	ВременнаяТаблицаТоварыНеВозврат.ДатаСФ КАК ДатаСФ,
		|	ВременнаяТаблицаТоварыНеВозврат.ПризнакСтраны КАК ПризнакСтраны,
		|	ВременнаяТаблицаТоварыНеВозврат.СерияБланкаСФ КАК СерияБланкаСФ,
		|	ВременнаяТаблицаТоварыНеВозврат.НомерБланкаСФ КАК НомерБланкаСФ,
		|	СУММА(ВременнаяТаблицаТоварыНеВозврат.Сумма) КАК Сумма,
		|	СУММА(ВременнаяТаблицаТоварыНеВозврат.СуммаНДС) КАК СуммаНДС
		|ПОМЕСТИТЬ ВременнаяТаблицаДанныеТабличныхЧастей
		|ИЗ
		|	ВременнаяТаблицаТоварыНеВозврат КАК ВременнаяТаблицаТоварыНеВозврат
		|
		|СГРУППИРОВАТЬ ПО
		|	ВременнаяТаблицаТоварыНеВозврат.ЗачетНДС,
		|	ВременнаяТаблицаТоварыНеВозврат.Контрагент,
		|	ВременнаяТаблицаТоварыНеВозврат.ДатаСФ,
		|	ВременнаяТаблицаТоварыНеВозврат.СерияБланкаСФ,
		|	ВременнаяТаблицаТоварыНеВозврат.НомерБланкаСФ,
		|	ВременнаяТаблицаТоварыНеВозврат.ПризнакСтраны
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ВременнаяТаблицаТоварыВозврат.ЗачетНДС КАК ЗачетНДС,
		|	ВременнаяТаблицаТоварыВозврат.Контрагент КАК Контрагент,
		|	ВременнаяТаблицаТоварыВозврат.ДатаСФ КАК ДатаСФ,
		|	ВременнаяТаблицаТоварыВозврат.ПризнакСтраны КАК ПризнакСтраны,
		|	ВременнаяТаблицаТоварыВозврат.СерияБланкаСФ КАК СерияБланкаСФ,
		|	ВременнаяТаблицаТоварыВозврат.НомерБланкаСФ КАК НомерБланкаСФ,
		|	СУММА(ВременнаяТаблицаТоварыВозврат.Сумма) КАК Сумма,
		|	СУММА(ВременнаяТаблицаТоварыВозврат.СуммаНДС) КАК СуммаНДС
		|ПОМЕСТИТЬ ВременнаяТаблицаДанныеТабличныхЧастейВозврат
		|ИЗ
		|	ВременнаяТаблицаТоварыВозврат КАК ВременнаяТаблицаТоварыВозврат
		|
		|СГРУППИРОВАТЬ ПО
		|	ВременнаяТаблицаТоварыВозврат.ЗачетНДС,
		|	ВременнаяТаблицаТоварыВозврат.Контрагент,
		|	ВременнаяТаблицаТоварыВозврат.ДатаСФ,
		|	ВременнаяТаблицаТоварыВозврат.СерияБланкаСФ,
		|	ВременнаяТаблицаТоварыВозврат.НомерБланкаСФ,
		|	ВременнаяТаблицаТоварыВозврат.ПризнакСтраны
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
...
Процедура СформироватьТаблицаСчетаФактурыВыписанные(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	|	ВременнаяТаблицаДокумента.ДоговорКонтрагента,
	|	ВременнаяТаблицаДокумента.СтавкаНДС,
	|	-СУММА(ВременнаяТаблицаДокумента.Сумма),
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, СтруктураДополнительныеСвойства, Отказ) Экспорт 
	...
	Запрос.Текст = 
		...
		|	СводПоРознице.СтатьяРасходов КАК СтатьяРасходов,
		...
		|	СводПоРознице.ДоговорКонтрагента.КодПоставкиНДС КАК КодПоставкиНДС,
