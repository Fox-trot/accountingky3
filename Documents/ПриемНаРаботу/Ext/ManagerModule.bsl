...
КонецПроцедуры // СформироватьТаблицаПлановыеУдержания()
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.Текст =
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ПриемНаРаботуУдержания.ВидРасчета,
...
//
Функция СформироватьЗапросДляПечати(ТекущийДокумент, ИмяМакета) Экспорт
...
Функция ПечатнаяФорма(МассивОбъектов, ОбъектыПечати, ИмяМакета)
	...
	Для каждого  ТекущийДокумент Из МассивОбъектов Цикл
		...
		Если ИмяМакета = "ПриказОПриеме" Тогда
			ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ПриемНаРаботу_ПриказОПриеме";     
		...
		ИначеЕсли ИмяМакета = "ТрудовойДоговор" Тогда  
			ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_ПриемНаРаботу_ТрудовойДоговор";     
