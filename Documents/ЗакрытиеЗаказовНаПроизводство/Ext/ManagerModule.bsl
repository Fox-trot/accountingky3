...
//	Запрос.Текст =
//		"ВЫБРАТЬ
//		|	ВременнаяТаблицаЗаказы.ЗаказНаПроизводство КАК ЗаказНаПроизводство,
//		|	ВременнаяТаблицаШапка.Организация КАК Организация,
//		|	ВременнаяТаблицаШапка.Дата КАК Период,
//		|	ВременнаяТаблицаЗаказы.Продукция КАК Продукция
//		|ИЗ
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.Текст =
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ЗакрытиеЗаказовНаПроизводствоЗаказы.ЗаказНаПроизводство,
		|	ЗакрытиеЗаказовНаПроизводствоЗаказы.Продукция,
		|	ЗакрытиеЗаказовНаПроизводствоЗаказы.Количество
		|ПОМЕСТИТЬ ВременнаяТаблицаЗаказы
		|ИЗ
		|	Документ.ЗакрытиеЗаказовНаПроизводство.Заказы КАК ЗакрытиеЗаказовНаПроизводствоЗаказы
		|ГДЕ
		|	ЗакрытиеЗаказовНаПроизводствоЗаказы.Ссылка = &Ссылка";
