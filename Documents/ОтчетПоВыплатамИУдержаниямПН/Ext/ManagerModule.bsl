...
Функция ПолучитьКонтактнуюИнформацию(Организация)
	...
	Структура = Новый Структура("ОКПО,ИНН,ГНСНаименование,ГНСКод,ОрганизацияНаименованиеПолное,Индекс,АдрОбластьГород,АдресОрганизации,Телефон,ЭлПочта",
								ОКПО, ИНН, ГНСНаименование, ГНСКод, ОрганизацияНаименованиеПолное, Индекс,АдрОбластьГород,АдресОрганизации,Телефон,ЭлПочта);
