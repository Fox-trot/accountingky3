...
Функция ПечатьДопРасходы(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	ТекстЗапроса =
		...
		|		ДополнительныеРасходы.Товары.Сумма + ДополнительныеРасходы.Товары.СуммаРасходов + ДополнительныеРасходы.Товары.СуммаРасходовНДС + ДополнительныеРасходы.Товары.СуммаРасходовНСП КАК Всего
		|	),
		...
		|		Сумма КАК Сумма,
		|		СуммаРасходов,
		|		ДополнительныеРасходы.ОС.Сумма + ДополнительныеРасходы.ОС.СуммаРасходов + ДополнительныеРасходы.ОС.СуммаРасходовНДС + ДополнительныеРасходы.ОС.СуммаРасходовНСП КАК Всего
		|	)
		|ИЗ
