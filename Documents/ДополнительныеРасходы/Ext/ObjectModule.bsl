...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если НЕ СуммаРезультатРаспределения = СуммаДопРасходов Тогда
...
Процедура РаспределитьРасходы() Экспорт	
	...
	Если НЕ СуммаДопРасходов = 0 Тогда 
		МассивРаспределениеМеждуТабличнымиЧастями = ОбщегоНазначения.РаспределитьСуммуПропорциональноКоэффициентам(СуммаДопРасходов, МассивОбщихСумм, 2);
