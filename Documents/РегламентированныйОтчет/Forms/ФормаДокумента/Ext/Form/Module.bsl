...
Процедура РассчитатьНаСервере()
	...
	Если Объект.Настройка.Родитель = Справочники.НастройкиРегламентированныхОтчетов.Баланс Тогда
		...
		ОтборСтрок.Вставить("Строка", "299");
		...
		ОтборСтрок.Вставить("Строка", "599");
		МассивСтрок	= Объект.Отчет.НайтиСтроки(ОтборСтрок);		
...
Процедура РассчитатьОтчет()
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	Отчет.Строка КАК Строка,
	|	Отчет.Наименование КАК Наименование,
	|	Отчет.Заголовок КАК Заголовок,
	|	Отчет.Группа КАК Группа,
	|	Отчет.НаименованиеК КАК НаименованиеК,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВременнаяТаблицаНастройки.Строка КАК Строка,
	|	ВременнаяТаблицаНастройки.Счет КАК Счет,
	...
	|		ПО ВременнаяТаблицаНастройки.Счет = Остатки.Счет
	|ГДЕ
	|	ВременнаяТаблицаНастройки.Счет <> &ПустойСчет
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	|	ВременнаяТаблицаНастройки.Строка,
	|	ВременнаяТаблицаНастройки.Счет,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВременнаяТаблицаОстаткиИОбороты.Строка КАК Строка,
	...
	|
	|СГРУППИРОВАТЬ ПО
	|	ВременнаяТаблицаОстаткиИОбороты.Строка,
	|	ВременнаяТаблицаОстаткиИОбороты.Счет,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВременнаяТаблицаОсновныеРасчеты.Строка КАК Строка,
	|	ВременнаяТаблицаОсновныеРасчеты.Счет КАК Счет,
	|	ВременнаяТаблицаОсновныеРасчеты.Дебет,
	|	ВременнаяТаблицаОсновныеРасчеты.Кредит,
	|	ВременнаяТаблицаОсновныеРасчеты.Знак,
	|	ВременнаяТаблицаОсновныеРасчеты.Формула,
	|	ВременнаяТаблицаОсновныеРасчеты.ВидКапитала,
	|	ВЫБОР
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Строка,
	|	СУММА(ВЫБОР
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВременнаяТаблицаОтчет.Строка,
	|	ВременнаяТаблицаОтчет.Наименование,
	|	ВременнаяТаблицаОтчет.Заголовок,
	|	ВременнаяТаблицаОтчет.Группа,
	|	ВременнаяТаблицаОтчет.НаименованиеК,
	|	ВременнаяТаблицаОтчет.Картинка,
	|	ВременнаяТаблицаОтчет.ЗнакГруппы,
	|	ВременнаяТаблицаОтчет.Проход,
	...
	|		ПО ВременнаяТаблицаОтчет.Строка = ВременнаяТаблицаГруппировкаПоСтроке.Строка
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Строка,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Счет,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Дебет,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Кредит,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Знак,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Формула,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ВидКапитала,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОборотДт,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОборотКт,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОстатокДтН,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОстатокКтН,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОстатокДт,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОстатокКт,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОборотДтПП,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОборотКтПП,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОстатокДтПП,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОстатокКтПП,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Сумма,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.СуммаУК,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.СуммаПК,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.СуммаНП,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.СуммаИтг,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.СуммаПП,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОборотыДТКТ,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.ОборотыДТКТПП
	|ИЗ
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс КАК ВременнаяТаблицаОсновныеЗнакМинусПлюс";
	...
	Пока КЦ <= КолвоПроходов Цикл
		...
		Для Каждого СТЧ Из Объект.Отчет Цикл
			Если СТЧ.Проход = КЦ И СТЧ.Строка <> "" Тогда 
				СТЗ = ТЗГ.Найти(СТЧ.Строка,"Группа");
...
Процедура РасчитатьОПУ()
	...
	|				,
	|				,
	|				ЗНАЧЕНИЕ(ПланВидовХарактеристик.ВидыСубконтоХозрасчетные.СтатьиЗатратИДоходов),
	|				Организация = &Организация,
	|				КорСчет <> &Сч5999
	|					И КорСчет <> &Сч5300,
	|				) КАК ХозрасчетныйОбороты
	|		ПО ВременнаяТаблицаНастройки.Счет = ХозрасчетныйОбороты.Счет
	|ГДЕ
	|	ВременнаяТаблицаНастройки.Счет <> &ПустойСчет
	|
	|ОБЪЕДИНИТЬ ВСЕ
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВременнаяТаблицаОтчет.Строка КАК Строка,
	|	ВременнаяТаблицаОтчет.Наименование,
	|	ВременнаяТаблицаОтчет.Заголовок,
	|	ВременнаяТаблицаОтчет.Группа,
	|	ВременнаяТаблицаОтчет.НаименованиеК,
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Строка КАК Строка,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Счет КАК Счет,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Дебет,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Кредит,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Знак,
	|	ВременнаяТаблицаОсновныеЗнакМинусПлюс.Формула,
	...
	ОтборСтрок = Новый Структура;
	ОтборСтрок.Вставить("Строка", "170");
	МассивСтрок			= Объект.Отчет.НайтиСтроки(ОтборСтрок);
	...
	Если НЕ Объект.ПрибыльПоНУ Тогда 
		...
		СтавкаНП = ?(ЗначениеЗаполнено(УПП.СтавкаНалогаНаПрибыль), УПП.СтавкаНалогаНаПрибыль, 10);
				
		// 8.2. Строка 170
		ОтборСтрок.Вставить("Строка", "160");
		МассивСтрок		= Объект.Отчет.НайтиСтроки(ОтборСтрок);
		...
		// 8.3. Строка 180		
		ОтборСтрок.Вставить("Строка", "180");
		МассивСтрок			= Объект.Отчет.НайтиСтроки(ОтборСтрок);
		...
		// 8.4. Строка 200
		ОтборСтрок.Вставить("Строка", "200");
		МассивСтрок			= Объект.Отчет.НайтиСтроки(ОтборСтрок);
...
Процедура ЗаполнитьНастройки()
	...
	Если НЕ Объект.Настройка.Пустая() Тогда			
		Объект.Отчет.Загрузить(Объект.Настройка.Отчет.Выгрузить());			
		Объект.Настройки.Загрузить(Объект.Настройка.Настройки.Выгрузить());
	КонецЕсли;
...
Процедура РассчитатьОИКНаСервере()
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	НастройкиРегламентированныхОтчетовНастройки.Строка КАК Строка,
	|	НастройкиРегламентированныхОтчетовНастройки.Счет КАК Счет,
	|	НастройкиРегламентированныхОтчетовНастройки.Дебет КАК Дебет,
	|	НастройкиРегламентированныхОтчетовНастройки.Кредит КАК Кредит,
	...
	|	0 КАК ОстатокДТПП,
	|	0 КАК ОстатокКТПП,
	|	НастройкиРегламентированныхОтчетовНастройки.ИмяКолонки
	|ПОМЕСТИТЬ ВТ
	|ИЗ
	|	Справочник.НастройкиРегламентированныхОтчетов.Настройки КАК НастройкиРегламентированныхОтчетовНастройки
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрБухгалтерии.Хозрасчетный.ОстаткиИОбороты(&ДатаН, &ДатаК, , , , , Организация = &Организация) КАК Остатки
	|		ПО НастройкиРегламентированныхОтчетовНастройки.Счет = Остатки.Счет
	|ГДЕ
	...
	|
	|ВЫБРАТЬ
	|	НастройкиРегламентированныхОтчетовНастройки.Строка,
	|	НастройкиРегламентированныхОтчетовНастройки.Счет,
	|	НастройкиРегламентированныхОтчетовНастройки.Дебет,
	|	НастройкиРегламентированныхОтчетовНастройки.Кредит,
	...
	|	ВТ.Формула,
	|	ВТ.ВидКапитала,
	|	СУММА(ВТ.ОборотДТ) КАК ОборотДТ,
	|	СУММА(ВТ.ОборотКТ) КАК ОборотКТ,
	|	СУММА(ВТ.ОстатокДТН) КАК ОстатокДТН,
	|	СУММА(ВТ.ОстатокКТН) КАК ОстатокКТН,
	|	СУММА(ВТ.ОстатокДТ) КАК ОстатокДТ,
	|	СУММА(ВТ.ОстатокКТ) КАК ОстатокКТ,
	|	СУММА(ВТ.ОборотДТПП) КАК ОборотДТПП,
	|	СУММА(ВТ.ОборотКТПП) КАК ОборотКТПП,
	|	СУММА(ВТ.ОстатокДТПП) КАК ОстатокДТПП,
	|	СУММА(ВТ.ОстатокКТПП) КАК ОстатокКТПП
	|ИЗ
	|	ВТ КАК ВТ
	|
	|СГРУППИРОВАТЬ ПО
	...
	Пока Выборка.Следующий() Цикл 
		...
		ПараметрыОтбора.Вставить("Строка", 		Выборка.Строка);
	...
	ОтчетЕГ.Свернуть("Наименование,Заголовок,Группа,ЗнакГруппы,ИмяКолонки,Строка",
...
Функция ЗаполнитьСтрокуОИК(СтруктураДанных)
	...
	Если Выборка.Строка < "016" Тогда
		Если Выборка.Формула = Перечисления.Формулы.ОборотыДт Тогда 	
			Выполнить("СТЧ." + Выборка.ИмяКолонки + "= Выборка.ОборотДТПП");
		ИначеЕсли Выборка.Формула = Перечисления.Формулы.ОборотыКт Тогда 	
			Выполнить("СТЧ." + Выборка.ИмяКолонки + "= Выборка.ОборотКТПП");
		ИначеЕсли Выборка.Формула = Перечисления.Формулы.СальдоДт Тогда 	
			Выполнить("СТЧ." + Выборка.ИмяКолонки + "= Выборка.ОстатокДТПП");
		ИначеЕсли Выборка.Формула = Перечисления.Формулы.СальдоКт Тогда 	
			Выполнить("СТЧ." + Выборка.ИмяКолонки + "= Выборка.ОстатокКТПП");
		КонецЕсли;
		
		Если Выборка.Строка = "001" Тогда
			СТЧ.Наименование = НСтр("ru = 'Баланс по состоянию на'") + " " + Формат(НачалоПредыдущегоПериода, "ДЛФ=DD");
		ИначеЕсли Выборка.Строка = "004" Тогда
			СТЧ.Наименование = НСтр("ru = 'Скорректированый баланс по состоянию на'") + " " + Формат(НачалоПредыдущегоПериода, "ДЛФ=DD");			
		ИначеЕсли Выборка.Строка = "015" Тогда
			СТЧ.Наименование = НСтр("ru = 'Баланс по состоянию на'") + " " + Формат(КонецПредыдущегоПериода, "ДЛФ=DD");					
		КонецЕсли;
			
	Иначе
		Если Выборка.Формула = Перечисления.Формулы.ОборотыДт Тогда 	
			Выполнить("СТЧ." + Выборка.ИмяКолонки + "= Выборка.ОборотДТ");
		ИначеЕсли Выборка.Формула = Перечисления.Формулы.ОборотыКт Тогда 	
			Выполнить("СТЧ." + Выборка.ИмяКолонки + "= Выборка.ОборотКт");
		ИначеЕсли Выборка.Формула = Перечисления.Формулы.СальдоДт Тогда 	
			Выполнить("СТЧ." + Выборка.ИмяКолонки + "= Выборка.ОстатокДт");
		ИначеЕсли Выборка.Формула = Перечисления.Формулы.СальдоКт Тогда 	
			Выполнить("СТЧ." + Выборка.ИмяКолонки + "= Выборка.ОстатокКт");
		КонецЕсли;			
		
		Если Выборка.Строка = "022" Тогда
			СТЧ.Наименование = НСтр("ru = 'Баланс по состоянию на'") + " " + Формат(КонецПериода, "ДЛФ=DD");				
		КонецЕсли;	
	КонецЕсли;	
