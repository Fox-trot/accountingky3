...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	Если ОтборНастройка = Справочники.НастройкиРегламентированныхОтчетов.ОИК Тогда 		
		ЭтаФорма.Заголовок = НСтр("ru = 'Регламентрированные отчеты об изменениях в собственном капитале'");
	ИначеЕсли ОтборНастройка = Справочники.НастройкиРегламентированныхОтчетов.ОПУ Тогда 
		ЭтаФорма.Заголовок = НСтр("ru = 'Регламентрированные отчеты о прибылях и убытках'");	
	ИначеЕсли ОтборНастройка = Справочники.НастройкиРегламентированныхОтчетов.ДДС Тогда 
		ЭтаФорма.Заголовок = НСтр("ru = 'Регламентрированные отчеты о движении денежных средств'");
	ИначеЕсли ОтборНастройка = Справочники.НастройкиРегламентированныхОтчетов.Баланс Тогда 
