...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =
		...
		|					КОГДА ТаблицаДокумента.ВалютаПрихода = &ВалютаРегламентированногоУчета
		|							И ТаблицаДокумента.ВалютаРасхода <> &ВалютаРегламентированногоУчета
		|			 			ТОГДА ТаблицаДокумента.СчетРасхода
		...
		|					КОГДА ТаблицаДокумента.ВалютаПрихода = &ВалютаРегламентированногоУчета
		|							И ТаблицаДокумента.ВалютаРасхода <> &ВалютаРегламентированногоУчета
		|			 			ТОГДА ТаблицаДокумента.РасходРасчетныйСчет
		|					ИНАЧЕ ТаблицаДокумента.ПриходРасчетныйСчет
		|				КОНЕЦ
		|		ИНАЧЕ &СтатьяЗатрат
		|	КОНЕЦ,
		|	ВЫБОР
		...
		|					ИНАЧЕ ТаблицаДокумента.ВалютаПрихода
		|				КОНЕЦ
		|		ИНАЧЕ НЕОПРЕДЕЛЕНО
		|	КОНЕЦ,
		|	ВЫБОР
	...
	Запрос.УстановитьПараметр("СтатьяДДС", СтруктураДополнительныеСвойства.УчетнаяПолитика.СтатьяДДСДляКурсовыхРазниц);
	Запрос.УстановитьПараметр("СтатьяЗатрат", СтруктураДополнительныеСвойства.УчетнаяПолитика.СтатьяЗатратДляОКР);
