...
Функция ПечатьЗаявленияНаКонвертацию(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	ТабличныйДокумент.КлючПараметровПечати = "ЗаявлениеНаКонвертацию";
	...
	Пока ВыборкаДок.Следующий() Цикл
		...
		ТабличныйДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_Конвертация_ЗаявлениеНаКонвертацию";
		...
		Если ВыборкаДок.ПечатнаяФормаБанкаРасхода = Перечисления.ПечатныеФормыБанков.БанкКыргызстан ИЛИ ВыборкаДок.ПечатнаяФормаБанкаРасхода = Перечисления.ПечатныеФормыБанков.БакайБанк Тогда
			ОбластьМакета.Параметры.Номер 					= ПрефиксацияОбъектовКлиентСервер.ПолучитьНомерНаПечать(ВыборкаДок.Номер);
		КонецЕсли;
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПечатьЗаявленияНаКонвертацию") Тогда
		...
		"Печать заявления на конвертацию",
