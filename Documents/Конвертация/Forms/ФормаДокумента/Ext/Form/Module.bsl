...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	Элементы.ДекорацияВалютКурсПрихода.Видимость = НЕ (Объект.ВалютаПрихода = ВалютаРегламентированногоУчета ИЛИ Объект.ВалютаПрихода = Справочник.Валюты.ПустаяСсылка);
	Элементы.ДекорацияВалютКурсРасхода.Видимость = НЕ (Объект.ВалютаРасхода = ВалютаРегламентированногоУчета ИЛИ Объект.ВалютаРасхода = Справочник.Валюты.ПустаяСсылка);
	Элементы.ДекорацияЧислоКурсПрихода.Видимость = НЕ (Объект.ВалютаПрихода = ВалютаРегламентированногоУчета ИЛИ Объект.ВалютаПрихода = Справочник.Валюты.ПустаяСсылка);
	Элементы.ДекорацияЧислоКурсРасхода.Видимость = НЕ (Объект.ВалютаРасхода = ВалютаРегламентированногоУчета ИЛИ Объект.ВалютаРасхода = Справочник.Валюты.ПустаяСсылка);
