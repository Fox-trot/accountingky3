...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства, Отказ)
	...
	Запрос.Текст =
		...
		|	КОНЕЦ КАК Склад,
		|	ВременнаяТаблицаШапка.ФизЛицоПолучатель КАК СкладПолучатель
		|ИЗ
		...
		|   ВременнаяТаблицаТовары.Субконто1 КАК СубконтоЗатрат1,
		|   ВременнаяТаблицаТовары.Субконто2 КАК СубконтоЗатрат2,
		|   ВременнаяТаблицаТовары.Субконто3 КАК СубконтоЗатрат3,
