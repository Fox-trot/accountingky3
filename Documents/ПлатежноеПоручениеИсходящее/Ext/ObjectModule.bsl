...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьПрефиксКассыИБанковскогоСчета") И БанковскийСчет.Префикс = "" Тогда
		ТекстСообщения = НСтр(
			"ru = 'Невозможно провести документ. Отсутствует префикс у банковского счета!'");
...
Процедура ПриУстановкеНовогоНомера(СтандартнаяОбработка, Префикс)
	Префикс = ?(БанковскийСчет.Префикс = "", "00", БанковскийСчет.Префикс);
КонецПроцедуры
