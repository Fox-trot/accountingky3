...
Процедура СформироватьНадписьКурсоваяРазница()
	...
	ИначеЕсли НЕ ДанныеОСчетах.СчетПриходаВалютный И ДанныеОСчетах.СчетРасходаВалютный И СуммаКурсовойРазницы < 0 Тогда
		Текст1 = "Доход";
	...
	ИначеЕсли ДанныеОСчетах.СчетПриходаВалютный И НЕ ДанныеОСчетах.СчетРасходаВалютный И СуммаКурсовойРазницы < 0 Тогда
		Текст1 = "Доход";		
	...
	ИначеЕсли ДанныеОСчетах.СчетПриходаВалютный И ДанныеОСчетах.СчетРасходаВалютный И СуммаКурсовойРазницы < 0 Тогда
		Текст1 = "Доход";			
