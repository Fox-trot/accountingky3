...
Процедура ВидВедомостиПриИзменении(Элемент)
	...
	Если Объект.ВидВедомости = ПредопределенноеЗначение("Перечисление.ВидыВедомости.Банк")
		ИЛИ Объект.ВидВедомости = ПредопределенноеЗначение("Перечисление.ВидыВедомости.ЗППроект") Тогда
		Объект.ВидДокументаВыплаты = ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.ППИ");	
...
Процедура СформироватьДокументыВыплаты(Команда)
	...
	Если Объект.ВидДокументаВыплаты = ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.Подотчет") 
		ИЛИ Объект.ВидДокументаВыплаты = ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.АвансовыйОтчет") Тогда
...
Процедура ПересчитатьТаблицуВыплат()
	...
	Если Объект.ВидВедомости = Перечисления.ВидыВедомости.ЗППроект Тогда
		Документ.ЗаполнитьТаблицуВыплатПоЗППроектам(ТЗ);
	КонецЕсли;
	
	Если Объект.ВидВедомости = Перечисления.ВидыВедомости.Банк Тогда
		Документ.ЗаполнитьТаблицуВыплатПоБанковскимСчетам(ТЗ.Итог("СуммаПоБанковскомуСчету"));
	КонецЕсли;
	
	Если Объект.ВидВедомости = Перечисления.ВидыВедомости.Все
		ИЛИ Объект.ВидВедомости = Перечисления.ВидыВедомости.Касса Тогда
...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	ВидВедомости_Все 		= Объект.ВидВедомости = ПредопределенноеЗначение("Перечисление.ВидыВедомости.Все");
	ВидВедомости_Касса 		= Объект.ВидВедомости = ПредопределенноеЗначение("Перечисление.ВидыВедомости.Касса");
	ВидВедомости_Банк 		= Объект.ВидВедомости = ПредопределенноеЗначение("Перечисление.ВидыВедомости.Банк");
	ВидВедомости_ЗППроект 	= Объект.ВидВедомости = ПредопределенноеЗначение("Перечисление.ВидыВедомости.ЗППроект");
	...
	Если ВидВедомости_Все ИЛИ ВидВедомости_Касса Тогда
	...
	Если ВидВедомости_ЗППроект Тогда
		Элементы.БанковскийСчет.Видимость 			= Истина;
...
Процедура СформироватьСписокВыбораВидаДокумента()
	...
	Если Объект.ВидВедомости = ПредопределенноеЗначение("Перечисление.ВидыВедомости.Все")
		ИЛИ Объект.ВидВедомости = ПредопределенноеЗначение("Перечисление.ВидыВедомости.Касса") Тогда
		Элементы.ВидДокументаВыплаты.СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.Общий"), 			"Общий");
		Элементы.ВидДокументаВыплаты.СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.Индивидуально"), 	"Индивидуально");
		Элементы.ВидДокументаВыплаты.СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.Подотчет"), 		"Подотчет");
		Элементы.ВидДокументаВыплаты.СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.АвансовыйОтчет"), 	"АвансовыйОтчет");
		
	ИначеЕсли Объект.ВидВедомости = ПредопределенноеЗначение("Перечисление.ВидыВедомости.Банк")
		ИЛИ Объект.ВидВедомости = ПредопределенноеЗначение("Перечисление.ВидыВедомости.ЗППроект") Тогда
		Элементы.ВидДокументаВыплаты.СписокВыбора.Добавить(ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.ППИ"), "ППИ");
	КонецЕсли;
КонецПроцедуры
...
Функция ПроверкаЗаполненияПередИсполнениемКоманды(НаименованиеКоманды)
	...
	Если НаименованиеКоманды = "СформироватьДокументыВыплаты" Тогда		
		...
		Если НЕ ЗначениеЗаполнено(Объект.ВидДокументаВыплаты) Тогда
			ТекстСообщения = НСтр("ru = 'Не заполнено значение ""Вид документа выплаты""! Заполнение документа отменено.'");
	...
	Если НЕ ЗначениеЗаполнено(Объект.ВидВедомости) Тогда
		ТекстСообщения = НСтр("ru = 'Не заполнено значение ""ВидВедомости""! Заполнение документа отменено.'");
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения,, "Объект.ВидВедомости",,Отказ);	
	КонецЕсли;
	
	Если (Объект.ВидДокументаВыплаты = ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.Общий")
		ИЛИ Объект.ВидДокументаВыплаты = ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.Индивидуально")
		ИЛИ Объект.ВидДокументаВыплаты = ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.Подотчет")) 
		И НЕ ЗначениеЗаполнено(Объект.Касса) Тогда
		ТекстСообщения = НСтр("ru = 'Выбран вид РКО, но не заполнена касса! Заполнение документа отменено.'");
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстСообщения,, "Объект.Касса",,Отказ);		
	КонецЕсли;
	
	Если (Объект.ВидДокументаВыплаты = ПредопределенноеЗначение("Перечисление.ВидыВедомости.Банк")
		ИЛИ Объект.ВидДокументаВыплаты = ПредопределенноеЗначение("Перечисление.ВидыВедомости.ЗППроект"))
		И НЕ ЗначениеЗаполнено(Объект.БанковскийСчет) Тогда
		ТекстСообщения = НСтр("ru = 'Выбран вид ведомости ""Банк"", но не заполнен банковский счет! Заполнение документа отменено.'");
...
Процедура ОткрытьФормуДокумента()
	...
	СтруктраПараметры.Вставить("ВедомостьЗП", 					Объект.Ссылка);
	...
	Если Объект.ВидДокументаВыплаты = ПредопределенноеЗначение("Перечисление.ВидыДокументовВыплаты.Подотчет") Тогда
