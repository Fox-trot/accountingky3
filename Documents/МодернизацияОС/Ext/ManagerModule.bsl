...
Процедура СформироватьТаблицаПараметрыУчетаОС(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =
		...
		|	ВременнаяТаблицаПараметрыУчетаОССрезПоследних.СтоимостьДляРасчетаАмортизации + ВременнаяТаблицаШапка.СтоимостьМодернизации - ВременнаяТаблицаШапка.НакопленнаяАмортизация КАК СтоимостьДляРасчетаАмортизации
		|ИЗ
