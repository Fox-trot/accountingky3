...
Процедура СформироватьТаблицаСведенияОбИмуществе(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =
		...
		|	ВЫБОР
		|		КОГДА ТаблицаДокумента.РегиональныйКоэффициент = ЗНАЧЕНИЕ(Справочник.РегиональныеКоэффициентыНалогаНаИмущество.ПустаяСсылка)
		...
		|	ВЫБОР
		|		КОГДА ТаблицаДокумента.ЗональныйКоэффициент = ЗНАЧЕНИЕ(Справочник.ЗональныеКоэффициентыНалогаНаИмущество.ПустаяСсылка)
		...
		|	ВЫБОР
		|		КОГДА ТаблицаДокумента.КодНазначенияИмущества = ЗНАЧЕНИЕ(Справочник.ОтраслевыеКоэффициентыНалогаНаИмущество.ПустаяСсылка)
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.Текст =	
		...
		|	ТаблицаДокумента.СуммаАмортизации КАК СуммаАмортизации,
		...
		|	ТаблицаДокумента.ОбъемПродукцииРабот КАК ОбъемПродукцииРабот,
...
Функция ПолучитьВсеПараметры(ДокументСсылка)
	...
	ТаблицаПараметров.Колонки.Добавить("РегиональныйКоэффициент", 				Новый ОписаниеТипов("СправочникСсылка.РегиональныеКоэффициентыНалогаНаИмущество"));
	ТаблицаПараметров.Колонки.Добавить("ЗональныйКоэффициент", 					Новый ОписаниеТипов("СправочникСсылка.ЗональныеКоэффициентыНалогаНаИмущество"));
	...
	ТаблицаПараметров.Колонки.Добавить("КодНазначенияИмущества",	 			Новый ОписаниеТипов("СправочникСсылка.ОтраслевыеКоэффициентыНалогаНаИмущество"));	
