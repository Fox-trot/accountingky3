...
Процедура РасчетАмортизацииИОстаточнойСтоимости()
	...
	Объект.СуммаАмортизации = УправлениеВнеоборотнымиАктивамиВызовСервера.РасчетАмортизацииОсновногоСредства(ДатаПринятияОС, 
	...
	Объект.ОстаточнаяСтоимостьОС = ПервоначальнаяСтоимость - Объект.СуммаАмортизации;
