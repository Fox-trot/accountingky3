...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	Если Объект.Событие = Перечисления.ВидыСобытийОС.Модернизация Тогда 
		...
		Элементы.ПервоначальнаяСтоимость.Видимость = Истина;
		Элементы.АмортизацияЗаМесяц.Видимость = Истина;
		Элементы.ОстаточнаяСтоимостьОС.Видимость = Истина;
		Элементы.СтоимостьПослеМодернизации.Видимость = Истина;
		Элементы.БазаАмортизации.Видимость = Истина;
		Элементы.РассчитатьСтоимостьМодернизации.Видимость = Истина;
		//Элементы.СпособОтраженияРасходовПоАмортизации.Видимость = Истина;
	Иначе 
		Элементы.СчетУчетаМодернизации.Видимость = Ложь;
		Элементы.СтоимостьМодернизации.Видимость = Ложь;
		Элементы.ПервоначальнаяСтоимость.Видимость = Ложь;
		Элементы.АмортизацияЗаМесяц.Видимость = Ложь;
		Элементы.ОстаточнаяСтоимостьОС.Видимость = Ложь;
		Элементы.СтоимостьПослеМодернизации.Видимость = Ложь;
		Элементы.БазаАмортизации.Видимость = Ложь;
...
Процедура РасчитатьСтоимостьМодернизации()	
	...
	Объект.БазаАмортизации = ПервоначальнаяСтоимость + Объект.СтоимостьМодернизации - Объект.НакопленнаяАмортизация - Объект.АмортизацияЗаМесяц - ЛиквидационнаяСтоимость;
	Объект.СтоимостьПослеМодернизации = ПервоначальнаяСтоимость + Объект.СтоимостьМодернизации;
