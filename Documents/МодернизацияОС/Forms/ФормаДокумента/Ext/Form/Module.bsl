...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РасчетАмортизацииОтСтоимостиДляРасчетаАмортизации = ПолучитьФункциональнуюОпцию("РасчетАмортизацииОтСтоимостиДляРасчетаАмортизации");
...
Процедура ОсновноеСредствоПриИзменении(Элемент)
	...
	Для Каждого СтрокаТабличнойЧасти Из Объект.ПараметрыОС Цикл 
		...
		Если СтрокаТабличнойЧасти.Параметр = ПредопределенноеЗначение("Перечисление.ПараметрыМодернизацииОС.СчетУчета") Тогда
		...
		Если ТекущаяСтрока <> Неопределено Тогда
			...
			Если ТекущаяСтрока.Параметр = ПредопределенноеЗначение("Перечисление.ПараметрыМодернизацииОС.ЛиквидационнаяСтоимость") Тогда
				...
				Если ТекущаяСтрока.Значение <> ТекущаяСтрока.СтароеЗначение Тогда
					Объект.БазаАмортизацииПослеМодернизации = ?(РасчетАмортизацииОтСтоимостиДляРасчетаАмортизации,
