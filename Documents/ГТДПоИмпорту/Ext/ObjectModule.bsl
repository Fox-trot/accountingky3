...
Процедура удалить_РаспределитьСуммуСопровождения()
	...
	Для Каждого СтрокаТабличнойЧасти Из Разделы Цикл
		...
		Если ИмяКолонкиИсточника <> "" Тогда
			РаспределитьСумму(СтрокаТабличнойЧасти, "РаспределитьСопровождение", ИмяКолонкиИсточника, "Сопровождение");
		КонецЕсли;
	КонецЦикла;
...
Процедура РаспределитьСумму(СтрокаТабличнойЧасти, ИмяРаспределения, ИмяКолонкиИсточника, ИмяКолонкиПриемника)
	...
	//ИначеЕсли ИмяРаспределения = "РаспределитьСопровождение" Тогда
	//	Сумма = СтрокаТабличнойЧасти.Сопровождение;		
	КонецЕсли;
