...
Процедура СформироватьТаблицаНДСГТДИмпорт(ДокументСсылка, СтруктураДополнительныеСвойства) 
	...
	|	И НЕ ВременнаяТаблицаТовары.ДокументПоступления.Контрагент.СтранаРезидентства.ЕАЭС";
...
Функция ПечатьГТДПоИмпорту(МассивОбъектов, ОбъектыПечати, ИмяМакета)
	...
	ТабличныйДокумент.КлючПараметровПечати 	= "ПАРАМЕТРЫ_ПЕЧАТИ_ГТДПоИмпорту";
	...
	Если ИмяМакета = "ГТДПоИмпорту" Тогда
		...
		ТабличныйДокумент.ИмяПараметровПечати 	= "ПАРАМЕТРЫ_ПЕЧАТИ_ГТДПоИмпорту_ГТДПоИмпорту";	
	...
	Иначе
		...
		ТабличныйДокумент.ИмяПараметровПечати 	= "ПАРАМЕТРЫ_ПЕЧАТИ_ГТДПоИмпорту_ГТДПоИмпортуПолная";	
