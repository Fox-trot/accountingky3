...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =
		...
		|			ТОГДА НЕ ВременнаяТаблицаРазделы.ЗачетНДС = ЗНАЧЕНИЕ(Перечисление.ВидыЗачетаНДС.Себестоимость)
		|		ИНАЧЕ ИСТИНА
		|	КОНЕЦ
		|
		|ОБЪЕДИНИТЬ ВСЕ
...
Процедура СформироватьТаблицаСведенияОНДСНаИмпорт(СтруктураДополнительныеСвойства) 
	...
	Запрос.Текст =
		...
		|	ВременнаяТаблицаТовары.СуммаБазыНДС КАК Сумма,
		...
		|	ВременнаяТаблицаОС.ОсновноеСредство,
		|	ВременнаяТаблицаОС.СуммаБазыНДС,
...
Процедура СформироватьТаблицаРеестрВвезенных(СтруктураДополнительныеСвойства) 
	...
	Запрос.Текст =
		...
		|		ИНАЧЕ ВременнаяТаблицаРазделы.ЗачетНДС
		|	КОНЕЦ КАК ЗачетНДС,
		|	СУММА(ВременнаяТаблицаРазделы.БазаНДС) КАК Сумма,
