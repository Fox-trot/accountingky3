...
Функция ПодготовитьПараметрыРасчета(ИмяТабличнойЧасти)
	...
	ПараметрыРасчета.Вставить("СтавкаНДС", 					Объект.СтавкаНДС);
	ПараметрыРасчета.Вставить("СчитатьСкидкуОтдельно",		Ложь);
	
	Если ИмяТабличнойЧасти = "Товары" Тогда
		ПараметрыРасчета.Вставить("СтавкаНСП", Объект.СтавкаНСП);	
	Иначе
		ПараметрыРасчета.Вставить("СтавкаНСП", Объект.СтавкаНСПУслуги);
	КонецЕсли;	
