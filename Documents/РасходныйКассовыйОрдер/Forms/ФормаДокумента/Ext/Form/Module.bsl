...
Процедура СформироватьНадписьКурсоваяРазница()
	...
	СчитатьОКР = СчитатьОперационныеКурсовыеРазницы();
	
	Если НЕ СчитатьОКР Тогда
...
&НаСервере
Функция СчитатьОперационныеКурсовыеРазницы()

	Возврат БухгалтерскийУчетСервер.СчитатьОперационныеКурсовыеРазницы();	
