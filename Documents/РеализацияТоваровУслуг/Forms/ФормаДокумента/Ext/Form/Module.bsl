...
Процедура УстановитьВидимостьДоступностьЭлементов()	
	...
	СтруктураНадписи = Новый Структура("УчетВалютныхОпераций, ВалютаДокумента, ТипЦен, СтавкаНДС, СтавкаНСП, СуммаВключаетНалоги", 
		Истина, 
		Объект.ВалютаДокумента,
		СтруктураДанные.ТипЦен,
		Объект.СтавкаНДС,
		Объект.СтавкаНСП,
		Объект.СуммаВключаетНалоги);
...
Функция ПолучитьДанныеДоговорПриИзменении(Период, ВалютаДокумента, ДоговорКонтрагента)
	...
	СтруктураДанные.Вставить(
		"СтавкаНСПУслуги",
		ДоговорКонтрагента.СтавкаНСПУслуги
	);
...
Процедура ОбработатьИзменениеДоговора(МодифицированДоговор = Ложь)
	...
	Если ДоговорПередИзменением <> Объект.ДоговорКонтрагента
		...
		Объект.СтавкаНСПУслуги = СтруктураДанные.СтавкаНСПУслуги;		
