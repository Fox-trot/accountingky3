...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыРасчета.Вставить("Период", 					Параметры.Объект.Дата);
	ПараметрыРасчета.Вставить("Организация", 				Параметры.Объект.Организация);
	...
	ПараметрыРасчета.Вставить("БезналичныйРасчет", 			Параметры.Объект.БезналичныйРасчет);
	ПараметрыРасчета.Вставить("СчитатьОтДохода", 			Истина);
	ПараметрыРасчета.Вставить("ИмяТабличнойЧасти", 			Параметры.ИмяТаблицы);
	ПараметрыРасчета.Вставить("Точность", 					?(Параметры.Объект.ТочностьЦены = 0, 2, Параметры.Объект.ТочностьЦены));
	ПараметрыРасчета.Вставить("СтавкаНДС", 					Параметры.СтавкаНДС);
	ПараметрыРасчета.Вставить("СтавкаНСП", 					Параметры.СтавкаНСП);
	...
	Для Каждого СтрокаТабличнойЧасти Из Параметры.Объект[Параметры.ИмяТаблицы] Цикл
		...
		Иначе
			Если Параметры.ИмяТаблицы <> "ОС" Тогда
