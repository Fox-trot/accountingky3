...
Процедура ОСЛиквидационнаяСтоимостьПриИзменении(Элемент)
	...
	ТД.СтоимостьДляВычисленияАмортизации = ТД.ПервоначальнаяСтоимость - ТД.ЛиквидационнаяСтоимость; 
КонецПроцедуры

&НаКлиенте
Процедура ОСПервоначальнаяСтоимостьПриИзменении(Элемент)
	СТЧ = Элементы.ОС.ТекущиеДанные;
	СТЧ.СтоимостьДляВычисленияАмортизации 	= СТЧ.ПервоначальнаяСтоимость; 
КонецПроцедуры
