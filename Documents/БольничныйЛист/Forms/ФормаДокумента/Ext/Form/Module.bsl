...
Процедура ФизЛицоПриИзмененииНаСервере()
	...
	Объект.Подразделение = СведенияОСотруднике.Подразделение;
	Объект.Должность = СведенияОСотруднике.Должность;
	Объект.ГрафикРаботы = СведенияОСотруднике.ГрафикРаботы;
