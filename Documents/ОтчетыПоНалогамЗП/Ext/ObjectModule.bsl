...
Процедура ЗаполнитьПодоходныйНалог() Экспорт
...
Процедура ЗаполнитьПодоходныйНалогПриложение() Экспорт
...
Процедура ЗаполнитьСоцфонд() Экспорт
	...
	Запрос.Текст = 
		...
		|	&НачалоПериода КАК ДатаНачалаРаботы,
		|	&КонецПериода КАК ДатаОкончанияРаботы,
