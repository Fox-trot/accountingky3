...
//				- ОбработчикиРеквизитовОтборов
//				- ОбработчикиКомандФормы
//				- ОбработчикиРезультатовИнтерактивныхДействий
//				- СлужебныеПроцедурыИФункции
//              - <прочие области> --- Например: ОбработчикиБиблиотек, МеткиОтборов и т.д.
// 2. Раздел «Обработчики событий элементов шапки формы» содержит процедуры-обработчики элементов, расположенных в основной части формы.
// 3. Процедуры и функции, объединенные общим функционалом/назначением и не использующиеся в других целях, 
//	    допускается объединять в отдельных области. Например, #Область ЗагрузкаИзExcel
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МожноРедактировать = ПравоДоступа("Редактирование", Метаданные.Документы.удалитьШаблон);
...
Процедура ОтборСотрудникОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	УстановитьМеткуИОтборСписка("Комиссия.ФизЛицо", Элемент.Родитель.Имя, ВыбранноеЗначение);
