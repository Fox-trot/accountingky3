...
Функция ПечатьБухгалтерскаяСправка(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Запрос.Текст = 
		...
		|	ВТХозрасчетный.СчетДт КАК СчетДт,
		...
		|	ВТХозрасчетный.СчетКт КАК СчетКт,
		|	ВТХозрасчетный.СубконтоКт1 КАК СубконтоКт1,
		|	ВТХозрасчетный.СубконтоКт2 КАК СубконтоКт2,
		|	ВТХозрасчетный.СубконтоКт3 КАК СубконтоКт3,
		|	ВТХозрасчетный.Организация КАК Организация,
		|	ВТХозрасчетный.Организация.НаименованиеПолное КАК ОрганизацияНаименованиеПолное,
		|	ВТХозрасчетный.ВалютаДт КАК ВалютаДт,
		|	ВТХозрасчетный.ВалютаКт КАК ВалютаКт,
		|	ВТХозрасчетный.Сумма КАК Сумма,
		|	ВТХозрасчетный.ВалютнаяСуммаДт КАК ВалютнаяСуммаДт,
		|	ВТХозрасчетный.ВалютнаяСуммаКт КАК ВалютнаяСуммаКт,
		|	ВТХозрасчетный.КоличествоДт КАК КоличествоДт,
		|	ВТХозрасчетный.КоличествоКт КАК КоличествоКт,
