...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =
		...
		|							ИНАЧЕ ВременнаяТаблицаТовары.Сумма + ВременнаяТаблицаТовары.СуммаНДС + ВременнаяТаблицаТовары.СуммаНСП - ВременнаяТаблицаТовары.СуммаАкциза
		|						КОНЕЦ 
...
Процедура СформироватьТаблицаРеестрПриобретенныхМатериальныхРесурсов(ДокументСсылка, СтруктураДополнительныеСвойства) 
	...
	Запрос.Текст =
		...
		|	(ВЫБРАТЬ
		|		ВременнаяТаблицаТовары.ЗачетНДС КАК ЗачетНДС,
		|		ЕСТЬNULL(СУММА(ВременнаяТаблицаТовары.Сумма - ВременнаяТаблицаТовары.СуммаНСП), 0) КАК Сумма,
		|		ЕСТЬNULL(СУММА(ВременнаяТаблицаТовары.СуммаНДС), 0) КАК СуммаНДС
		|	ИЗ
		|		ВременнаяТаблицаТовары КАК ВременнаяТаблицаТовары
		|	
		...
		|	ВЫБРАТЬ
		|		ВременнаяТаблицаУслуги.ЗачетНДС,
		|		ЕСТЬNULL(СУММА(ВременнаяТаблицаУслуги.Сумма - ВременнаяТаблицаУслуги.СуммаНСП), 0),
		...
		|	ВЫБРАТЬ
		|		ВременнаяТаблицаОС.ЗачетНДС,
		|		ЕСТЬNULL(СУММА(ВременнаяТаблицаОС.Сумма - ВременнаяТаблицаОС.СуммаНСП), 0),
