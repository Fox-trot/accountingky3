...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	ТекстЗапроса =
		...
		|				И &УказыватьПризнакЗачетаНДС
		|			ТОГДА ВременнаяТаблицаУслуги.Сумма + ВременнаяТаблицаУслуги.СуммаНДС + ВременнаяТаблицаУслуги.СуммаНСП - ВременнаяТаблицаУслуги.СуммаАкциза
	...
	ТекстЗапроса = ТекстЗапроса +
		...
		|				И &УказыватьПризнакЗачетаНДС
		|			ТОГДА ВременнаяТаблицаОС.Сумма + ВременнаяТаблицаОС.СуммаНДС + ВременнаяТаблицаОС.СуммаНСП - ВременнаяТаблицаОС.СуммаАкциза
	...
	ТекстЗапроса = ТекстЗапроса +
		...
		|	ВременнаяТаблицаУслуги.Сумма + ВременнаяТаблицаУслуги.СуммаНСП КАК Сумма,
...
Процедура СформироватьТаблицаРеестрПриобретенныхМатериальныхРесурсов(ДокументСсылка, СтруктураДополнительныеСвойства) 
	...
	Запрос.Текст =
		...
		|		КОГДА ВременнаяТаблицаШапка.ВидОперации = ЗНАЧЕНИЕ(Перечисление.ВидыОперацийПоступлениеТоваровУслуг.ЗакупочныйАкт)
		|			ТОГДА ИСТИНА
		|		ИНАЧЕ НЕ ВременнаяТаблицаШапка.СерияБланкаСФ = """"
		|	КОНЕЦ
