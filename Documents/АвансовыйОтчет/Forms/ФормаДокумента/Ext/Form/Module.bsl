...
// Процедура - обработчик события ПриИзменении поля ввода ОбменВалютСуммаяПосле.
//
&НаКлиенте
...
Процедура ОбновитьПодвал(Закладка = Неопределено)
	...
	Если Закладка = "Выплата ЗП" ИЛИ Закладка = Неопределено Тогда
	...
	Если Закладка = "Обмен валют" ИЛИ Закладка = Неопределено Тогда
