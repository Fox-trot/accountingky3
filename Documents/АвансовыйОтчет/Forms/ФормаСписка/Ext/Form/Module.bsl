...
&НаКлиенте
Процедура ОтборСписокОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	Если Не ЗначениеЗаполнено(ВыбранноеЗначение) Тогда
		Возврат;
	КонецЕсли;
	
	Если ВыбранноеЗначение = "Оплата" Тогда 
		УстановитьМеткуИОтборСписка("ОплатаПоставщикам.НомерСтроки", Элемент.Родитель.Имя, 1, НСтр("ru = 'Оплата'"));
		ВыбранноеЗначение = Неопределено;
	ИначеЕсли ВыбранноеЗначение = "Услуги" Тогда 
		УстановитьМеткуИОтборСписка("Прочее.НомерСтроки", Элемент.Родитель.Имя, 1, НСтр("ru = 'Услуги'"));
		ВыбранноеЗначение = Неопределено;
	ИначеЕсли ВыбранноеЗначение = "ВыплатаЗП" Тогда 
		УстановитьМеткуИОтборСписка("ВыплатаЗаработнойПлаты.НомерСтроки", Элемент.Родитель.Имя, 1, НСтр("ru = 'Выплата ЗП'"));
		ВыбранноеЗначение = Неопределено;
	ИначеЕсли ВыбранноеЗначение = "Патенты" Тогда 
		УстановитьМеткуИОтборСписка("ВладельцыПатентов.НомерСтроки", Элемент.Родитель.Имя, 1, НСтр("ru = 'Патенты'"));
		ВыбранноеЗначение = Неопределено;
	ИначеЕсли ВыбранноеЗначение = "ОбменВалют" Тогда 
		УстановитьМеткуИОтборСписка("ОбменВалют.НомерСтроки", Элемент.Родитель.Имя, 1, НСтр("ru = 'Обмен валют'"));
		ВыбранноеЗначение = Неопределено;
	КонецЕсли;	
