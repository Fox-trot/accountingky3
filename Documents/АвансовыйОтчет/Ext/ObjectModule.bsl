...
//	ДанныеЗаполнения - Структура - Данные заполнения документа.
//	
Процедура ЗаполнитьДокументПоДокументуВедомостьЗП(ДанныеЗаполнения) Экспорт
	//ДокументОснование 		= ДанныеЗаполнения;
	//Организация				= ДанныеЗаполнения.Организация;
	//
	//ЗаполнитьАвансы(КонецДня(ТекущаяДатаСеанса()));	
...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	СтратегияЗаполнения[Тип("ДокументСсылка.ВедомостьЗП")] = "ЗаполнитьДокументПоДокументуВедомостьЗП";
