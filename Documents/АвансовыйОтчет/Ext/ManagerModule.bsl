	...
	Пока Шапка.Следующий() Цикл
		...
		Если ВыборкаПоСсылкеПроводки.Следующий() Тогда
			...
			Пока ВыборкаПроводок.Следующий() Цикл
				...
				Если ВыборкаПроводок.СчетДт = ПланыСчетов.Хозрасчетный.РасчетыСПодотчетнымиЛицами 
					И ВыборкаПроводок.СчетКт = ПланыСчетов.Хозрасчетный.РасчетыСПодотчетнымиЛицами Тогда

					ОбластьМакета.Параметры.СубСчетДебет1   = ВыборкаПроводок.СчетДт;
					ОбластьМакета.Параметры.СубСчетКредит1  = ПланыСчетов.Хозрасчетный.Вспомогательный;
					...
					ОбластьМакета.Параметры.СубСчетДебет1   =  ПланыСчетов.Хозрасчетный.Вспомогательный;
		...
		Если ВыборкаПоСсылке.Следующий() Тогда
			...
			Пока Товар.Следующий() Цикл
				...
				ОбластьМакета.Параметры.ДокументДата        = Формат(Товар.ДокументДата, "ДФ=dd.MM.yyyy");
