...
Процедура СформироватьТаблицаХозрасчетный(СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =
		...
		|	ВедомостьНаВыплатуЗарплатыЗарплата.СуммаПоАвансовомуОтчету,
		|	&ВалютаРегламентированногоУчета,
		|	&ВалютаРегламентированногоУчета,
		|	ВедомостьНаВыплатуЗарплатыЗарплата.СуммаПоАвансовомуОтчету,
		|	ВедомостьНаВыплатуЗарплатыЗарплата.СуммаПоАвансовомуОтчету,
		...
		|	И ВедомостьНаВыплатуЗарплатыЗарплата.СуммаПоАвансовомуОтчету <> 0
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
...
Функция ПечатьАвансовогоОтчета(МассивОбъектов, ОбъектыПечати)
	...
	ТекстЗапроса =
		...
		|	СУММА(ВыплатаЗарплатыЗарплата.СуммаПоАвансовомуОтчету),
		|	СУММА(ВыплатаЗарплатыЗарплата.СуммаПоАвансовомуОтчету),
		|	ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.НачисленнаяЗаработнаяПлата),
