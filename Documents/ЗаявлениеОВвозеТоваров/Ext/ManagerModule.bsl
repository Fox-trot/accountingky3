...
Процедура СформироватьТаблицаСведенияОВвозимыхТоварах(СтруктураДополнительныеСвойства) 
	...
	Запрос.Текст =
		...
		|	ВременнаяТаблицаТовары.ДокументПоступления.Дата КАК Дата,
...
Функция ПечатьЗаявленияОВвозе(МассивОбъектов, ОбъектыПечати)
	...
	ТекстЗапроса =
		...
		|	ЗаявлениеОВвозеТоваров.Курс КАК Курс,
	...
	Пока ВыборкаДок.Следующий() Цикл
		...
		Если Товары.Количество() > 0 Тогда
			ДанныеПечати.Вставить("НомерДоговора",	Товары[0].НомерДоговора);
			ДанныеПечати.Вставить("ДатаДоговора",	Товары[0].ДатаДоговора);	
		КонецЕсли;	
		...
		Пока ВыборкаСтрокТовары.Следующий() Цикл
			...
			ДанныеПечатиСтроки.Вставить("Курс", 		ВыборкаДок.Курс);
