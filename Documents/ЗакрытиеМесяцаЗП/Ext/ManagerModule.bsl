...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =
		...
		|	ВременнаяТаблицаНалогиСОрганизации.НоменклатурнаяГруппа,
		// Субконто Кт
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
		...
		|	ВременнаяТаблицаШапка.Организация,
		// Счет Дт/Кт
		|	ВременнаяТаблицаНалогиСОрганизацииКорректировки.СчетУчетаЗатрат,
		|	&СчетУчетаРасчетовПФФ,
		// Субконто Дт
		|	ВременнаяТаблицаНалогиСОрганизацииКорректировки.СтатьяЗатрат,
		|	ВременнаяТаблицаНалогиСОрганизацииКорректировки.Подразделение,
		|	ВременнаяТаблицаНалогиСОрганизацииКорректировки.НоменклатурнаяГруппа,
		// Субконто Кт
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
