...
Процедура ЗаполнитьНаСервере()
	...
	МассивРезультатов = Документы.ЗакрытиеМесяца.ПолучитьДанныеПоНалогуНаИмущество(Объект.Организация, НачалоГода(Объект.Дата), КонецГода(Объект.Дата));
	...
	СуммаНалога = МассивРезультатов[9].Выгрузить().Итог("СуммаНалога");
