...
Процедура ВыполнитьПредварительныйКонтроль(Отказ)
	...
	Запрос = Новый Запрос(
		...
		|	И (СведенияОРаботеСверхурочно.ФизЛицо, СведенияОРаботеСверхурочно.ДатаНачала, СведенияОРаботеСверхурочно.ДатаОкончания) В
		|			(ВЫБРАТЬ РАЗЛИЧНЫЕ
	...
	// Мсяц начала и окончания периода должен быть одинаковым.
