...
Функция ПечатнаяФормаПриказОРаботеВВыходнойИПраздничныйДень(МассивОбъектов, ОбъектыПечати)
	...
	ТекстЗапроса = 
		...
		|	РаботаВВыходныеИПраздничныеДни.ПериодРегистрации,
	...
	ТабличныйДокумент.ИмяПараметровПечати = "ПФ_MXL_ПриказОРаботеВВыходнойИПраздничныйДень";
		...
		Для Каждого ИмяОбласти Из МассивОбластейМакета Цикл
			...
			ИначеЕсли ИмяОбласти = "Сотрудник" Тогда  
				...
				Пока ВыборкаПоСотрудникам.Следующий() Цикл 
					...
					ОбластьМакета.Параметры.ДолжностьНаименование 	= ДанныеФизЛица.Должность;						
					ТабличныйДокумент.Вывести(ОбластьМакета);
				КонецЦикла;	
			КонецЕсли;
		КонецЦикла;
