...
Процедура КонтрольКомплектов(Отказ)
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
			ТекстСообщения = СтрШаблон(НСтр("ru = 'Вы перемещаете все элементы комплекта ""%1"". Добавьте этот комплект в табличную часть, а основное средство ""%2"" удалите из табличной части.'"), 
