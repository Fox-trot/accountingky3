...
Процедура ЗначениеСтавкиНДСПриИзменении(Элемент)
	...
	Для Каждого СтрокаТабличнойЧасти Из Объект.Товары Цикл	 
		ОбработкаТабличныхЧастейКлиентСервер.РассчитатьЦенуСтрокиТабличнойЧасти(
			СтрокаТабличнойЧасти,,ПараметрыРасчета.ПризнакСтраныЕАЭС);
	КонецЦикла;
...
Функция ПодготовитьПараметрыРасчета(ДляОС = Ложь)
	...
	ПараметрыРасчета.Вставить("СуммаВключаетНалоги", 	ПризнакСтраныЕАЭС);
	...
	ПараметрыРасчета.Вставить("РассчитатьБазуНДС", 		?(ДляОС, Ложь, ПризнакСтраныЕАЭС));
	ПараметрыРасчета.Вставить("РассчитатьОтБазыНДС", 	?(ДляОС, Ложь, ПризнакСтраныЕАЭС));
