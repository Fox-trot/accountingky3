...
Процедура ТоварыКоличествоПриИзменении(Элемент)	
	...
	Если ЗначениеЗаполнено(Объект.ДокументОснование) Тогда
		...
		Иначе
			СтрокаТабличнойЧасти.Всего = СтрокаТабличнойЧасти.Количество / СтрокаТабличнойЧасти.КоличествоПоПоступлению * СтрокаТабличнойЧасти.ВсегоПоПоступлению;
			СтрокаТабличнойЧасти.Сумма = СтрокаТабличнойЧасти.Количество / СтрокаТабличнойЧасти.КоличествоПоПоступлению * СтрокаТабличнойЧасти.СуммаПоПоступлению;
			СтрокаТабличнойЧасти.СуммаНДС = СтрокаТабличнойЧасти.Количество / СтрокаТабличнойЧасти.КоличествоПоПоступлению * СтрокаТабличнойЧасти.СуммаНДСПоПоступлению;
			СтрокаТабличнойЧасти.СуммаНСП = СтрокаТабличнойЧасти.Количество / СтрокаТабличнойЧасти.КоличествоПоПоступлению * СтрокаТабличнойЧасти.СуммаНСППоПоступлению;
			СтрокаТабличнойЧасти.СуммаАкциза = СтрокаТабличнойЧасти.Количество / СтрокаТабличнойЧасти.КоличествоПоПоступлению * СтрокаТабличнойЧасти.СуммаАкцизаПоПоступлению;
		КонецЕсли;	
