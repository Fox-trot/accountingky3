...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства, Отказ)
	...
	Запрос.Текст =
		...
		|	ВременнаяТаблицаШапка.ВалютаДокумента,
		|	-ВременнаяТаблицаОС.СуммаВозврат,
		|	-ВременнаяТаблицаОС.СуммаВалютнаяВозврат,
		|	-ВременнаяТаблицаОС.СуммаВалютнаяВозврат,
		|	&СодержаниеОС,
		|	0,
		|	0
		...
		|	ВременнаяТаблицаШапка.ВалютаДокумента,
		|	ВременнаяТаблицаШапка.ВалютаДокумента,
		|	-СУММА(ВременнаяТаблицаОС.СуммаНДСВозврат),
		|	-СУММА(ВременнаяТаблицаОС.СуммаНДСВалютнаяВозврат),
		|	-СУММА(ВременнаяТаблицаОС.СуммаНДСВалютнаяВозврат),
		|	&СодержаниеОСНДС,
		|	0,
		|	0
		...
		|	ВременнаяТаблицаШапка.Дата,
		|	ВременнаяТаблицаШапка.Организация,
		|	ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.РасходыПоВозвратамПоставщикам),
		|	ВременнаяТаблицаШапка.СчетРасчетов,
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
		|	НЕОПРЕДЕЛЕНО,
		...
		|	ВременнаяТаблицаШапка.ВалютаДокумента,
		|	ВременнаяТаблицаШапка.ВалютаДокумента,
		|	-СУММА(ВременнаяТаблицаОС.СуммаВозврат - ВременнаяТаблицаОС.СуммаПоступление),
		|	-СУММА(ВременнаяТаблицаОС.СуммаВалютнаяВозврат - ВременнаяТаблицаОС.СуммаВалютнаяПоступление),
		|	-СУММА(ВременнаяТаблицаОС.СуммаВалютнаяВозврат - ВременнаяТаблицаОС.СуммаВалютнаяПоступление),
		...
		|	ВременнаяТаблицаШапка.ВалютаДокумента,
		|	ВременнаяТаблицаШапка.ВалютаДокумента,
		|	-СУММА(ВременнаяТаблицаОС.СуммаНДСВозврат - ВременнаяТаблицаОС.СуммаНДСПоступление),
		|	-СУММА(ВременнаяТаблицаОС.СуммаНДСВалютнаяВозврат - ВременнаяТаблицаОС.СуммаНДСВалютнаяПоступление),
		|	-СУММА(ВременнаяТаблицаОС.СуммаНДСВалютнаяВозврат - ВременнаяТаблицаОС.СуммаНДСВалютнаяПоступление),
...
Процедура СформироватьТаблицаРеестрЗакупок(ДокументСсылка, СтруктураДополнительныеСвойства) 
	...
	Запрос.Текст =
		...
		|	ВременнаяТаблицаШапка.ЗначениеСтавкиНДС,
		|	ВременнаяТаблицаШапка.ЗначениеСтавкиНСП,
		|	-ВЫРАЗИТЬ(ВременнаяТаблицаУслуги.СуммаНДС * ВременнаяТаблицаШапка.Курс / ВременнаяТаблицаШапка.Кратность КАК ЧИСЛО(15, 2)) КАК СуммаНДС,
		...
		|	-ВЫРАЗИТЬ(ВременнаяТаблицаУслуги.СуммаНСП * ВременнаяТаблицаШапка.Курс / ВременнаяТаблицаШапка.Кратность КАК ЧИСЛО(15, 2)) КАК СуммаНСП,
		...
		|	ВременнаяТаблицаШапка.ЗначениеСтавкиНДС,
		|	ВременнаяТаблицаШапка.ЗначениеСтавкиНСП,
		|	-ВЫРАЗИТЬ(ВременнаяТаблицаОС.СуммаНДС * ВременнаяТаблицаШапка.Курс / ВременнаяТаблицаШапка.Кратность КАК ЧИСЛО(15, 2)) КАК СуммаНДС,
		|	-ВЫРАЗИТЬ(ВременнаяТаблицаОС.Сумма * ВременнаяТаблицаШапка.Курс / ВременнаяТаблицаШапка.Кратность КАК ЧИСЛО(15, 2)) КАК Сумма,
		|	-ВЫРАЗИТЬ(ВременнаяТаблицаОС.СуммаНСП * ВременнаяТаблицаШапка.Курс / ВременнаяТаблицаШапка.Кратность КАК ЧИСЛО(15, 2)) КАК СуммаНСП,
		|	-1 КАК Количество
		|ИЗ
		|	ВременнаяТаблицаОС КАК ВременнаяТаблицаОС
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВременнаяТаблицаШапка КАК ВременнаяТаблицаШапка
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, СтруктураДополнительныеСвойства, Отказ) Экспорт
	...
	Запрос.Текст =
		...
		|	ВозвратТоваровПоставщику.Контрагент.ПризнакСтраны КАК ПризнакСтраны,
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ВозвратТоваровПоставщикуОС.НомерСтроки КАК НомерСтроки,
		|	ВозвратТоваровПоставщикуОС.ОсновноеСредство КАК ОсновноеСредство,
		|	ВозвратТоваровПоставщикуОС.Сумма КАК Сумма,
		|	ВозвратТоваровПоставщикуОС.СуммаНДС КАК СуммаНДС,
		|	ВозвратТоваровПоставщикуОС.СуммаНСП КАК СуммаНСП,
		|	ВозвратТоваровПоставщикуОС.Всего КАК Всего,
		|	ВозвратТоваровПоставщикуОС.СуммаПоПоступлению КАК СуммаПоПоступлению,
		|	ВозвратТоваровПоставщикуОС.СуммаНДСПоПоступлению КАК СуммаНДСПоПоступлению,
		|	ВозвратТоваровПоставщикуОС.СуммаНСППоПоступлению КАК СуммаНСППоПоступлению,
		|	ВозвратТоваровПоставщикуОС.ВсегоПоПоступлению КАК ВсегоПоПоступлению,
		|   ВозвратТоваровПоставщикуОС.СчетУчета КАК СчетУчета,
		|	ВозвратТоваровПоставщикуОС.ЗачетНДС КАК ЗачетНДС
		|ПОМЕСТИТЬ ВременнаяТаблицаОСПредварительно
		|ИЗ
		|	Документ.ВозвратТоваровПоставщику.ОС КАК ВозвратТоваровПоставщикуОС
		|ГДЕ
		|	ВозвратТоваровПоставщикуОС.Ссылка = &ДокументСсылка
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|   ВременнаяТаблицаОСПредварительно.ОсновноеСредство,
		|	ВЫБОР
		|		КОГДА ВременнаяТаблицаОСПредварительно.ЗачетНДС = ЗНАЧЕНИЕ(Перечисление.ВидыЗачетаНДС.Себестоимость) И &УказыватьПризнакЗачетаНДС
		|			ТОГДА ВЫБОР
		|					КОГДА ВременнаяТаблицаШапка.ПризнакСтраны = ЗНАЧЕНИЕ(Перечисление.ПризнакиСтраны.ЕАЭС)
		...
		|						КОНЕЦ 
		|				ИНАЧЕ ВЫРАЗИТЬ((ВременнаяТаблицаОСПредварительно.Сумма + ВременнаяТаблицаОСПредварительно.СуммаНСП) * ВременнаяТаблицаШапка.Курс / ВременнаяТаблицаШапка.Кратность КАК ЧИСЛО(15, 2))
		|			КОНЕЦ
		|	КОНЕЦ КАК Сумма,
		|	ВЫБОР
		|		КОГДА ВременнаяТаблицаШапка.ПризнакСтраны = ЗНАЧЕНИЕ(Перечисление.ПризнакиСтраны.ЕАЭС)
		|			ТОГДА ВременнаяТаблицаОСПредварительно.Всего
		|		ИНАЧЕ ВЫБОР
		|				КОГДА ВременнаяТаблицаОСПредварительно.ЗачетНДС = ЗНАЧЕНИЕ(Перечисление.ВидыЗачетаНДС.Себестоимость) И &УказыватьПризнакЗачетаНДС
		|					ТОГДА ВременнаяТаблицаОСПредварительно.Сумма + ВременнаяТаблицаОСПредварительно.СуммаНДС + ВременнаяТаблицаОСПредварительно.СуммаНСП
		|				ИНАЧЕ ВременнаяТаблицаОСПредварительно.Сумма + ВременнаяТаблицаОСПредварительно.СуммаНСП
		|			КОНЕЦ
		|	КОНЕЦ КАК СуммаВалютная,
		|	ВЫБОР
		|		КОГДА ВременнаяТаблицаШапка.ПризнакСтраны = ЗНАЧЕНИЕ(Перечисление.ПризнакиСтраны.ЕАЭС)
		|			ТОГДА ВременнаяТаблицаОСПредварительно.СуммаНДС
		|		ИНАЧЕ ВЫРАЗИТЬ(ВременнаяТаблицаОСПредварительно.СуммаНДС * ВременнаяТаблицаШапка.Курс / ВременнаяТаблицаШапка.Кратность КАК ЧИСЛО(15, 2))
		|	КОНЕЦ КАК СуммаНДС
		...
		|			ТОГДА ВЫБОР
		|					КОГДА ВременнаяТаблицаШапка.ПризнакСтраны = ЗНАЧЕНИЕ(Перечисление.ПризнакиСтраны.ЕАЭС)
		|						ТОГДА ВременнаяТаблицаОСПредварительно.СуммаПоПоступлению + ВременнаяТаблицаОСПредварительно.СуммаНДСПоПоступлению
		|					ИНАЧЕ ВЫРАЗИТЬ((ВременнаяТаблицаОСПредварительно.СуммаПоПоступлению + ВременнаяТаблицаОСПредварительно.СуммаНДСПоПоступлению + ВременнаяТаблицаОСПредварительно.СуммаНСППоПоступлению) * ВременнаяТаблицаШапка.Курс / ВременнаяТаблицаШапка.Кратность КАК ЧИСЛО(15, 2))
		|				КОНЕЦ
		|		ИНАЧЕ ВЫБОР
		|				КОГДА ВременнаяТаблицаШапка.ПризнакСтраны = ЗНАЧЕНИЕ(Перечисление.ПризнакиСтраны.ЕАЭС)
		|					ТОГДА 
		|						ВЫБОР
		|							КОГДА ВременнаяТаблицаШапка.ПлательщикНДС
		|								ТОГДА ВременнаяТаблицаОСПредварительно.СуммаПоПоступлению + ВременнаяТаблицаОСПредварительно.СуммаНСППоПоступлению
		|							ИНАЧЕ ВременнаяТаблицаОСПредварительно.СуммаПоПоступлению + ВременнаяТаблицаОСПредварительно.СуммаНДСПоПоступлению + ВременнаяТаблицаОСПредварительно.СуммаНСППоПоступлению
		|						КОНЕЦ 
		|				ИНАЧЕ ВЫРАЗИТЬ((ВременнаяТаблицаОСПредварительно.СуммаПоПоступлению + ВременнаяТаблицаОСПредварительно.СуммаНСППоПоступлению) * ВременнаяТаблицаШапка.Курс / ВременнаяТаблицаШапка.Кратность КАК ЧИСЛО(15, 2))
		|			КОНЕЦ
		|	КОНЕЦ КАК Сумма,
		|	ВЫБОР
		|		КОГДА ВременнаяТаблицаШапка.ПризнакСтраны = ЗНАЧЕНИЕ(Перечисление.ПризнакиСтраны.ЕАЭС)
		|			ТОГДА ВременнаяТаблицаОСПредварительно.ВсегоПоПоступлению
		|		ИНАЧЕ ВЫБОР
		|				КОГДА ВременнаяТаблицаОСПредварительно.ЗачетНДС = ЗНАЧЕНИЕ(Перечисление.ВидыЗачетаНДС.Себестоимость) И &УказыватьПризнакЗачетаНДС
		|					ТОГДА ВременнаяТаблицаОСПредварительно.СуммаПоПоступлению + ВременнаяТаблицаОСПредварительно.СуммаНДСПоПоступлению + ВременнаяТаблицаОСПредварительно.СуммаНСППоПоступлению
		|				ИНАЧЕ ВременнаяТаблицаОСПредварительно.СуммаПоПоступлению + ВременнаяТаблицаОСПредварительно.СуммаНСППоПоступлению
		|			КОНЕЦ
		|	КОНЕЦ КАК СуммаВалютная,
		|	ВЫБОР
		|		КОГДА ВременнаяТаблицаШапка.ПризнакСтраны = ЗНАЧЕНИЕ(Перечисление.ПризнакиСтраны.ЕАЭС)
		|			ТОГДА ВременнаяТаблицаОСПредварительно.СуммаНДСПоПоступлению
		|		ИНАЧЕ ВЫРАЗИТЬ(ВременнаяТаблицаОСПредварительно.СуммаНДСПоПоступлению * ВременнаяТаблицаШапка.Курс / ВременнаяТаблицаШапка.Кратность КАК ЧИСЛО(15, 2))
		|	КОНЕЦ КАК СуммаНДС
		...
		|	ВременнаяТаблицаОСПредварительно.СуммаНДСПоПоступлению КАК СуммаНДСВалютнаяПоступление,
