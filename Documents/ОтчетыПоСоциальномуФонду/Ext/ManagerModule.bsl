...
//  Табличный документ - печатная форма
//
Функция ПечатьЕжемесячногоПоСФШтрих(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Пока Шапка.Следующий() Цикл
		...
		ОбластьМакета.Рисунки.ШтрихкодПоле.ТипКода = 1;
		ОбластьМакета.Рисунки.ШтрихкодПоле.ТекстКода = 4353487689;
		ТабличныйДокумент.Вывести(ОбластьМакета);
