...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	Если Объект.ВидОперации = Перечисления.ВидыОперацийКорректировкаДолга.ПереносЗадолженности Тогда
		...
		Элементы.ВидЗадолженностиДляПереноса.Заголовок = "Перенести";
	...
	ИначеЕсли Объект.ВидОперации = Перечисления.ВидыОперацийКорректировкаДолга.СписаниеЗадолженности Тогда
		...
		Элементы.СчетаУчета.Заголовок = "Счета списания";
		Элементы.СчетаУчета.Видимость = Истина;
			
		Элементы.ВидЗадолженностиДляПереноса.Заголовок = "Списать";
...
Процедура УстановитьПараметрыВыбора()
	...
	СвязиДоговораНовогоКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Организация", "Объект.Организация"));
	
	СвязиКорДоговораНовогоКонтрагента = Новый Массив;
	СвязиКорДоговораНовогоКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Организация", "Объект.Организация"));
	СвязиКорДоговораНовогоКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.ВалютаРасчетов", "Элементы.ТаблицаКредиторскаяЗадолженность.ТекущиеДанные.ВалютаДоговораКонтрагента"));

	СвязиДоговораКонтрагента = Новый Массив;
	СвязиДоговораКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Организация", "Объект.Организация"));

	СвязиКорДоговораКонтрагента = Новый Массив;
	СвязиКорДоговораКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Организация", "Объект.Организация"));
	СвязиКорДоговораКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.ВалютаРасчетов", "Элементы.ТаблицаДебиторскаяЗадолженность.ТекущиеДанные.ВалютаДоговораКонтрагента"));

	СвязиДокументаНовогоКонтрагента = Новый Массив;
	СвязиДокументаНовогоКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Организация", "Объект.Организация"));
	
	СвязиДокументаКонтрагента = Новый Массив;
	СвязиДокументаКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Организация", "Объект.Организация"));
	
	Если Объект.ВидОперации = Перечисления.ВидыОперацийКорректировкаДолга.ПереносЗадолженности Тогда

		СвязиДоговораНовогоКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Владелец", "Объект.КонтрагентКредитор"));
		
		СвязиДоговораКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Владелец", "Объект.КонтрагентДебитор"));
		СвязиДокументаКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Контрагент", "Объект.КонтрагентДебитор"));
		
		СвязиКорДоговораНовогоКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Владелец", "Объект.КонтрагентКредитор"));
		СвязиКорДоговораКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Владелец", "Объект.КонтрагентКредитор"));
	...
	ИначеЕсли Объект.ВидОперации = Перечисления.ВидыОперацийКорректировкаДолга.СписаниеЗадолженности Тогда
		...
		СвязиДоговораНовогоКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Владелец", "Объект.КонтрагентДебитор"));
		СвязиДокументаНовогоКонтрагента.Добавить(Новый СвязьПараметраВыбора("Отбор.Контрагент", "Объект.КонтрагентДебитор"));
