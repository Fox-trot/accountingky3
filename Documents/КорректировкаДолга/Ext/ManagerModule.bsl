...
Процедура СформироватьТаблицаХозрасчетный(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =
		...
		|	ВременнаяТаблицаШапка.СуммаКтЗадолженности КАК Сумма,
		|	ВременнаяТаблицаШапка.ВалютаПрихода КАК ВалютаДт,
		|	ВременнаяТаблицаШапка.ВалютаРасхода КАК ВалютаКт,
		|	ВременнаяТаблицаШапка.СуммаДтЗадолженности КАК ВалютнаяСуммаДт,
		|	ВременнаяТаблицаШапка.СуммаКтЗадолженности КАК ВалютнаяСуммаКт,
		|	&Содержание КАК Содержание
		|ИЗ
		|	ВременнаяТаблицаШапка КАК ВременнаяТаблицаШапка";
	Запрос.УстановитьПараметр("Содержание", НСтр("ru = 'Корректировка долга'"));
	РезультатЗапроса = Запрос.Выполнить();		
	...
	//	|		ПО ТаблицаДокумента.СчетРасхода = СчетаУчетаСОсобымПорядкомПереоценки.СчетУчета
	//	|ГДЕ
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.Текст =
		...
		|	ТаблицаДокумента.СуммаКтЗадолженности КАК СуммаКтЗадолженности,
		|	ТаблицаДокумента.СуммаДтЗадолженности КАК СуммаДтЗадолженности
