...
Функция ПолучитьКоличествоЛистов(Макет, ТаблицаТовары)
	...
	ОбластьПодвал 	 = Макет.ПолучитьОбласть("ИтогоПоЛисту");
...
Функция ПечатьПриложение2(МассивОбъектов, ОбъектыПечати)
	...
	Пока Шапка.Следующий() Цикл
		...
		КоличествоЛистов = ПолучитьКоличествоЛистов(Макет, Шапка.Приложение2.Выгрузить());
...
Функция ПечатьПриложение2_1(МассивОбъектов, ОбъектыПечати)
	...
	Запрос.Текст = 
		...
		|		МУКЦЗаЕдиницуТовара КАК МУКЦЗаЕдиницуТовара,
