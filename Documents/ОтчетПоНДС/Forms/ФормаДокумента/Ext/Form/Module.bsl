...
Функция ФормированиеФайлаXML(ДополнительныеПараметры, Ошибки)
	...
	ТаблицаРеестрГТД 						= ВыборкаШапка.ОтчетРеестрГТД.Выгрузить();
	...
	ОбъектXDTO.data.Добавить(data("sti_062_003", ?(ТаблицаРеестрГТД.Количество() = 0, 0, 1)));
	...
	ОбъектXDTO.attachment.Добавить(attachment(3, ТаблицаРеестрГТД));
