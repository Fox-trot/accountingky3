...
Функция ПечатьОтчетаРеестрПоставок(МассивОбъектов, ОбъектыПечати)	
	...
	|		СерияСФ,
	|		КодПоставки,
	|		ВЫРАЗИТЬ(КонтрагентНаименование КАК СТРОКА(20)) КАК КонтрагентНаименование,
	|		ИННКонтрагента,
	|		КодГНС,
	|		ДатаПоставки,
	|		СтоимостьБезНДС,
...
Функция ПечатьОтчетаРеестрПриобретенных(МассивОбъектов, ОбъектыПечати)	
	...
	|		КорНомерСФ,
	|		КорСерияСФ,
	|		ВЫРАЗИТЬ(КонтрагентНаименование КАК СТРОКА(24)) КАК КонтрагентНаименование,
	|		ИННКонтрагента,
	|		КодГНС,
	|		ДатаПоставки,
	|		СтоимостьБезНДС,
...
Функция ПечатьОтчетаРеестрВвезенных(МассивОбъектов, ОбъектыПечати)
	...
	Запрос.Текст = 
		...
		|		Комментарий,
		|		ВЫБОР
		|			КОГДА Контрагент.ПризнакСтраны = ЗНАЧЕНИЕ(Перечисление.ПризнакиСтраны.ЕАЭС)
		|				ТОГДА ИСТИНА
		|			ИНАЧЕ ЛОЖЬ 
...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "РеестрГТД") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм, 
		"РеестрГТД", 
		НСтр("ru = 'Реестр ввезенных материальных ресурсов'"), 
