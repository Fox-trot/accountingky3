...
Процедура ЗаполнитьОтражениеВУчете()
	...
	СтруктураОтбора.КатегорияДолжности = Объект.Должность.Категория;
	...
	Объект.СчетУчетаЗатрат = ДанныеСчетаУчетаЗП.СчетУчетаЗатрат;
	Объект.СтатьяЗатрат = ДанныеСчетаУчетаЗП.СтатьяЗатрат;
