...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УПП = БухгалтерскийУчетВызовСервераПовтИсп.ПолучитьДанныеУчетнойПолитикиОрганизаций(Объект.Дата, Объект.Организация);
...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	Элементы.КоэффициентОсвобожденныхПоставок.Видимость = Объект.РасчетНДС И УПП.ВводКоэффициентаОсвобожденныхПоставокВЗакрытииМесяца;
