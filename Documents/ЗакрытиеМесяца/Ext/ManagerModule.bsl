...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, СтруктураДополнительныеСвойства) Экспорт 		
	...
	Запрос.Текст =
		...
		|	ТаблицаДокумента.РасчетНалогаНаПрибыль,
		...
		|	ЗакрытиеМесяцаДоотгрузкаРасшифровка.Договор,
		|	ЗакрытиеМесяцаДоотгрузкаРасшифровка.ДокументАванса,
		|	ЗакрытиеМесяцаДоотгрузкаРасшифровка.Сумма,
		|	ЗакрытиеМесяцаДоотгрузкаРасшифровка.СуммаНДС,
		|	ЗакрытиеМесяцаДоотгрузкаРасшифровка.СуммаНСП,
		|	ЗакрытиеМесяцаДоотгрузкаРасшифровка.ДокументОплаты
		...
		|	ЗакрытиеМесяцаАвансы.СуммаНДС,
		|	ЗакрытиеМесяцаАвансы.СуммаНСП
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ЗакрытиеМесяцаРасходыБП.Ссылка,
		|	ЗакрытиеМесяцаРасходыБП.СчетДт,
		|	ЗакрытиеМесяцаРасходыБП.СчетКт,
		|	ЗакрытиеМесяцаРасходыБП.СубконтоДт1,
		|	ЗакрытиеМесяцаРасходыБП.СубконтоДт2,
		|	ЗакрытиеМесяцаРасходыБП.СубконтоДт3,
		|	ЗакрытиеМесяцаРасходыБП.Сумма,
		|	ЗакрытиеМесяцаРасходыБП.РБП КАК СубконтоКт1,
		|	ЗакрытиеМесяцаРасходыБП.СуммаНДС
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ЗакрытиеМесяцаНалоговаяАмортизация.ГруппаНУ,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.ОсновноеСредство,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.БалансоваяСтоимостьНаНГ,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.УвеличениеСтоимости,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.УвеличениеСтоимостиНУ,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.ПоступлениеПГ,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.СуммаВыбытияОбщая,		
		|	ЗакрытиеМесяцаНалоговаяАмортизация.СуммаВыбытияНУ,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.ВыбытиеПГ,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.ЗатратыНаРемонт,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.НормаНаРемонт,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.Превышение,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.БалансоваяСтоимость,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.БалансоваяСтоимостьИтого,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.НормаАО,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.Амортизация,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.УвеличениеСОД,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.ВычетМеньше100РП,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.ДатаПринятияКУчету,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.КоличествоЛетЭксплуатации,
		|	ЗакрытиеМесяцаНалоговаяАмортизация.БазаПрямолинейнойАмортизации
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ЗакрытиеМесяцаНалоговаяВыверка.Ссылка,
		|	ЗакрытиеМесяцаНалоговаяВыверка.НомерСтроки,
		|	ЗакрытиеМесяцаНалоговаяВыверка.Сумма,
		|	ЗакрытиеМесяцаНалоговаяВыверка.НаименованиеСтроки
