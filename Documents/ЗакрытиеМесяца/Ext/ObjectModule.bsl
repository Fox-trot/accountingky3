...
Процедура ВыполнитьЗакрытиеМесяца(ПараметрыПроцедуры, АдресХранилища = Неопределено) Экспорт
	...
	Если РасчетАмортизацииОС Тогда
		...
		РассчитатьАмортизациюОсновныхСредств(ДанныеУчетнойПолитики, ПараметрыПроцедуры.Ошибки);
	...
	Если РасчетНДС Тогда 
		...
		Если ДанныеУчетнойПолитики.УчетНДСНаАвансы Тогда 
			РассчитатьНДСНаАвансыДоотгрузку(ДанныеУчетнойПолитики, ПараметрыПроцедуры.Ошибки);
		КонецЕсли;	
	...
	Если РасчетСтоимостиПродукцииПоНоменклатурнымГруппам Тогда 
		...
		РассчитатьСтоимостиПродукцииПоНоменклатурнымГруппам(ДанныеУчетнойПолитики, ПараметрыПроцедуры.Сообщения, ПараметрыПроцедуры.Ошибки);
		ОтразитьРасчетСтоимостиПродукцииПоНоменклатурнымГруппам(ДополнительныеСвойства, ПараметрыПроцедуры.Ошибки);
	КонецЕсли;
	...
	Если РасчетНалогаНаИмущество Тогда 
		...
		РассчитатьНалогНаИмущество(ПараметрыПроцедуры.Ошибки);
