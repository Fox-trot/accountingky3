...
Процедура СформироватьНадписи()
	...
	Если РасчетСтоимостиПродукции Тогда
		НадписьСебестоимостиГотовойПродукции = СтрШаблон(НСтр("ru = 'Сумма плановая: %1; Сумма фактическая: %2'"), СуммаГотоваяПродукцияПлановая, СуммаГотоваяПродукцияФактическая);	
	КонецЕсли;	
КонецПроцедуры
