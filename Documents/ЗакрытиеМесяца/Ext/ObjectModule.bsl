...
Процедура ВыполнитьЗакрытиеМесяца(СтруктураПараметров) Экспорт
	...
	Если ЗакрытьВременныеСчетаУчета
		...
		Попытка
			...
			// Временно отменяем расчет себестоимости продукции, так как еще не рапределены накладные расходы.
			РасчетСтоимостиПродукцииПередИзменением = РасчетСтоимостиПродукции;
			РасчетСтоимостиПродукции = Ложь;
			
			Записать(РежимЗаписиДокумента.Проведение);
			
			РасчетСтоимостиПродукции = РасчетСтоимостиПродукцииПередИзменением;
		Исключение
			ОтменитьТранзакцию();
