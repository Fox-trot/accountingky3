...
Процедура ЗаполнитьДокументыОснования() Экспорт
	...
	// Заполнение отбора по шапке
	Если ЗначениеЗаполнено(ДоговорКонтрагента) Тогда
		Отбор = "ВременнаяТаблицаДокументы.ДоговорКонтрагента = &ДоговорКонтрагента";
	Иначе	
		Отбор = "ВременнаяТаблицаДокументы.БезналичныйРасчет = &БезналичныйРасчет
