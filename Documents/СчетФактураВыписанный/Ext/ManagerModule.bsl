...
Процедура СформироватьТаблицаСчетаФактурыВыписанные(ДокументСсылка, СтруктураДополнительныеСвойства)
	...
	Запрос.Текст =
		...
		|	ВременнаяТаблицаШапка.ЗаполнятьТоварами КАК ЗаполненоПоТоварам,
		|	ВременнаяТаблицаШапка.ЗаполнятьУслугами КАК ЗаполненоПоУслугам,
		|	ВременнаяТаблицаДокументыОснования.Сумма КАК СуммаБезНДС,
		...
		|	ВременнаяТаблицаОбщая.ЗаполненоПоТоварам,
		|	ВременнаяТаблицаОбщая.ЗаполненоПоУслугам,
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылка, СтруктураДополнительныеСвойства) Экспорт
	...
	Запрос.Текст =
		...
		|	ТаблицаДокумента.ЗаполнятьТоварами,
		|	ТаблицаДокумента.ЗаполнятьУслугами
