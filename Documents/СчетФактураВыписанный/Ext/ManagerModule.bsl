...
Функция ПечатьСчетФактура(МассивОбъектов, ОбъектыПечати, КоличествоСтрокСчетаФактуры)
	...
	Пока Шапка.Следующий() Цикл
		...
		ДанныеПечати.Вставить("ПредставлениеПокупателя", Шапка.КонтрагентПредставление);
...
Функция ПолучитьТекстЗапросаДокументовОснования()
	...
	ТекстЗапроса =
		...
		|	ВременнаяТаблицаДокументыОснования.ДокументСФ,
		|	СчетНаОплатуПокупателюТовары.Ссылка,
		|	СчетНаОплатуПокупателюТовары.Ссылка.Курс,
		|	СчетНаОплатуПокупателюТовары.Ссылка.Кратность,
		...
		|	СчетНаОплатуПокупателюТовары.Всего,
		|	ВЫБОР
		|		КОГДА СчетНаОплатуПокупателюТовары.Ссылка.СуммаВключаетНалоги
		|			ТОГДА СчетНаОплатуПокупателюТовары.Сумма - СчетНаОплатуПокупателюТовары.СуммаНДС - СчетНаОплатуПокупателюТовары.СуммаНСП
		...
		|	ВременнаяТаблицаДокументыОснования.ДокументСФ,
		|	СчетНаОплатуПокупателюУслуги.Ссылка,
		|	СчетНаОплатуПокупателюУслуги.Ссылка.Курс,
		|	СчетНаОплатуПокупателюУслуги.Ссылка.Кратность,
		...
		|	СчетНаОплатуПокупателюУслуги.Всего,
		|	ВЫБОР
		|		КОГДА СчетНаОплатуПокупателюУслуги.Ссылка.СуммаВключаетНалоги
		|			ТОГДА СчетНаОплатуПокупателюУслуги.Сумма - СчетНаОплатуПокупателюУслуги.СуммаНДС - СчетНаОплатуПокупателюУслуги.СуммаНСП
