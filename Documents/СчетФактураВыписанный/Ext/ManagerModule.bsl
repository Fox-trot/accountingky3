					...
					Для Каждого СтрокаТаблицы Из ИсходнаяТаблица Цикл
						...
						Если ОбластьМакетаДопСтрока = Неопределено Тогда
							...
							ЗначениеСтавкиНСП = ?(ДанныеУчетнойПолитики.ПлательщикНСП, 
												УчетНДСВызовСервера.ПолучитьСтавкуНСП(Шапка.Дата, Шапка.Организация, СтрокаТаблицы.СтавкаНСП), 
												ПредопределенноеЗначение("Справочник.СтавкиНСП.ПустаяСсылка"));
							
							ЗначениеСтавкиНДС = ?(ДанныеУчетнойПолитики.ПлательщикНДС, 
												УчетНДСВызовСервера.ПолучитьСтавкуНДС(Шапка.Дата, СтрокаТаблицы.СтавкаНДС), 
						...
						Иначе
							...
							Если Строки.Количество() > 0 Тогда
								...
								Иначе	
									...
									// Ставки
									ЗначениеСтавкиНСП = ?(ДанныеУчетнойПолитики.ПлательщикНСП, 
														УчетНДСВызовСервера.ПолучитьСтавкуНСП(Шапка.Дата, Шапка.Организация, Данные.СтавкаНСП), 
														ПредопределенноеЗначение("Справочник.СтавкиНСП.ПустаяСсылка"));
									
									ЗначениеСтавкиНДС = ?(ДанныеУчетнойПолитики.ПлательщикНДС, 
														УчетНДСВызовСервера.ПолучитьСтавкуНДС(Шапка.Дата, Данные.СтавкаНДС), 
														ПредопределенноеЗначение("Справочник.СтавкиНДС.ПустаяСсылка"));
			...
			Для Каждого ИмяОбласти Из МассивОбластейМакета Цикл
				...
				ИначеЕсли ИмяОбласти = "СтрокаТаблицы" Тогда 
					...
					Для Каждого СтрокаМассива Из МассивСтрок Цикл
						...
						ЗначениеСтавкиНСП = КэшЗначенийСтавок.Получить(СтрокаМассива.СтавкаНСП);
						
						Если ЗначениеСтавкиНСП = Неопределено Тогда
							ЗначениеСтавкиНСП = УчетНДСВызовСервера.ПолучитьСтавкуНСП(Шапка.Дата, Шапка.Организация, СтрокаМассива.СтавкаНСП);
