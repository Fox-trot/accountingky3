...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	Если Объект.СуммаВключаетНалоги Тогда
		...
		Элементы.ДокументыДоход1.Видимость 	= Ложь;
		Элементы.ДокументыВсего.Видимость 	= Ложь;
		Элементы.ДокументыДоход2.Видимость 	= Истина;
	Иначе
		...
		Элементы.ДокументыДоход1.Видимость 	= Истина;
		Элементы.ДокументыВсего.Видимость 	= Истина;
		Элементы.ДокументыДоход2.Видимость 	= Ложь;
	КонецЕсли;
КонецПроцедуры	
