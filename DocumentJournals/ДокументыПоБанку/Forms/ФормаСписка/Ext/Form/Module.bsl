...
Процедура ПередЗагрузкойДанныхИзНастроекНаСервере(Настройки)
	...
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(БанковскиеВыписки, "ОрганизацияДляОтбора", Организация, ЗначениеЗаполнено(Организация));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(БанковскиеВыписки, "Контрагент", Контрагент, ЗначениеЗаполнено(Контрагент));
	БухгалтерскийУчетКлиентСервер.УстановитьЭлементОтбораСписка(БанковскиеВыписки, "БанковскийСчет", БанковскийСчет, ЗначениеЗаполнено(БанковскийСчет));
