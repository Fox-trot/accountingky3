...
Функция СоздатьУзелОбменаДанными(НастройкиПодключенияXDTO)
	
	НастройкиПодключения = СериализаторXDTO.ПрочитатьXDTO(НастройкиПодключенияXDTO);
	
	Обработки.ПомощникСозданияОбменаДанными.ВыполнитьДействияПоНастройкеОбменаДанными(НастройкиПодключения);
