...
Функция СоставНастроекТранспортаОбмена(ПодстрокаПоиска)
	...
	Для Каждого Ресурс Из СоздатьНаборЗаписей().Метаданные().Ресурсы Цикл
...
Процедура ДобавитьЭлементПредставленияНастройки(Структура, ИмяНастройки)
	...
	Структура.Вставить(ИмяНастройки,
		СоздатьНаборЗаписей().Метаданные().Ресурсы[ИмяНастройки].Представление());
