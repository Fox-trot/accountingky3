...
//				НСтр("ru = 'Вид стажа с категорией ""%1"" уже существует.'"),
...
//				Продолжить;
//			КонецЕсли;
//			ТекстОшибки = СтрШаблон(НСтр("ru = 'Вид стажа с категорией ""%1"" уже существует.'"),	Выборка.КатегорияСтажа);
//			ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстОшибки,,,,Отказ);
//		КонецЦикла;
//		
//	КонецЕсли;
...
//				ТекстОшибки = СтрШаблон(ТекстОшибки, ВыборкаСтажей.ФизическоеЛицо);
//				ОбщегоНазначенияКлиентСервер.СообщитьПользователю(ТекстОшибки,,,, Отказ);
//			КонецЕсли;
//		КонецЦикла;
//	КонецЕсли;
