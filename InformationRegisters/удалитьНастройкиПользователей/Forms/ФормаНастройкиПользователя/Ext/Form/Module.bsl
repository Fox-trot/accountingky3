...
Процедура ЗаполнитьДерево()
	...
	|ИЗ
	|	ПланВидовХарактеристик.удалитьНастройкиПользователей КАК Настройки
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.удалитьНастройкиПользователей КАК ЗначениеНастроек
	...
	|	И НЕ(Настройки.Ссылка = ЗНАЧЕНИЕ(ПланВидовХарактеристик.удалитьНастройкиПользователей.ОсновнаяОрганизация)
	...
	|	И НЕ Настройки.Ссылка = ЗНАЧЕНИЕ(ПланВидовХарактеристик.удалитьНастройкиПользователей.ОсновноеПодразделениеОрганизаций)
	|
	|УПОРЯДОЧИТЬ ПО
	|	ЭтоГруппа ИЕРАРХИЯ,
...
Процедура ОбновитьНастройки()
	...
	НаборЗаписей = РегистрыСведений.удалитьНастройкиПользователей.СоздатьНаборЗаписей();
