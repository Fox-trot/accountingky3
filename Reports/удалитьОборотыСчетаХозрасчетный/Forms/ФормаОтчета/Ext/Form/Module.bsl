...
// Процедура - обработчик события ПриИзменении поля ввода Показатель.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода ПоказательРазвернутоеСальдо.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода СальдоНаНачалоДт.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода СальдоНаНачалоКт.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода СальдоНаКонецДт.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода СальдоНаКонецКт.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода ОборотыЗаПериодДт.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода ОборотыЗаПериодКт.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода ОборотыСоСчетамиДт.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода ОборотыСоСчетамиКт.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода МакетОформления.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода Группировка.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода Отборы.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода РазмещениеДополнительныхПолей.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода ДополнительныеПоля.
//
&НаКлиенте
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = СтрШаблон(НСтр("ru = 'Обороты счета %1 %2'"),
		Отчет.Счет, 
...
Процедура ЗаполнитьНастройкамиПоУмолчанию(ЗаполняемыеНастройки) Экспорт
	...
	//		
	//		БухгалтерскиеОтчетыКлиентСервер.ОбработатьОтборПриСменеСчета(ДанныеСтарогоСчета, ДанныеСчета, Отчет.КомпоновщикНастроек);
	//		
	//	КонецЕсли;
	//КонецЕсли;
