...
// После переименования ключа варианта отчета в команде "ВаловаяПрибыль", необходимо перенести сохраненные пользовательские настройки отчета
// из хранилища настроек со старым ключом варианта отчета в новый, чтобы настройки корректно восстанавливались при работе с отчетом.
//
Процедура ПеренестиТекущиеПользовательскиеНастройки() Экспорт
	...
	Для Каждого ПользовательИБ Из ПользователиИБ Цикл
		...
		СохраненныеНастройки = ОбщегоНазначения.ХранилищеСистемныхНастроекЗагрузить(СтарыйКлючОбъекта, , Неопределено, , ПользовательИБ.Имя);
		Если СохраненныеНастройки = Неопределено Тогда
			Продолжить;
		КонецЕсли;
		
		ОбщегоНазначения.ХранилищеСистемныхНастроекСохранить(НовыйКлючОбъекта, , СохраненныеНастройки, , ПользовательИБ.Имя);
		
		ОбщегоНазначения.ХранилищеСистемныхНастроекУдалить(СтарыйКлючОбъекта, , ПользовательИБ.Имя);
