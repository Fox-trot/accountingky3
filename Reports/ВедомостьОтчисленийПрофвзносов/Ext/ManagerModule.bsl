...
Процедура СформироватьТабличныйДокумент(СтруктураПараметров, РезультатФормирования)
	...
	|	ПрофвзносыСрезПоследних.Профсоюз КАК Профсоюз
	|ПОМЕСТИТЬ ВременнаяТаблицаПрофсоюзы
	|ИЗ
	...
	|						ВременнаяТаблицаНачисленныеПрофВзносы.Физлицо
	|					ИЗ
	|						ВременнаяТаблицаНачисленныеПрофВзносы КАК ВременнаяТаблицаНачисленныеПрофВзносы)) КАК ПрофвзносыСрезПоследних
	|ГДЕ
	...
	|	ВременнаяТаблицаПрофсоюзы.Профсоюз КАК Профсоюз
	|ИЗ
	|	ВременнаяТаблицаНачисленныеПрофВзносы КАК ВременнаяТаблицаНачисленныеПрофВзносы
	...
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВременнаяТаблицаПрофсоюзы КАК ВременнаяТаблицаПрофсоюзы
	|		ПО ВременнаяТаблицаНачисленныеПрофВзносы.Физлицо = ВременнаяТаблицаПрофсоюзы.ФизЛицо
	|
	|СГРУППИРОВАТЬ ПО
	|	ВременнаяТаблицаПрофсоюзы.Профсоюз";	
