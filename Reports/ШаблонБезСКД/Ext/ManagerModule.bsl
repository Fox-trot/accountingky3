...
Процедура СформироватьТабличныйДокумент(СтруктураПараметров, РезультатФормирования) Экспорт
	...
	ОсновнойТекстЗапроса = 
		...
		|		ПО (ПоступленияИтоги.ДокументПоступления = ПоступленияОбороты.Регистратор)
		...
		|	ПоступленияОбороты.Регистратор,
		|	""Ставка НДС: Без НДС"",
		...
		|	ВременнаяТаблицаОбщая.СуммаБезНДС КАК СуммаБезНДС,
		|	ВременнаяТаблицаОбщая.СуммаНДС КАК СуммаНДС,
		|	ВременнаяТаблицаОбщая.СуммаНеоблагаемая КАК СуммаНеоблагаемая,
