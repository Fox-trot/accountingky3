...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Возврат "Расчетная ведомость" + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(ПараметрыОтчета.НачалоПериода, ПараметрыОтчета.КонецПериода);
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "РасчетнаяВедомостьДетальный");
	НастройкиВарианта.Описание = НСтр("ru = 'Выводит информацию о начислениях и удержаниях за указанный период в разрезах видов начислений, удержаний, налогов и выплат.'");
КонецПроцедуры
...
Функция ВариантыНастроек() Экспорт
	...
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("Имя, Представление","РасчетнаяВедомостьДетальный", "Расчетная ведомость (детальный)"));	
	Возврат Массив;
