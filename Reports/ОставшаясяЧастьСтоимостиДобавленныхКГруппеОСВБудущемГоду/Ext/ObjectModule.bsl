...
Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
	...
	Заголовок = "Оставшаяся часть стоимости добавленных к группе ОС в будущем году";
	...
	ПараметрыОтчета.Вставить("ИдентификаторОтчета"      , "ОставшаясяЧастьСтоимостиДобавленныхКГруппеОСВБудущемГоду");
