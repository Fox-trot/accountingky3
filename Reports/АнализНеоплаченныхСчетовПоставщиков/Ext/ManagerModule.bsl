...
Функция ВариантыНастроек() Экспорт
	Возврат ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Новый Структура("Имя, Представление", "НеоплаченныеСчетаПоставщиков", НСтр("ru = 'Счета, не оплаченные поставщикам'")));
КонецФункции
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "НеоплаченныеСчетаПоставщиков");
	НастройкиВарианта.Описание = НСтр("ru = 'Счета, не оплаченные поставщикам'");
КонецПроцедуры
