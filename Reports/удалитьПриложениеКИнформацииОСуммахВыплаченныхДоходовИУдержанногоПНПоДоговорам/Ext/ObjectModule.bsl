...
Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
	...
	Заголовок = "Приложение к информации о суммах выплаченных доходов и удержанного подоходного налога в разрезе лиц, работающих по договорам, заключенным в соответствии с трудовым законодательством КР";
	...
	ПараметрыОтчета.Вставить("ИдентификаторОтчета"      , "ПриложениеКИнформацииОСуммахВыплаченныхДоходовИУдержанногоПНПоДоговорам");
