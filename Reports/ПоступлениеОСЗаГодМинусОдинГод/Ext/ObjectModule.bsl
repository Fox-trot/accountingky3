...
Процедура ОпределитьНастройкиФормы(Форма, КлючВарианта, Настройки) Экспорт
	...
	НовоеСоответствие.Вставить("Год", Перечисления.ДоступныеПериодыОтчета.Год);
	Настройки.Вставить("ПриНажатииКнопкиВыбораПериода", НовоеСоответствие);	
КонецПроцедуры 
...
Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
	...
	ПараметрПериод = НастройкиОтчета.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("НаДату"));
	...
	Заголовок = "Поступления ОС с " 
		+ ?(ЗначениеЗаполнено(Период.Дата), СтрЗаменить(Строка(Год(Период.Дата) - 1), Символы.НПП, ""), "") 
		+ " года, введенных  в эксплуатацию в " + ?(ЗначениеЗаполнено(Период.Дата), СтрЗаменить(Строка(Год(Период.Дата)), Символы.НПП, ""), "") + " году";
	...
	ПараметрыОтчета.Вставить("ИдентификаторОтчета"      , "ПоступлениеОСЗаГодМинусОдинГод");
