...
Процедура СформироватьТабличныйДокумент(ТабличныйДокумент, ВидОтчета, СтПериод) Экспорт
	...
	Если ВидОтчета = "Обороты" Тогда 
		ТабличныйДокумент.КлючПараметровПечати = "МониторДенежныхСредств_СхемаВалютныйПоВалюте";		
	ИначеЕсли ВидОтчета = "Расшифровка" Тогда 
		ТабличныйДокумент.КлючПараметровПечати = "МониторДенежныхСредств_СхемаРасшифровка";		
	КонецЕсли;
...
Процедура СформироватьТабличныйДокументМониторИзДокумента(ТабличныйДокумент, СтруктураДанных) Экспорт
	...
	ТабличныйДокумент = Новый ТабличныйДокумент;
	ТабличныйДокумент.КлючПараметровПечати = "МониторДенежныхСредств_РасшифровкаДокумента";
