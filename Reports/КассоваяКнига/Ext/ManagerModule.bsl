...
Процедура СформироватьТитульныйЛист(ЛистовЗаГод, ПараметрыОтчета, СписокСформированныхЛистов)
	...
	ОбластьОбложка.Параметры.РНН_БИН             = "РНН БИН";
...
Функция ПолучитьОтветственныхЛиц(ДатаЛиста, ПараметрыОтчета)
	...
	Руководители = БухгалтерскийУчетСервер.ОтветственныеЛицаОрганизаций(ПараметрыОтчета.Организация, ПараметрыОтчета.КонецПериода,ОтборПоКассе);
