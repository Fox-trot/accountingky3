...
Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
	...
	// Проверка отбора по подразделению
	УстановленОтборПоПодразделению = Ложь;

	Для Каждого ЭлементОтбора Из НастройкиОтчета.Отбор.Элементы Цикл
		Если ТипЗнч(ЭлементОтбора) = Тип("ЭлементОтбораКомпоновкиДанных") 
			И Строка(ЭлементОтбора.ЛевоеЗначение) = "Подразделение" Тогда 
			УстановленОтборПоПодразделению = ЭлементОтбора.Использование;
		КонецЕсли;
	КонецЦикла;

	ПараметрУстановленОтборПоПодразделению = НастройкиОтчета.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("УстановленОтборПоПодразделению"));
	Если ПараметрУстановленОтборПоПодразделению <> Неопределено Тогда
		ПараметрУстановленОтборПоПодразделению.Значение = УстановленОтборПоПодразделению;
	КонецЕсли;
	...
	ПараметрыОтчета.Вставить("ИдентификаторОтчета"      , "ЖурналОС");
