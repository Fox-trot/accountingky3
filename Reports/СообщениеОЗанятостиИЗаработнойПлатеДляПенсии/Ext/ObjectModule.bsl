...
// КЭ ***Мальцев А.П. АПМ закомментировал от 21.10.2016 <<
//Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
//	
//	ВыводитьЗаголовок = Ложь;
//	ВыводитьПодписи = Ложь;
//	Заголовок = "Сообщение о занятости и заработной плате";
//	
...
//	ПараметрыОтчета.Вставить("ИдентификаторОтчета"      , "СообщениеОЗанятостиИЗаработнойПлатеДляПенсии");
