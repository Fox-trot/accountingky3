...
Процедура ОпределитьНастройкиФормы(Форма, КлючВарианта, Настройки) Экспорт
	...
	Настройки.Печать.АвтоМасштаб = Истина;
...
Функция ПодготовитьПараметрыОтчета(НастройкиОтчета)
	...
	Заголовок = "Свод себестоимости товара по импорту";
	...
	ПараметрыОтчета.Вставить("ИдентификаторОтчета"      , "удалитьСводСебестоимостиТовараПоИмпорту");
