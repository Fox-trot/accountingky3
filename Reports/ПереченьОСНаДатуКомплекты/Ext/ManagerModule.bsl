...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Возврат "Перечень ОС (комплекты) на " + Формат(ПараметрыОтчета.Период, "ДФ=dd.MM.yyyy; ДП=...");
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(КомпоновщикНастроек.Настройки.Выбор, "НакопленнаяАмортизация");
	БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(КомпоновщикНастроек.Настройки.Выбор, "ОстаточнаяСтоимость");
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ПереченьОСНаДатуКомплекты");
	НастройкиВарианта.Описание = НСтр("ru = 'Выводит информацию по составам комплектов.'");
КонецПроцедуры
...
Процедура ЗаполнитьПараметрыРасшифровкиОтчета(Адрес, Расшифровка, ПараметрыРасшифровки) Экспорт
	...
	СписокПунктовМеню.Добавить("ПереченьОСНаДатуКомплекты", "Перечень ОС на дату (комплекты)");
	
	НастройкиРасшифровки = Новый Структура();
	НастройкиРасшифровки.Вставить("ПереченьОСНаДатуКомплекты", ПользовательскиеНастройки);
...
Функция ВариантыНастроек() Экспорт
	...
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("Имя, Представление","ПереченьОСНаДатуКомплекты", "Перечень ОС на дату (комплекты)"));	
	Возврат Массив;
