...
Функция ПодготовитьПараметрыОтчетаНаСервере()
	...
	ПараметрыОтчета.ВсеДопРасходы                 	= Отчет.ВсеДопРасходы;
	ПараметрыОтчета.ВалютаРегламентированногоУчета  = ОбщегоНазначенияБПВызовСервераПовтИсп.ПолучитьВалютуРегламентированногоУчета();
	...
	ПараметрыОтчета.Вставить("ЗаголовокОтчета", ПредставлениеТекущегоВарианта);
