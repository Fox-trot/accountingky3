...
Функция ВариантыНастроек() Экспорт
	Возврат ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Новый Структура("Имя, Представление", "СводСебестоимостиТовараПоИмпорту", НСтр("ru = 'Свод с/с товара по импорту'")));
КонецФункции
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "СводСебестоимостиТовараПоИмпорту");
	НастройкиВарианта.Описание = НСтр("ru = 'Свод с/с товара по импорту'");
КонецПроцедуры
...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	ТекстЗаголовкаОтчета = НСтр("ru = 'Свод с/с товара по импорту %1'");
...
Процедура ЗаполнитьПараметрыРасшифровкиОтчета(Адрес, Расшифровка, ПараметрыРасшифровки) Экспорт
	...
	СписокПунктовМеню.Добавить("СводСебестоимостиТовараПоИмпорту", "Свод с/с товара по импорту");
	
	НастройкиРасшифровки = Новый Структура();
	НастройкиРасшифровки.Вставить("СводСебестоимостиТовараПоИмпорту", ПользовательскиеНастройки);
