...
Функция ВариантыНастроек() Экспорт
	...
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("Имя, Представление","СводСебестоимостиТовараПоИмпорту", НСтр("ru = 'Свод с/с товара по импорту'")));
	Возврат Массив;
КонецФункции
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	БухгалтерскиеОтчетыКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ВсеДопРасходы", ПараметрыОтчета.ВсеДопРасходы);
...
Функция НастройкиОтчетаСохраняемыеВРассылке() Экспорт
	...
	КоллекцияНастроек.Вставить("ВсеДопРасходы"                , Ложь);
