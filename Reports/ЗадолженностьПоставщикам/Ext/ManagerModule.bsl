...
Функция ВариантыНастроек() Экспорт
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("Имя, Представление","ЗадолженностьПоставщикам",  НСтр("ru = 'Задолженность поставщикам'")));
	Массив.Добавить(Новый Структура("Имя, Представление","ЗадолженностьПоставщикамПоДоговорам",  НСтр("ru = 'Задолженность поставщикам по договорам'")));
	Возврат Массив;
КонецФункции
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ЗадолженностьПоставщикамПоДоговорам");
	НастройкиВарианта.Описание = НСтр("ru = 'Задолженность поставщикам по договорам'");
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ЗадолженностьПоставщикам");
	НастройкиВарианта.Описание = НСтр("ru = 'Задолженность поставщикам'");
КонецПроцедуры
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	ПредопределенныеСчетаАвансов.Добавить(ПланыСчетов.Хозрасчетный.АвансыВыданные);
...
Функция ПолучитьЗадолженностьПоставщикамДляМонитораРуководителя(Организация, ДатаЗадолженности) Экспорт
	...
	Запрос.Текст = 
		...
		|				И ВЫРАЗИТЬ(Субконто2 КАК Справочник.ДоговорыКонтрагентов).ВидДоговора = ЗНАЧЕНИЕ(Перечисление.ВидыДоговоровКонтрагентов.СПоставщиком)) КАК ХозрасчетныйОстатки
		|ГДЕ
