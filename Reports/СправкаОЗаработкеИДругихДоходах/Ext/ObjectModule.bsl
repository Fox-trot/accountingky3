...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	Для Каждого СтрокаФизЛицо Из ДанныеОтчета.Строки Цикл
		...
		Если ЕстьГруппировкаПоОрганизации Тогда
			...
			ОбластьМакета.Параметры.Адрес = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъекта(СтрокаФизЛицо.Организация, Справочники.ВидыКонтактнойИнформации.ЮрАдресОрганизации, ДатаПодписи);
		Иначе
			ОбластьМакета.Параметры.ИННОрганизации = ОсновнаяОрганизация.ИНН;
			ОбластьМакета.Параметры.Адрес = УправлениеКонтактнойИнформацией.КонтактнаяИнформацияОбъекта(ОсновнаяОрганизация, Справочники.ВидыКонтактнойИнформации.ЮрАдресОрганизации, ДатаПодписи);
		КонецЕсли; 
