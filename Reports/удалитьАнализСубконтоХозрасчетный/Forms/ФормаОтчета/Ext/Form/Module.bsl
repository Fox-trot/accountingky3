...
#Область ОбработчикиСобытийТаблицыФормыВидыСубконто

// Процедура - обработчик события ПриИзменении поля ввода СписокВидовСубконто.
//
&НаКлиенте
...
#Область ОбработчикиСобытийТаблицыДополнительныеПоля
		...
		Если ЗаполняемыеНастройки.Отбор И НЕ Отчет.РежимРасшифровки Тогда
			...
			Для Каждого ЭлементОтбора Из Отчет.КомпоновщикНастроек.Настройки.Отбор.Элементы Цикл
				Если ТипЗнч(ЭлементОтбора) = Тип("ЭлементОтбораКомпоновкиДанных") Тогда 
					Если Найти(ЭлементОтбора.ЛевоеЗначение, "Субконто") > 0 ИЛИ (Строка(ЭлементОтбора.ЛевоеЗначение) = "Валюта" И НЕ ЕстьВалюта) Тогда
