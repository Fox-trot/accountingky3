...
Процедура ЗаполнитьПравилаРасшифровки(Правила) Экспорт
		...
		// Когда БухТипРесурса известен открывается отчет по проводкам который может дать более точную расшифровку используя
		// эту информацию. В остальных случаях будем открывать карточку счета, для этого у БухТипРесурса значение по умолчанию
		// "Неопределено" и правилами наложен фильтр.
