...
Процедура ПолеОрганизацияОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	...
	ОбщегоНазначенияБПКлиент.ПолеОрганизацияОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка, СоответствиеОрганизаций, Отчет.Организация);
...
Процедура ЗаполнитьДополнительныеПоляПоУмолчанию()
	...
	СтрокаДопПолей = Отчет.ДополнительныеПоля.Добавить();
	СтрокаДопПолей.Использование = Истина;
	СтрокаДопПолей.Поле          = "Доход";
	СтрокаДопПолей.Представление = "Доход";

	СтрокаДопПолей = Отчет.ДополнительныеПоля.Добавить();
	СтрокаДопПолей.Использование = Истина;
	СтрокаДопПолей.Поле          = "Себестоимость";
	СтрокаДопПолей.Представление = "Себестоимость";

	СтрокаДопПолей = Отчет.ДополнительныеПоля.Добавить();
	СтрокаДопПолей.Использование = Истина;
	СтрокаДопПолей.Поле          = "Скидка";
	СтрокаДопПолей.Представление = "Скидка";

	СтрокаДопПолей = Отчет.ДополнительныеПоля.Добавить();
	СтрокаДопПолей.Использование = Истина;
	СтрокаДопПолей.Поле          = "СуммаНДС";
	СтрокаДопПолей.Представление = "СуммаНДС";
	
	СтрокаДопПолей = Отчет.ДополнительныеПоля.Добавить();
	СтрокаДопПолей.Использование = Истина;
	СтрокаДопПолей.Поле          = "СуммаНСП";
	СтрокаДопПолей.Представление = "СуммаНСП";
	
	СтрокаДопПолей = Отчет.ДополнительныеПоля.Добавить();
	СтрокаДопПолей.Использование = Истина;
	СтрокаДопПолей.Поле          = "Прибыль";
	СтрокаДопПолей.Представление = "Прибыль";
	
	СтрокаДопПолей = Отчет.ДополнительныеПоля.Добавить();
	СтрокаДопПолей.Использование = Истина;
	СтрокаДопПолей.Поле          = "Всего";
	СтрокаДопПолей.Представление = "Всего";
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Название = ?(ЗначениеЗаполнено(Форма.ПредставлениеТекущегоВарианта), Форма.ПредставлениеТекущегоВарианта, "Отчет о реализации");
