...
Функция ВариантыНастроек() Экспорт
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("Имя, Представление","КонтрольЗаполненныхСтатейДвиженияДенежныхСредств", НСтр("ru = 'Контроль заполненных статей ДДС'")));
	Возврат Массив;
КонецФункции
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "КонтрольЗаполненныхСтатейДвиженияДенежныхСредств");
	НастройкиВарианта.Описание = НСтр("ru = 'Контроль заполненных статей ДДС'");
...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Возврат "Контроль заполненных статей ДДС" + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(ПараметрыОтчета.НачалоПериода, ПараметрыОтчета.КонецПериода);
...
Процедура ЗаполнитьПараметрыРасшифровкиОтчета(Адрес, Расшифровка, ПараметрыРасшифровки) Экспорт
	...
	СписокПунктовМеню.Добавить("КонтрольЗаполненныхСтатейДвиженияДенежныхСредств", "Контроль заполненных статей ДДС");
		
	НастройкиРасшифровки = Новый Структура();
	НастройкиРасшифровки.Вставить("КонтрольЗаполненныхСтатейДвиженияДенежныхСредств", ПользовательскиеНастройки);
