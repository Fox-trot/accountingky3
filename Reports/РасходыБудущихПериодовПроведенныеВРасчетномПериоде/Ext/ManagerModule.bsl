...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.НастройкиДляПоиска.НаименованияПараметровИОтборов =
		...
		|КонецПериода
		|Организация'");
	НастройкиВарианта.НастройкиДляПоиска.КлючевыеСлова = НСтр("ru = 'Расходы будущих периодов проведенные в расчетном периоде'");
КонецПроцедуры
...
Процедура СформироватьТабличныйДокумент(СтруктураПараметров, РезультатФормирования)
	...
	ТабличныйДокумент.КлючПараметровПечати = "РасходыБудущихПериодовПроведенныеВРасчетномПериоде_РасходыБудущихПериодов";
