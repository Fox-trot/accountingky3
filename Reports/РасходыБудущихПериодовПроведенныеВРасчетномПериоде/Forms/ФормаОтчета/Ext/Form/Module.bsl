...
Процедура ОбновитьТекстЗаголовка(Форма)
	ЗаголовокОтчета = НСтр("ru = 'Расходы будущих периодов, проведенные в расчетном периоде %1'");
...
Функция СформироватьОтчетНаСервере(ПараметрыОтчета)
	...
	РезультатВыполнения = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
		...
		"Отчеты.РасходыБудущихПериодовПроведенныеВРасчетномПериоде.Сформировать",
		ПараметрыОтчета,
