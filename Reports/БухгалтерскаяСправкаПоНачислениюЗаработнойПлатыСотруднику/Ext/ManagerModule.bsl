...
Процедура СформироватьТабличныйДокумент(СтруктураПараметров, РезультатФормирования)
	...
	ТекстЗапроса =		
	"ВЫБРАТЬ
	|	УчетнаяПолитикаПоПерсоналуСрезПоследних.СчетУчета
	|ПОМЕСТИТЬ ВременнаяТаблицаСчетУчета
	|ИЗ
	|	РегистрСведений.УчетнаяПолитикаПоПерсоналу.СрезПоследних(&НачалоПериода, ) КАК УчетнаяПолитикаПоПерсоналуСрезПоследних
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|ГДЕ
	|	ХозрасчетныйОборотыДтКт.СчетКт В
	|			(ВЫБРАТЬ
	|				ВременнаяТаблицаСчетУчета.СчетУчета
	|			ИЗ
	|				ВременнаяТаблицаСчетУчета)
	|
	|СГРУППИРОВАТЬ ПО
	|	ХозрасчетныйОборотыДтКт.СчетДт,
	|	ХозрасчетныйОборотыДтКт.СчетКт,
	//|	ХозрасчетныйОборотыДтКт.СубконтоКт3.ГруппаНачисления,
	|	ХозрасчетныйОборотыДтКт.СубконтоДт1.Наименование,
	|	ХозрасчетныйОборотыДтКт.СчетДт.Код,
	|	ХозрасчетныйОборотыДтКт.СчетКт.Код
	//|	ХозрасчетныйОборотыДтКт.СубконтоКт3.ГруппаНачисления.Наименование
	|
	|УПОРЯДОЧИТЬ ПО
	|	ГруппаНачисления,
	|	СчетДт
