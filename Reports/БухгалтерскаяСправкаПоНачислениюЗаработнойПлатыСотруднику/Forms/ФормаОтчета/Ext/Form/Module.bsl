...
Процедура ОбновитьТекстЗаголовка(Форма)
	ЗаголовокОтчета = НСтр("ru = 'Бухгалтерская справка по начислению заработной платы сотрудников %1'");
...
Функция СформироватьОтчетНаСервере(ПараметрыОтчета)
	...
	РезультатВыполнения = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
		...
		"Отчеты.БухгалтерскаяСправкаПоНачислениюЗаработнойПлатыСотруднику.Сформировать",
		ПараметрыОтчета,
