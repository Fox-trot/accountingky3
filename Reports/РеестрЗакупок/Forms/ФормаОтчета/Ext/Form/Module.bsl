...
Функция ПодготовитьПараметрыОтчетаНаСервере()
	...
	ПараметрыОтчета.НеУчитыватьСФ				= Отчет.НеУчитыватьСФ;
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Название = ?(ЗначениеЗаполнено(Форма.ПредставлениеТекущегоВарианта), Форма.ПредставлениеТекущегоВарианта, "Реестр закупок");
...
Функция СформироватьОтчетНаСервере() Экспорт
	...
	Если НастройкиОтчета.ВариантСсылка.КлючВарианта = "РеестрЗакупокПоКонтрагентам" Тогда
		ПараметрыОтчета.Вставить("ПоКонтрагентам", Истина);	
	Иначе
