...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	Название = ?(ЗначениеЗаполнено(Форма.ПредставлениеТекущегоВарианта), Форма.ПредставлениеТекущегоВарианта, "Расчетная ведомость");
...
Процедура УстановитьНастройкиПоУмолчаниюНаСервере()
	...
	Для Каждого СтрокаТабличнойЧасти Из Отчет.Группировка Цикл 
		Если СтрокаТабличнойЧасти.Поле = "ФизЛицо" Тогда 
			СтрокаТабличнойЧасти.НомерПоПорядку = Истина;	
		КонецЕсли;	
	КонецЦикла;
