...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Выводит информацию о начислениях и удержаниях за указанный период.'");
КонецПроцедуры
...
Функция ВариантыНастроек() Экспорт
	...
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("Имя, Представление","РасчетнаяВедомость", "Расчетная ведомость"));	
	Возврат Массив;
...
Функция ПустыеПараметрыКомпоновкиОтчета() Экспорт
	...
	ПараметрыОтчета.Вставить("УстанавливатьНомерПоПорядку"  , Истина);
