...
Процедура ОбновитьТекстЗаголовка(Форма)
	ЗаголовокОтчета = НСтр("ru = 'Отчет об использовании бланков счет-фактур %1'");
...
Функция СформироватьОтчетНаСервере(ПараметрыОтчета)
	...
	РезультатВыполнения = ДлительныеОперации.ЗапуститьВыполнениеВФоне(
		...
		"Отчеты.БланкиСФОтчетОбИспользовании.Сформировать",
		ПараметрыОтчета,
...
Функция ПодготовитьПараметрыОтчета() Экспорт
	...
	ПараметрыОтчета.Вставить("Ландшафт", 		Ландшафт);
	ПараметрыОтчета.Вставить("Подробный", 		Подробный);
