...
Функция ВариантыНастроек() Экспорт
	Возврат ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Новый Структура("Имя, Представление", "ОборачиваемостьТоваров", НСтр("ru = 'Оборачиваемость товаров'")));
КонецФункции
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ОборачиваемостьТоваров");
	НастройкиВарианта.Описание = НСтр("ru = 'Оборачиваемость товаров'");
КонецПроцедуры
...
Процедура ЗаполнитьНастройкиДляРасшифровки(ПараметрыОтчета, КомпоновщикНастроек, Схема)
	...
	// Формируем разные варианты расшифровки, в зависимости от того, к какой группе (СреднийОбъем или Расход) относится
	// показатель расшифровки.
	Если ПараметрыОтчета.РасчетныйПоказательРасшифровки = "СреднийОбъем" Тогда
