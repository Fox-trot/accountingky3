...
Функция ПолучитьТекстЗаголовка(ПараметрыОтчета) Экспорт 
	...
	Возврат "Штатное расписание на " + Формат(ПараметрыОтчета.Период, "ДФ=dd.MM.yyyy; ДП=...");
...
Процедура ПередКомпоновкойМакета(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
	...
	БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(КомпоновщикНастроек.Настройки.Выбор, "КоличествоСтавок");
	БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(КомпоновщикНастроек.Настройки.Выбор, "ЗанятоСтавок");
	БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(КомпоновщикНастроек.Настройки.Выбор, "Вакантно");
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "ШтатноеРасписание");
	НастройкиВарианта.Описание = НСтр("ru = 'В отчете формируется информация о количестве занимаемых и свободных ставок.'");
КонецПроцедуры
...
Процедура ЗаполнитьПараметрыРасшифровкиОтчета(Адрес, Расшифровка, ПараметрыРасшифровки) Экспорт
	...
	СписокПунктовМеню.Добавить("ШтатноеРасписание", "Штатное расписание");
	
	НастройкиРасшифровки = Новый Структура();
	НастройкиРасшифровки.Вставить("ШтатноеРасписание", ПользовательскиеНастройки);
...
Функция ВариантыНастроек() Экспорт
	...
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("Имя, Представление","ШтатноеРасписание", "Штатное расписание"));	
	Возврат Массив;
