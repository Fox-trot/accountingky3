...
Процедура СформироватьТабличныйДокумент(СтруктураПараметров, РезультатФормирования)
	...
	|ГДЕ
	|	ВзаиморасчетыССотрудникамиОбороты.Регистратор ССЫЛКА Документ.ВедомостьЗаработнойПлаты
	|	И ВЫРАЗИТЬ(ВзаиморасчетыССотрудникамиОбороты.Регистратор КАК Документ.ВедомостьЗаработнойПлаты).ВидВыплаты = ЗНАЧЕНИЕ(Перечисление.ВидыВыплатыЗарплаты.ЧерезБанк)
	|	И НЕ ВЫРАЗИТЬ(ВзаиморасчетыССотрудникамиОбороты.Регистратор КАК Документ.ВедомостьЗаработнойПлаты).ВыплатаАванса
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
