...
// Процедура - обработчик события ПриИзменении поля ввода ПоказательБУ.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода ПоказательВалютнаяСумма.
//
&НаКлиенте
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыНастройкаГруппировка
...
// Процедура - обработчик события ПриИзменении поля ввода ПоПодразделам.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода ВыводитьЗабалансовыеСчета.
//
&НаКлиенте
...
#Область ОбработчикиСобытийЭлементовТаблицыФормыГруппировкаДоп

// Процедура - обработчик события ПриИзменении поля ввода ГруппировкаДоп.
//
&НаКлиенте
...
// Процедура - обработчик события ПриИзменении поля ввода ГруппировкаСчет.
//
&НаКлиенте
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	Если Режим = "ГруппировкаДоп" Тогда
		Для Каждого ДоступноеПоле Из Отчет.КомпоновщикНастроек.Настройки.Выбор.ДоступныеПоляВыбора.Элементы Цикл
			Если (Строка(ДоступноеПоле.Поле) <> "Организация") И (Строка(ДоступноеПоле.Поле) <> "ВидУчета") Тогда 
				СписокПолей.Добавить(Строка(ДоступноеПоле.Поле));
			КонецЕсли;
		КонецЦикла;
