...
Функция ВариантыНастроек() Экспорт
	Возврат ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве(Новый Структура("Имя, Представление", "НеоплаченныеСчетаПокупателям", НСтр("ru = 'Счета, не оплаченные покупателями'")));
КонецФункции
...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "НеоплаченныеСчетаПокупателям");
	НастройкиВарианта.Описание = НСтр("ru = 'Счета, не оплаченные покупателями'");
КонецПроцедуры
...
Функция ДанныеОНеоплаченныхСчетахПокупателей(Организация) Экспорт
	...
	Запрос.Текст =
		...
		|	СчетаНаОплату.ВалютаДокумента КАК ВалютаДокумента,
		|	ВЫБОР
