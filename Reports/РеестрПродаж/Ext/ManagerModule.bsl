...
Процедура ДобавитьРесурсыОтчета(Элемент, ПараметрыОтчета, ВариантОтчета)
	...
	Если ВариантОтчета = 3 Тогда		
		БухгалтерскиеОтчетыКлиентСервер.ДобавитьВыбранноеПоле(Элемент.Выбор, "ПоставкиБезНСП");
	КонецЕсли;	
