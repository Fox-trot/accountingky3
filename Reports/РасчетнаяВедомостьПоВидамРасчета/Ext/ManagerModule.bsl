...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "РасчетнаяВедомостьПоВидамРасчета");
	НастройкиВарианта.Описание = НСтр("ru = 'Выводит информацию о начислениях и удержаниях за указанный период в разрезе видов расчета.'");
КонецПроцедуры
...
Функция ВариантыНастроек() Экспорт
	...
	Массив = Новый Массив;
	Массив.Добавить(Новый Структура("Имя, Представление","РасчетнаяВедомостьПоВидамРасчета", "Расчетная ведомость по видам расчета"));	
	Возврат Массив;
