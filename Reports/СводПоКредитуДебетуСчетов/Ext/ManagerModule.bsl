...
Процедура НастроитьВариантыОтчета(Настройки, НастройкиОтчета) Экспорт
	...
	НастройкиВарианта.Описание = НСтр("ru = 'Свод по дебету / кредиту.'");      
	
	НастройкиВарианта = ВариантыОтчетов.ОписаниеВарианта(Настройки, НастройкиОтчета, "Свод по дебету");
	НастройкиВарианта.Описание = НСтр("ru = 'Свод по дебету.'");
КонецПроцедуры
