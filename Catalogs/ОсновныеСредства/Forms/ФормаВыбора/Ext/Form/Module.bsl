...
Процедура УстановитьЭлементОтбора(Список, ПараметрыПолученияОС)
	...
	ТекстЗапроса = 
		...
		|	И МестонахождениеОССрезПоследних.Склад = &Склад
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		|	ВТ_Состояние.ОсновноеСредство
		|ИЗ
		|	ВТ_МестонахождениеОС КАК ВТ_МестонахождениеОС
		|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ВТ_Состояние КАК ВТ_Состояние
		|		ПО ВТ_МестонахождениеОС.ОсновноеСредство = ВТ_Состояние.ОсновноеСредство";
	Если ЗначениеЗаполнено(ПараметрыПолученияОС.Склад) Тогда 
		Запрос.УстановитьПараметр("Склад", ПараметрыПолученияОС.Склад);
	Иначе
	...
	Если ЗначениеЗаполнено(ПараметрыПолученияОС.Подразделение) Тогда 
	...
	Если ЗначениеЗаполнено(ПараметрыПолученияОС.МОЛ) Тогда 
