...
Процедура УстановитьВидимостьДоступностьЭлементов()
	...
	Если Объект.СтранаРезидентства = ПредопределенноеЗначение("Справочник.СтраныМира.Киргизия") Тогда 
...
Функция ПолучитьПризнакСтраны(Страна)
	...
	Если Страна.Код = "417" Тогда  // Коргизия
		Возврат Перечисления.ПризнакиСтраны.КР;
	ИначеЕсли Страна.Код = "051"  // Армения
		Или Страна.Код = "112"  // Беларусь
		Или Страна.Код = "398" // Кахахстан
		Или Страна.Код = "643" Тогда // Россия
