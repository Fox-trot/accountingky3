...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Макет = Справочники.ВидыТранспорта.ПолучитьМакет("КлассификаторВидовТранспорта");
...
Процедура ВыполнитьВыбор(ТекущаяОбласть)
	...
	ОткрытьФорму("Справочник.ВидыТранспорта.Форма.ФормаЭлемента",
