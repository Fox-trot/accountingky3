...
Процедура УстановитьЭлементОтбора(Список, ПараметрыПолученияСотрудников)
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ПараметрыПолученияСотрудниковОрганизаций.Вставить("ДоступныНепринятые", ДоступныНепринятые);
	...
	Иначе
		...
		Если НЕ ОтборПоПериодуКадровыхДанных И 
			Параметры.Отбор.Свойство("ДатаПримененияОтбора") 
	...
	УстановитьЭлементОтбора(Список, ПараметрыПолученияСотрудниковОрганизаций);
