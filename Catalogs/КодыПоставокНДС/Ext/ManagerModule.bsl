...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Для Каждого СтрокаТаблицыЗначений Из КлассификаторТаблица Цикл
		...
		ЗначенияЗаполнения.Вставить("ВидПоставки", Справочники.ВидыПоставокНДС[СтрокаТаблицыЗначений.ВидПоставки]);
...
//
// Параметры:
//  Объект                  - СправочникОбъект.КодыПоставокНДС - заполняемый объект.
