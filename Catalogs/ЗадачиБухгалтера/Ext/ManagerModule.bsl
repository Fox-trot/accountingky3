...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Для Каждого СтрокаТаблицыЗначений Из КлассификаторТаблица Цикл
		...
		ЗначенияЗаполнения.Вставить("Периодичность", СтрокаТаблицыЗначений.Периодичность);
		ЗначенияЗаполнения.Вставить("Макет", Истина);
		ЗначенияЗаполнения.Вставить("Срок", ?(СтрДлина(СтрокаТаблицыЗначений.Срок) > 2, Дата(СтрокаТаблицыЗначений.Срок), СтрокаТаблицыЗначений.Срок));
...
//
// Параметры:
//  Объект                  - СправочникОбъект.ЗадачиБухгалтера - заполняемый объект.
