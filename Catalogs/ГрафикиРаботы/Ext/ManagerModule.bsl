...
Процедура ЗаполнитьПоУмолчанию() Экспорт 
	...
	Для Каждого СтрокаТаблицыЗначений Из КлассификаторТаблица Цикл
		...
		СправочникОбъект.НормаЧасовЗаполнения = 8;
		СправочникОбъект.УчитыватьПраздники = Истина;
		...
		ЗаполнитьКалендариГрафиковРабот(ТаблицаПериодичность, СправочникСсылка, НомерТекущегоГода, УчитыватьПраздники);
	КонецЦикла;
