...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Для Каждого СтрокаТаблицыЗначений Из КлассификаторТаблица Цикл
		...
		ЗначенияЗаполнения.Вставить("СчетЗатратСФ", ПланыСчетов.Хозрасчетный.НайтиПоКоду(СтрокаТаблицыЗначений.СчетЗатратСФ));
...
//
// Параметры:
//  Объект                  - СправочникОбъект.СпособыОтраженияЗаработнойПлаты - заполняемый объект.
