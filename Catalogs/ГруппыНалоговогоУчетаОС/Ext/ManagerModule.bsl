...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	СправочникМенеджер = Справочники.ГруппыНалоговогоУчетаОС;
	...
	Для Каждого СтрокаТаблицыЗначений Из КлассификаторТаблица Цикл
		...
		ЗначенияЗаполнения.Вставить("ВидУчетаВГруппеОС", Перечисления.ВидыНалоговогоУчетаВГруппахОС[СтрокаТаблицыЗначений.ВидУчетаВГруппеОС]);
		ЗначенияЗаполнения.Вставить("НормаАмортизации", СтрокаТаблицыЗначений.НормаАмортизации);
		ЗначенияЗаполнения.Вставить("НормаАмортизацииДополнительная", СтрокаТаблицыЗначений.НормаАмортизацииДополнительная);
...
//
// Параметры:
//  Объект                  - СправочникОбъект.ГруппыНалоговогоУчетаОС - заполняемый объект.
