...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Для Каждого СтрокаТаблицыЗначений Из КлассификаторТаблица Цикл
		...
		ЗначенияЗаполнения.Вставить("КодАльфа2", СтрокаТаблицыЗначений.КодАльфа2);
		ЗначенияЗаполнения.Вставить("КодАльфа3", СтрокаТаблицыЗначений.КодАльфа3);
		...
		ЗначенияЗаполнения.Вставить("МеждународноеНаименование", СтрокаТаблицыЗначений.МеждународноеНаименование);
		ЗначенияЗаполнения.Вставить("УчастникЕАЭС", ?(СтрокаТаблицыЗначений.УчастникЕАЭС = "истина", Истина, Ложь));
