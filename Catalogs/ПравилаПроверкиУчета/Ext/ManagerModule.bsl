...
Процедура ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию(Параметры) Экспорт
	...
	ИдентификаторыПроверок.Добавить("СтандартныеПодсистемы.ПроверкаНезаполненныхОбязательныхРеквизитов");
	ИдентификаторыПроверок.Добавить("СтандартныеПодсистемы.ПроверкаСсылочнойЦелостности");
