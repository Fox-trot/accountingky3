...
Процедура НачальноеЗаполнение() Экспорт
	...
	НоваяСтрокаКлассификатора.Наименование = НСтр("ru='Академик Кыргызской академии наук'");
	...
	НоваяСтрокаКлассификатора.Наименование = НСтр("ru='Член-корреспондент Кыргызской академии наук'");
