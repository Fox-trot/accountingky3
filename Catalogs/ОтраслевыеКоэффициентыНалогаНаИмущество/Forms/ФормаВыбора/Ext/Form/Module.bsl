...
Процедура ВопросПодобратьЕдиницуЗавершение(Результат, ДополнительныеПараметры) Экспорт
	Если Результат = КодВозвратаДиалога.Да Тогда
		ПодобратьИзКлассификатора();
	Иначе
		ОткрытьФорму("Справочник.ОтраслевыеКоэффициентыНалогаНаИмущество.Форма.ФормаЭлемента", ДополнительныеПараметры, ЭтаФорма);
	КонецЕсли;
КонецПроцедуры
...
Процедура ПодобратьИзКлассификатора()
	...
	ОбщегоНазначенияБПКлиент.ОткрытьФормуПодбораИзКлассификатора(
		"ОтраслевыеКоэффициентыНалогаНаИмущество", "Справочник.ОтраслевыеКоэффициентыНалогаНаИмущество.Классификатор", НСтр("ru = 'Отраслевые коэффициенты для расчета налога на имущество'"), ЭтаФорма, СоответствиеПолей);
КонецПроцедуры
