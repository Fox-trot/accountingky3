...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИначеЕсли ЗначениеЗаполнено(СвязьПоВладельцу) Тогда
		...
		НоваяСвязь	 = Новый СвязьПараметраВыбора("Отбор.Владелец", "СвязьПоВладельцу", РежимИзмененияСвязанногоЗначения.Очищать);
...
Процедура Выбрать(Команда)
	...
	Иначе
		СтруктураВыбора.Значение = НСтр("ru = 'Не изменять'");
