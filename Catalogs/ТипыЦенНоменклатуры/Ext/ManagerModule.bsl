...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Для Каждого СтрокаТаблицыЗначений Из КлассификаторТаблица Цикл
		...
		ЗначенияЗаполнения.Вставить("Валюта", Справочники.Валюты.НайтиПоКоду(СтрокаТаблицыЗначений.Валюта));
		ЗначенияЗаполнения.Вставить("ЦенаВключаетНалоги", ?(СтрокаТаблицыЗначений.ЦенаВключаетНалоги = "истина", Истина, Ложь));
		ЗначенияЗаполнения.Вставить("Точность", СтрокаТаблицыЗначений.Точность);
...
//
// Параметры:
//  Объект                  - СправочникОбъект.ТипыЦенНоменклатуры - заполняемый объект.
