...
Функция ЦиклыСпецификаций(СтрутураОтбора = Неопределено, МаксимальнаяДлинаПути = 10) Экспорт
	...
	// Будем считать уровнем элемента количество прямо или косвенно «предшествующих» ему других элементов (в смысле конкретного отношения).
	// Такой уровень на основе таблицы транзитивного замыкания легко посчитать для ориентированного графа любого вида.
	// Нетрудно догадаться, что уровень всех элементов, находящихся в цикле, будет одинаков.
